...
public class MConstructorDefinitionImpl extends MAbstractMethodDefinitionImpl implements MConstructorDefinition {
	...
	public MGravityModel getModel() {
		if (eContainerFeatureID() != ModiscoPackage.MCONSTRUCTOR_DEFINITION__MODEL)
			return null;
	...
	public NotificationChain basicSetModel(MGravityModel newModel, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject) newModel, ModiscoPackage.MCONSTRUCTOR_DEFINITION__MODEL, msgs);
		return msgs;
	}
	...
	public void setModel(MGravityModel newModel) {
		if (newModel != eInternalContainer()
				|| (eContainerFeatureID() != ModiscoPackage.MCONSTRUCTOR_DEFINITION__MODEL && newModel != null)) {
			...
			if (newModel != null)
				msgs = ((InternalEObject) newModel).eInverseAdd(this,
						ModiscoPackage.MGRAVITY_MODEL__MCONSTRUCTOR_DEFINITIONS, MGravityModel.class, msgs);
			msgs = basicSetModel(newModel, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModiscoPackage.MCONSTRUCTOR_DEFINITION__MODEL,
					newModel, newModel));
	}
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		...
		case ModiscoPackage.MCONSTRUCTOR_DEFINITION__MODEL:
			return eInternalContainer().eInverseRemove(this, ModiscoPackage.MGRAVITY_MODEL__MCONSTRUCTOR_DEFINITIONS,
