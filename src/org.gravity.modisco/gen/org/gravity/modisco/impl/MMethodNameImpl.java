...
public class MMethodNameImpl extends MNameImpl implements MMethodName {
	...
	public MGravityModel getModel() {
		if (eContainerFeatureID() != ModiscoPackage.MMETHOD_NAME__MODEL)
			return null;
	...
	public void setModel(MGravityModel newModel) {
		if (newModel != eInternalContainer()
				|| (eContainerFeatureID() != ModiscoPackage.MMETHOD_NAME__MODEL && newModel != null)) {
			...
			if (newModel != null)
				msgs = ((InternalEObject) newModel).eInverseAdd(this, ModiscoPackage.MGRAVITY_MODEL__MMETHOD_NAMES,
						MGravityModel.class, msgs);
			msgs = basicSetModel(newModel, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModiscoPackage.MMETHOD_NAME__MODEL, newModel,
					newModel));
	}
	...
	public EList<MMethodDefinition> getMMethodDefinitions() {
		if (mMethodDefinitions == null) {
			mMethodDefinitions = new EObjectWithInverseResolvingEList<MMethodDefinition>(MMethodDefinition.class, this,
					ModiscoPackage.MMETHOD_NAME__MMETHOD_DEFINITIONS, ModiscoPackage.MMETHOD_DEFINITION__MMETHOD_NAME);
		}
	...
	public EList<MMethodSignature> getMMethodSignatures() {
		if (mMethodSignatures == null) {
			mMethodSignatures = new EObjectWithInverseResolvingEList<MMethodSignature>(MMethodSignature.class, this,
					ModiscoPackage.MMETHOD_NAME__MMETHOD_SIGNATURES, ModiscoPackage.MMETHOD_SIGNATURE__MMETHOD_NAME);
		}
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		...
		case ModiscoPackage.MMETHOD_NAME__MODEL:
			return eInternalContainer().eInverseRemove(this, ModiscoPackage.MGRAVITY_MODEL__MMETHOD_NAMES,
					MGravityModel.class, msgs);
		}
