 ...
 * @generated
 */
public abstract class MNameImpl extends EObjectImpl implements MName {
	/**
	...
	public EList<MSignature> getMSignatures() {
		if (mSignatures == null) {
			mSignatures = new EObjectResolvingEList<MSignature>(MSignature.class, this,
					ModiscoPackage.MNAME__MSIGNATURES);
		}
		return mSignatures;
	}
