...
public class MFieldNameImpl extends MNameImpl implements MFieldName {
	...
	public MGravityModel getModel() {
		if (eContainerFeatureID() != ModiscoPackage.MFIELD_NAME__MODEL)
			return null;
	...
	public void setModel(MGravityModel newModel) {
		if (newModel != eInternalContainer()
				|| (eContainerFeatureID() != ModiscoPackage.MFIELD_NAME__MODEL && newModel != null)) {
			...
			if (newModel != null)
				msgs = ((InternalEObject) newModel).eInverseAdd(this, ModiscoPackage.MGRAVITY_MODEL__MFIELD_NAMES,
						MGravityModel.class, msgs);
			msgs = basicSetModel(newModel, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModiscoPackage.MFIELD_NAME__MODEL, newModel,
					newModel));
	}
	...
	public EList<MFieldSignature> getMFieldSignatures() {
		if (mFieldSignatures == null) {
			mFieldSignatures = new EObjectWithInverseResolvingEList<MFieldSignature>(MFieldSignature.class, this,
					ModiscoPackage.MFIELD_NAME__MFIELD_SIGNATURES, ModiscoPackage.MFIELD_SIGNATURE__MFIELD_NAME);
		}
	...
	public EList<MFieldDefinition> getMFieldDefinitions() {
		if (mFieldDefinitions == null) {
			mFieldDefinitions = new EObjectWithInverseResolvingEList<MFieldDefinition>(MFieldDefinition.class, this,
					ModiscoPackage.MFIELD_NAME__MFIELD_DEFINITIONS, ModiscoPackage.MFIELD_DEFINITION__MFIELD_NAME);
		}
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		...
		case ModiscoPackage.MFIELD_NAME__MODEL:
			return eInternalContainer().eInverseRemove(this, ModiscoPackage.MGRAVITY_MODEL__MFIELD_NAMES,
					MGravityModel.class, msgs);
		}
