...
public class MGravityModelImpl extends ModelImpl implements MGravityModel {
	...
	/**
	 * The cached value of the '{@link #getMConstructorDefinitions() <em>MConstructor Definitions</em>}' containment reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	public EList<MMethodDefinition> getMMethodDefinitions() {
		if (mMethodDefinitions == null) {
			mMethodDefinitions = new EObjectWithInverseResolvingEList<MMethodDefinition>(MMethodDefinition.class, this,
					ModiscoPackage.MGRAVITY_MODEL__MMETHOD_DEFINITIONS, ModiscoPackage.MMETHOD_DEFINITION__MODEL);
		}
	...
	public EList<MFieldDefinition> getMFieldDefinitions() {
		if (mFieldDefinitions == null) {
			mFieldDefinitions = new EObjectWithInverseResolvingEList<MFieldDefinition>(MFieldDefinition.class, this,
					ModiscoPackage.MGRAVITY_MODEL__MFIELD_DEFINITIONS, ModiscoPackage.MFIELD_DEFINITION__MODEL);
		}
	...
	public EList<MConstructorDefinition> getMConstructorDefinitions() {
		if (mConstructorDefinitions == null) {
			mConstructorDefinitions = new EObjectContainmentWithInverseEList<MConstructorDefinition>(
					MConstructorDefinition.class, this, ModiscoPackage.MGRAVITY_MODEL__MCONSTRUCTOR_DEFINITIONS,
					ModiscoPackage.MCONSTRUCTOR_DEFINITION__MODEL);
		}
	...
	public EList<AnonymousClassDeclaration> getAnonymousClassDeclarations() {
		if (anonymousClassDeclarations == null) {
			anonymousClassDeclarations = new EObjectResolvingEList<AnonymousClassDeclaration>(
					AnonymousClassDeclaration.class, this, ModiscoPackage.MGRAVITY_MODEL__ANONYMOUS_CLASS_DECLARATIONS);
		}
	...
	public EList<MMethodName> getMMethodNames() {
		if (mMethodNames == null) {
			mMethodNames = new EObjectContainmentWithInverseEList<MMethodName>(MMethodName.class, this,
					ModiscoPackage.MGRAVITY_MODEL__MMETHOD_NAMES, ModiscoPackage.MMETHOD_NAME__MODEL);
		}
		return mMethodNames;
	}
	...
	public EList<MMethodSignature> getMMethodSignatures() {
		if (mMethodSignatures == null) {
			mMethodSignatures = new EObjectContainmentWithInverseEList<MMethodSignature>(MMethodSignature.class, this,
					ModiscoPackage.MGRAVITY_MODEL__MMETHOD_SIGNATURES, ModiscoPackage.MMETHOD_SIGNATURE__MODEL);
		}
	...
	public EList<MFieldSignature> getMFieldSignatures() {
		if (mFieldSignatures == null) {
			mFieldSignatures = new EObjectContainmentWithInverseEList<MFieldSignature>(MFieldSignature.class, this,
					ModiscoPackage.MGRAVITY_MODEL__MFIELD_SIGNATURES, ModiscoPackage.MFIELD_SIGNATURE__MODEL);
		}
	...
	public EList<MFieldName> getMFieldNames() {
		if (mFieldNames == null) {
			mFieldNames = new EObjectContainmentWithInverseEList<MFieldName>(MFieldName.class, this,
					ModiscoPackage.MGRAVITY_MODEL__MFIELD_NAMES, ModiscoPackage.MFIELD_NAME__MODEL);
		}
		return mFieldNames;
	}
	...
	public EList<MAbstractMethodDefinition> getMAbstractMethodDefinitions() {
		if (mAbstractMethodDefinitions == null) {
			mAbstractMethodDefinitions = new EObjectResolvingEList<MAbstractMethodDefinition>(
					MAbstractMethodDefinition.class, this, ModiscoPackage.MGRAVITY_MODEL__MABSTRACT_METHOD_DEFINITIONS);
		}
	...
	public EList<TypeParameter> getTypeParameters() {
		if (typeParameters == null) {
			typeParameters = new EObjectResolvingEList<TypeParameter>(TypeParameter.class, this,
					ModiscoPackage.MGRAVITY_MODEL__TYPE_PARAMETERS);
		}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		...
		case ModiscoPackage.MGRAVITY_MODEL__MFIELD_DEFINITIONS:
			return ((InternalEList<InternalEObject>) (InternalEList<?>) getMFieldDefinitions()).basicAdd(otherEnd,
					msgs);
		case ModiscoPackage.MGRAVITY_MODEL__MCONSTRUCTOR_DEFINITIONS:
			return ((InternalEList<InternalEObject>) (InternalEList<?>) getMConstructorDefinitions()).basicAdd(otherEnd,
					msgs);
		...
		case ModiscoPackage.MGRAVITY_MODEL__MMETHOD_SIGNATURES:
			return ((InternalEList<InternalEObject>) (InternalEList<?>) getMMethodSignatures()).basicAdd(otherEnd,
					msgs);
