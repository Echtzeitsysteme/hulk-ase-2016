 ...
 * @generated
 */
public class MEntryImpl extends EObjectImpl implements MEntry {
	/**
		...
		if (mNext != null && mNext.eIsProxy()) {
			...
			if (mNext != oldMNext) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ModiscoPackage.MENTRY__MNEXT, oldMNext,
							mNext));
			}
		}
		return mNext;
	...
	public NotificationChain basicSetMNext(MEntry newMNext, NotificationChain msgs) {
		...
		mNext = newMNext;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ModiscoPackage.MENTRY__MNEXT,
					oldMNext, newMNext);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setMNext(MEntry newMNext) {
		if (newMNext != mNext) {
			...
			if (mNext != null)
				msgs = ((InternalEObject) mNext).eInverseRemove(this, ModiscoPackage.MENTRY__MPREVIOUS, MEntry.class,
						msgs);
			if (newMNext != null)
				msgs = ((InternalEObject) newMNext).eInverseAdd(this, ModiscoPackage.MENTRY__MPREVIOUS, MEntry.class,
						msgs);
	...
	public MEntry getMPrevious() {
		if (mPrevious != null && mPrevious.eIsProxy()) {
			...
			if (mPrevious != oldMPrevious) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ModiscoPackage.MENTRY__MPREVIOUS,
							oldMPrevious, mPrevious));
			}
		}
		return mPrevious;
	}
	...
	public NotificationChain basicSetMPrevious(MEntry newMPrevious, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					ModiscoPackage.MENTRY__MPREVIOUS, oldMPrevious, newMPrevious);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
	...
	public void setMPrevious(MEntry newMPrevious) {
		if (newMPrevious != mPrevious) {
			NotificationChain msgs = null;
			if (mPrevious != null)
				msgs = ((InternalEObject) mPrevious).eInverseRemove(this, ModiscoPackage.MENTRY__MNEXT, MEntry.class,
						msgs);
			if (newMPrevious != null)
				msgs = ((InternalEObject) newMPrevious).eInverseAdd(this, ModiscoPackage.MENTRY__MNEXT, MEntry.class,
						msgs);
			msgs = basicSetMPrevious(newMPrevious, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModiscoPackage.MENTRY__MPREVIOUS, newMPrevious,
					newMPrevious));
	}
	...
	public Type getType() {
		if (type != null && type.eIsProxy()) {
			...
			if (type != oldType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ModiscoPackage.MENTRY__TYPE, oldType,
							type));
			}
		}
		return type;
