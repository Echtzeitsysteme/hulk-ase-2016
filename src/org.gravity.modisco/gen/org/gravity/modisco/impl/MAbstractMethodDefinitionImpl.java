...
public abstract class MAbstractMethodDefinitionImpl extends MDefinitionImpl implements MAbstractMethodDefinition {
	...
	public NotificationChain basicSetBody(Block newBody, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					ModiscoPackage.MABSTRACT_METHOD_DEFINITION__BODY, oldBody, newBody);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newBody != body) {
			...
			if (body != null)
				msgs = ((InternalEObject) body).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - ModiscoPackage.MABSTRACT_METHOD_DEFINITION__BODY, null, msgs);
			if (newBody != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, ModiscoPackage.MABSTRACT_METHOD_DEFINITION__BODY,
					newBody, newBody));
	}
	...
	public EList<SingleVariableDeclaration> getParameters() {
		if (parameters == null) {
			parameters = new EObjectContainmentWithInverseEList<SingleVariableDeclaration>(
					SingleVariableDeclaration.class, this, ModiscoPackage.MABSTRACT_METHOD_DEFINITION__PARAMETERS,
					JavaPackage.SINGLE_VARIABLE_DECLARATION__METHOD_DECLARATION);
		}
		return parameters;
	}
	...
	public EList<TypeAccess> getThrownExceptions() {
		if (thrownExceptions == null) {
			thrownExceptions = new EObjectContainmentEList<TypeAccess>(TypeAccess.class, this,
					ModiscoPackage.MABSTRACT_METHOD_DEFINITION__THROWN_EXCEPTIONS);
		}
	...
	public EList<TypeParameter> getTypeParameters() {
		if (typeParameters == null) {
			typeParameters = new EObjectContainmentEList<TypeParameter>(TypeParameter.class, this,
					ModiscoPackage.MABSTRACT_METHOD_DEFINITION__TYPE_PARAMETERS);
		}
	...
	public EList<MethodRef> getUsagesInDocComments() {
		if (usagesInDocComments == null) {
			usagesInDocComments = new EObjectWithInverseResolvingEList<MethodRef>(MethodRef.class, this,
					ModiscoPackage.MABSTRACT_METHOD_DEFINITION__USAGES_IN_DOC_COMMENTS, JavaPackage.METHOD_REF__METHOD);
		}
	...
	public EList<AbstractMethodInvocation> getUsages() {
		if (usages == null) {
			usages = new EObjectWithInverseResolvingEList<AbstractMethodInvocation>(AbstractMethodInvocation.class,
					this, ModiscoPackage.MABSTRACT_METHOD_DEFINITION__USAGES,
					JavaPackage.ABSTRACT_METHOD_INVOCATION__METHOD);
		}
		return usages;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		...
		case ModiscoPackage.MABSTRACT_METHOD_DEFINITION__USAGES_IN_DOC_COMMENTS:
			return ((InternalEList<InternalEObject>) (InternalEList<?>) getUsagesInDocComments()).basicAdd(otherEnd,
					msgs);
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == AbstractMethodDeclaration.class) {
			...
			case ModiscoPackage.MABSTRACT_METHOD_DEFINITION__BODY:
				return JavaPackage.ABSTRACT_METHOD_DECLARATION__BODY;
			case ModiscoPackage.MABSTRACT_METHOD_DEFINITION__PARAMETERS:
				return JavaPackage.ABSTRACT_METHOD_DECLARATION__PARAMETERS;
			case ModiscoPackage.MABSTRACT_METHOD_DEFINITION__THROWN_EXCEPTIONS:
				return JavaPackage.ABSTRACT_METHOD_DECLARATION__THROWN_EXCEPTIONS;
			case ModiscoPackage.MABSTRACT_METHOD_DEFINITION__TYPE_PARAMETERS:
				return JavaPackage.ABSTRACT_METHOD_DECLARATION__TYPE_PARAMETERS;
			case ModiscoPackage.MABSTRACT_METHOD_DEFINITION__USAGES_IN_DOC_COMMENTS:
				return JavaPackage.ABSTRACT_METHOD_DECLARATION__USAGES_IN_DOC_COMMENTS;
			case ModiscoPackage.MABSTRACT_METHOD_DEFINITION__USAGES:
				return JavaPackage.ABSTRACT_METHOD_DECLARATION__USAGES;
			default:
				return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == AbstractMethodDeclaration.class) {
			...
			case JavaPackage.ABSTRACT_METHOD_DECLARATION__BODY:
				return ModiscoPackage.MABSTRACT_METHOD_DEFINITION__BODY;
			case JavaPackage.ABSTRACT_METHOD_DECLARATION__PARAMETERS:
				return ModiscoPackage.MABSTRACT_METHOD_DEFINITION__PARAMETERS;
			case JavaPackage.ABSTRACT_METHOD_DECLARATION__THROWN_EXCEPTIONS:
				return ModiscoPackage.MABSTRACT_METHOD_DEFINITION__THROWN_EXCEPTIONS;
			case JavaPackage.ABSTRACT_METHOD_DECLARATION__TYPE_PARAMETERS:
				return ModiscoPackage.MABSTRACT_METHOD_DEFINITION__TYPE_PARAMETERS;
			case JavaPackage.ABSTRACT_METHOD_DECLARATION__USAGES_IN_DOC_COMMENTS:
				return ModiscoPackage.MABSTRACT_METHOD_DEFINITION__USAGES_IN_DOC_COMMENTS;
			case JavaPackage.ABSTRACT_METHOD_DECLARATION__USAGES:
				return ModiscoPackage.MABSTRACT_METHOD_DEFINITION__USAGES;
			default:
				return -1;
			}
		}
