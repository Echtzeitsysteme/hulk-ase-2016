...
public class MFieldSignatureImpl extends MSignatureImpl implements MFieldSignature {
			...
			if (mFieldName != oldMFieldName) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ModiscoPackage.MFIELD_SIGNATURE__MFIELD_NAME, oldMFieldName, mFieldName));
			}
		}
		return mFieldName;
	}
	...
	public NotificationChain basicSetMFieldName(MFieldName newMFieldName, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					ModiscoPackage.MFIELD_SIGNATURE__MFIELD_NAME, oldMFieldName, newMFieldName);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newMFieldName != mFieldName) {
			...
			if (mFieldName != null)
				msgs = ((InternalEObject) mFieldName).eInverseRemove(this,
						ModiscoPackage.MFIELD_NAME__MFIELD_SIGNATURES, MFieldName.class, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET, ModiscoPackage.MFIELD_SIGNATURE__MFIELD_NAME,
	...
	public MGravityModel getModel() {
		if (eContainerFeatureID() != ModiscoPackage.MFIELD_SIGNATURE__MODEL)
			return null;
	...
	public void setModel(MGravityModel newModel) {
		if (newModel != eInternalContainer()
				|| (eContainerFeatureID() != ModiscoPackage.MFIELD_SIGNATURE__MODEL && newModel != null)) {
			...
			if (newModel != null)
				msgs = ((InternalEObject) newModel).eInverseAdd(this, ModiscoPackage.MGRAVITY_MODEL__MFIELD_SIGNATURES,
						MGravityModel.class, msgs);
			msgs = basicSetModel(newModel, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModiscoPackage.MFIELD_SIGNATURE__MODEL, newModel,
					newModel));
	}
	...
	public Type getType() {
		if (type != null && type.eIsProxy()) {
			...
			if (type != oldType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ModiscoPackage.MFIELD_SIGNATURE__TYPE,
							oldType, type));
			}
		}
		return type;
	...
	public void setType(Type newType) {
		...
		type = newType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModiscoPackage.MFIELD_SIGNATURE__TYPE, oldType,
					type));
	}
	...
	public EList<MFieldDefinition> getMFieldDefinitions() {
		if (mFieldDefinitions == null) {
			mFieldDefinitions = new EObjectWithInverseResolvingEList<MFieldDefinition>(MFieldDefinition.class, this,
					ModiscoPackage.MFIELD_SIGNATURE__MFIELD_DEFINITIONS,
					ModiscoPackage.MFIELD_DEFINITION__MFIELD_SIGNATURE);
		}
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		...
		case ModiscoPackage.MFIELD_SIGNATURE__MODEL:
			return eInternalContainer().eInverseRemove(this, ModiscoPackage.MGRAVITY_MODEL__MFIELD_SIGNATURES,
					MGravityModel.class, msgs);
		}
