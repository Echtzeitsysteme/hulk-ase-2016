...
public class MFieldDefinitionImpl extends MDefinitionImpl implements MFieldDefinition {
	...
	public NotificationChain basicSetType(TypeAccess newType, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					ModiscoPackage.MFIELD_DEFINITION__TYPE, oldType, newType);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newType != type) {
			...
			if (type != null)
				msgs = ((InternalEObject) type).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - ModiscoPackage.MFIELD_DEFINITION__TYPE, null, msgs);
			if (newType != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, ModiscoPackage.MFIELD_DEFINITION__TYPE, newType,
					newType));
	}
	...
	public EList<VariableDeclarationFragment> getFragments() {
		if (fragments == null) {
			fragments = new EObjectContainmentWithInverseEList<VariableDeclarationFragment>(
					VariableDeclarationFragment.class, this, ModiscoPackage.MFIELD_DEFINITION__FRAGMENTS,
			...
			if (mFieldSignature != oldMFieldSignature) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ModiscoPackage.MFIELD_DEFINITION__MFIELD_SIGNATURE, oldMFieldSignature, mFieldSignature));
			}
		}
	...
	public NotificationChain basicSetMFieldSignature(MFieldSignature newMFieldSignature, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					ModiscoPackage.MFIELD_DEFINITION__MFIELD_SIGNATURE, oldMFieldSignature, newMFieldSignature);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
	...
	public void setMFieldSignature(MFieldSignature newMFieldSignature) {
		if (newMFieldSignature != mFieldSignature) {
			...
			if (mFieldSignature != null)
				msgs = ((InternalEObject) mFieldSignature).eInverseRemove(this,
						ModiscoPackage.MFIELD_SIGNATURE__MFIELD_DEFINITIONS, MFieldSignature.class, msgs);
			if (newMFieldSignature != null)
				msgs = ((InternalEObject) newMFieldSignature).eInverseAdd(this,
						ModiscoPackage.MFIELD_SIGNATURE__MFIELD_DEFINITIONS, MFieldSignature.class, msgs);
			msgs = basicSetMFieldSignature(newMFieldSignature, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModiscoPackage.MFIELD_DEFINITION__MFIELD_SIGNATURE,
					newMFieldSignature, newMFieldSignature));
	}
	...
	public MFieldName getMFieldName() {
		if (mFieldName != null && mFieldName.eIsProxy()) {
			...
			if (mFieldName != oldMFieldName) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ModiscoPackage.MFIELD_DEFINITION__MFIELD_NAME, oldMFieldName, mFieldName));
			}
		}
		return mFieldName;
	}
	...
	public NotificationChain basicSetMFieldName(MFieldName newMFieldName, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					ModiscoPackage.MFIELD_DEFINITION__MFIELD_NAME, oldMFieldName, newMFieldName);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
	...
	public void setMFieldName(MFieldName newMFieldName) {
		if (newMFieldName != mFieldName) {
			NotificationChain msgs = null;
			if (mFieldName != null)
				msgs = ((InternalEObject) mFieldName).eInverseRemove(this,
						ModiscoPackage.MFIELD_NAME__MFIELD_DEFINITIONS, MFieldName.class, msgs);
			if (newMFieldName != null)
				msgs = ((InternalEObject) newMFieldName).eInverseAdd(this,
						ModiscoPackage.MFIELD_NAME__MFIELD_DEFINITIONS, MFieldName.class, msgs);
			msgs = basicSetMFieldName(newMFieldName, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModiscoPackage.MFIELD_DEFINITION__MFIELD_NAME,
					newMFieldName, newMFieldName));
	}
	...
	public MGravityModel getModel() {
		if (model != null && model.eIsProxy()) {
			...
			if (model != oldModel) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ModiscoPackage.MFIELD_DEFINITION__MODEL,
							oldModel, model));
			}
		}
		return model;
	...
	public NotificationChain basicSetModel(MGravityModel newModel, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					ModiscoPackage.MFIELD_DEFINITION__MODEL, oldModel, newModel);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
	...
	public void setModel(MGravityModel newModel) {
		if (newModel != model) {
			NotificationChain msgs = null;
			if (model != null)
				msgs = ((InternalEObject) model).eInverseRemove(this, ModiscoPackage.MGRAVITY_MODEL__MFIELD_DEFINITIONS,
						MGravityModel.class, msgs);
			if (newModel != null)
				msgs = ((InternalEObject) newModel).eInverseAdd(this, ModiscoPackage.MGRAVITY_MODEL__MFIELD_DEFINITIONS,
						MGravityModel.class, msgs);
			msgs = basicSetModel(newModel, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModiscoPackage.MFIELD_DEFINITION__MODEL, newModel,
					newModel));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		...
		case ModiscoPackage.MFIELD_DEFINITION__MFIELD_SIGNATURE:
			if (resolve)
				return getMFieldSignature();
			return basicGetMFieldSignature();
		case ModiscoPackage.MFIELD_DEFINITION__MFIELD_NAME:
			if (resolve)
				return getMFieldName();
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == AbstractVariablesContainer.class) {
			...
			case JavaPackage.ABSTRACT_VARIABLES_CONTAINER__TYPE:
				return ModiscoPackage.MFIELD_DEFINITION__TYPE;
			case JavaPackage.ABSTRACT_VARIABLES_CONTAINER__FRAGMENTS:
				return ModiscoPackage.MFIELD_DEFINITION__FRAGMENTS;
			default:
				return -1;
			}
		}
