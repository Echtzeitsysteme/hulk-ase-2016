 ...
 * @generated
 */
public class TParameterListImpl extends TElementWithIdImpl implements TParameterList {
	/**
	...
	public EList<TParameter> getEntries() {
		if (entries == null) {
			entries = new EObjectContainmentEList<TParameter>(TParameter.class, this,
					BasicPackage.TPARAMETER_LIST__ENTRIES);
		}
		return entries;
	}
		...
		if (first != null && first.eIsProxy()) {
			...
			if (first != oldFirst) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, BasicPackage.TPARAMETER_LIST__FIRST,
							oldFirst, first));
			}
		}
		return first;
	...
	public void setFirst(TParameter newFirst) {
		...
		first = newFirst;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BasicPackage.TPARAMETER_LIST__FIRST, oldFirst,
					first));
	}
