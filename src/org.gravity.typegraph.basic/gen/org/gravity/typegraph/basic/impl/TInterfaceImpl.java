...
public class TInterfaceImpl extends TAbstractTypeImpl implements TInterface {
	...
	public EList<TClass> getImplementedBy() {
		if (implementedBy == null) {
			implementedBy = new EObjectWithInverseResolvingEList.ManyInverse<TClass>(TClass.class, this,
					BasicPackage.TINTERFACE__IMPLEMENTED_BY, BasicPackage.TCLASS__IMPLEMENTS);
		}
	...
	public EList<TInterface> getParentInterfaces() {
		if (parentInterfaces == null) {
			parentInterfaces = new EObjectWithInverseResolvingEList.ManyInverse<TInterface>(TInterface.class, this,
					BasicPackage.TINTERFACE__PARENT_INTERFACES, BasicPackage.TINTERFACE__CHILD_INTERFACES);
		}
	...
	public EList<TInterface> getChildInterfaces() {
		if (childInterfaces == null) {
			childInterfaces = new EObjectWithInverseResolvingEList.ManyInverse<TInterface>(TInterface.class, this,
					BasicPackage.TINTERFACE__CHILD_INTERFACES, BasicPackage.TINTERFACE__PARENT_INTERFACES);
		}
