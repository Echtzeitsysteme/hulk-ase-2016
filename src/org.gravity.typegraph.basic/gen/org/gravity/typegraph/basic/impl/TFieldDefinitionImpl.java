...
public class TFieldDefinitionImpl extends TMemberImpl implements TFieldDefinition {
	...
	public TFieldSignature getSignature() {
		if (eContainerFeatureID() != BasicPackage.TFIELD_DEFINITION__SIGNATURE)
			return null;
	...
	public void setSignature(TFieldSignature newSignature) {
		if (newSignature != eInternalContainer()
				|| (eContainerFeatureID() != BasicPackage.TFIELD_DEFINITION__SIGNATURE && newSignature != null)) {
			...
			if (newSignature != null)
				msgs = ((InternalEObject) newSignature).eInverseAdd(this, BasicPackage.TFIELD_SIGNATURE__DEFINITIONS,
						TFieldSignature.class, msgs);
			msgs = basicSetSignature(newSignature, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BasicPackage.TFIELD_DEFINITION__SIGNATURE,
		...
		if (hiding != null && hiding.eIsProxy()) {
			...
			if (hiding != oldHiding) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, BasicPackage.TFIELD_DEFINITION__HIDING,
							oldHiding, hiding));
			}
		}
		return hiding;
	...
	public NotificationChain basicSetHiding(TFieldDefinition newHiding, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					BasicPackage.TFIELD_DEFINITION__HIDING, oldHiding, newHiding);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setHiding(TFieldDefinition newHiding) {
		if (newHiding != hiding) {
			NotificationChain msgs = null;
			if (hiding != null)
				msgs = ((InternalEObject) hiding).eInverseRemove(this, BasicPackage.TFIELD_DEFINITION__HIDDEN_BY,
						TFieldDefinition.class, msgs);
			if (newHiding != null)
				msgs = ((InternalEObject) newHiding).eInverseAdd(this, BasicPackage.TFIELD_DEFINITION__HIDDEN_BY,
						TFieldDefinition.class, msgs);
			msgs = basicSetHiding(newHiding, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BasicPackage.TFIELD_DEFINITION__HIDING, newHiding,
					newHiding));
	}
	...
	public EList<TFieldDefinition> getHiddenBy() {
		if (hiddenBy == null) {
			hiddenBy = new EObjectWithInverseResolvingEList<TFieldDefinition>(TFieldDefinition.class, this,
					BasicPackage.TFIELD_DEFINITION__HIDDEN_BY, BasicPackage.TFIELD_DEFINITION__HIDING);
		}
		return hiddenBy;
	}
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		...
		case BasicPackage.TFIELD_DEFINITION__SIGNATURE:
			return eInternalContainer().eInverseRemove(this, BasicPackage.TFIELD_SIGNATURE__DEFINITIONS,
					TFieldSignature.class, msgs);
		}
