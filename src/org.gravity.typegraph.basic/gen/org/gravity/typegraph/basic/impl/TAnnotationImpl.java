...
public class TAnnotationImpl extends TElementWithIdImpl implements TAnnotation {
	...
	public TAnnotatable getTAnnotated() {
		if (eContainerFeatureID() != BasicPackage.TANNOTATION__TANNOTATED)
			return null;
		return (TAnnotatable) eContainer();
	}
	...
	public void setTAnnotated(TAnnotatable newTAnnotated) {
		if (newTAnnotated != eInternalContainer()
				|| (eContainerFeatureID() != BasicPackage.TANNOTATION__TANNOTATED && newTAnnotated != null)) {
			...
			if (newTAnnotated != null)
				msgs = ((InternalEObject) newTAnnotated).eInverseAdd(this, BasicPackage.TANNOTATABLE__TANNOTATION,
						TAnnotatable.class, msgs);
			msgs = basicSetTAnnotated(newTAnnotated, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BasicPackage.TANNOTATION__TANNOTATED, newTAnnotated,
					newTAnnotated));
	}
		...
		if (type != null && type.eIsProxy()) {
			...
			if (type != oldType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, BasicPackage.TANNOTATION__TYPE, oldType,
							type));
			}
		}
		return type;
	...
	public NotificationChain basicSetType(TAnnotationType newType, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					BasicPackage.TANNOTATION__TYPE, oldType, newType);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setType(TAnnotationType newType) {
		if (newType != type) {
			NotificationChain msgs = null;
			if (type != null)
				msgs = ((InternalEObject) type).eInverseRemove(this, BasicPackage.TANNOTATION_TYPE__ANNOTATIONS,
						TAnnotationType.class, msgs);
			if (newType != null)
				msgs = ((InternalEObject) newType).eInverseAdd(this, BasicPackage.TANNOTATION_TYPE__ANNOTATIONS,
						TAnnotationType.class, msgs);
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		...
		case BasicPackage.TANNOTATION__TANNOTATED:
			return eInternalContainer().eInverseRemove(this, BasicPackage.TANNOTATABLE__TANNOTATION, TAnnotatable.class,
					msgs);
		}
