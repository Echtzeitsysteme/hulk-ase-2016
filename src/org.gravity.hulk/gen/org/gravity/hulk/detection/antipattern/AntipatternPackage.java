...
public interface AntipatternPackage extends EPackage {
	 ...
	 * @generated
	 */
	String eNS_URI = "platform:/plugin/org.gravity.hulk/model/Hulk.ecore#//detection/antipattern";
	 ...
	 * @ordered
	 */
	int HBLOB_DETECTOR__HULK = DetectionPackage.HANTI_PATTERN_DETECTOR__HULK;
	 ...
	 * @ordered
	 */
	int HBLOB_DETECTOR___GET_NEXT_ID = DetectionPackage.HANTI_PATTERN_DETECTOR___GET_NEXT_ID;
	 ...
	 * @ordered
	 */
	int HGOD_CLASS_DETECTOR__HULK = DetectionPackage.HANTI_PATTERN_DETECTOR__HULK;
	 ...
	 * @ordered
	 */
	int HGOD_CLASS_DETECTOR___GET_NEXT_ID = DetectionPackage.HANTI_PATTERN_DETECTOR___GET_NEXT_ID;
	 ...
	 * @ordered
	 */
	int HSWISS_ARMY_KNIFE_DETECTOR__HULK = DetectionPackage.HANTI_PATTERN_DETECTOR__HULK;
	 ...
	 * @ordered
	 */
	int HSWISS_ARMY_KNIFE_DETECTOR___GET_NEXT_ID = DetectionPackage.HANTI_PATTERN_DETECTOR___GET_NEXT_ID;
	 ...
	 * @ordered
	 */
	int HSPAGHETTI_CODE_DETECTOR__HULK = DetectionPackage.HCLASS_BASED_CALCULATOR__HULK;
	 ...
	 * @ordered
	 */
	int HSPAGHETTI_CODE_DETECTOR___GET_NEXT_ID = DetectionPackage.HCLASS_BASED_CALCULATOR___GET_NEXT_ID;
