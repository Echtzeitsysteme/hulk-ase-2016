...
public class HBlobDetectorImpl extends HAntiPatternDetectorImpl implements HBlobDetector {
	 ...
	 * @generated
	 */
	public HAnnotation calculate(TClass tClass) {// ActivityNode10
		Object[] result1_black = HBlobDetectorImpl.pattern_HBlobDetector_0_1_ActivityNode10_blackFBF(tClass);
		if (result1_black != null) {
			// HGodClassAntiPattern mainClass = (HGodClassAntiPattern) result1_black[0];
				...
				if (result3_bindingAndBlack != null) {
					...
					if (result4_black == null) {
						throw new RuntimeException("Pattern matching in node [ActivityNode9] failed." + " Variables: "
								+ "[tClass] = " + tClass + ", " + "[this] = " + this + ", " + "[nad] = " + nad + ".");
					}
					...
					for (Object[] result5_black : HBlobDetectorImpl
						...
						if (result6_black == null) {
							throw new RuntimeException("Pattern matching in node [ActivityNode15] failed."
									+ " Variables: " + "[blob] = " + blob + ", " + "[dc] = " + dc + ".");
						}
					...
					if (result7_black != null) {
						...
						// TypeGraph pg = (TypeGraph) result7_black[2];
						HBlobDetectorImpl.pattern_HBlobDetector_0_7_ActivityNode69_greenBBFB(tAnnotationType, tClass,
								this);
						// TAnnotation annotation = (TAnnotation) result7_green[2];
	...
	public static final Object[] pattern_HBlobDetector_0_7_ActivityNode69_greenBBFB(TAnnotationType tAnnotationType,
			TClass tClass, HBlobDetector _this) {
		...
		return new Object[] { tAnnotationType, tClass, annotation, _this };
	}
