...
public class HLargeClassLowCohesionDetectorImpl extends HClassBasedCalculatorImpl
	 ...
	 * @generated
	 */
	public HAnnotation calculate(TClass tClass) {// ActivityNode33
		...
		if (result1_black != null) {
			// HLargeClassSmell large = (HLargeClassSmell) result1_black[0];
		} else {
			// ActivityNode34
			...
			if (result2_black != null) {
				// HLowCohesionSmell low = (HLowCohesionSmell) result2_black[0];
			} else {
		...
		if (result4_black == null) {
			throw new RuntimeException("Pattern matching in node [ActivityNode35] failed." + " Variables: "
