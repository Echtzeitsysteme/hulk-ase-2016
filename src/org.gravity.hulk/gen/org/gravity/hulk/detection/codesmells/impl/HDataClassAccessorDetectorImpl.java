...
public class HDataClassAccessorDetectorImpl extends HCodeSmellDetectorImpl implements HDataClassAccessorDetector {
	...
	public HAnnotation calculate(TClass tClass) {
		...
		if (result1_black == null) {
			throw new RuntimeException("Pattern matching in node [ActivityNode55] failed." + " Variables: "
					+ "[tClass] = " + tClass + ".");
		}
		...
		if (result2_black != null) {
			// TMember tAnyAccessing = (TMember) result2_black[0];
			// TMember tAnyAccessed = (TMember) result2_black[1];
			// TAccess anyAccess = (TAccess) result2_black[2];
			// TClass tAnyDataClass = (TClass) result2_black[3];
			// HDataClassSmell tData = (HDataClassSmell) result2_black[5];
			...
			if (result3_black == null) {
				throw new RuntimeException("Pattern matching in node [ActivityNode66] failed." + " Variables: "
			...
			for (Object[] result4_black : HDataClassAccessorDetectorImpl
				...
				// TClass dataClass = (TClass) result4_black[1];
				// TMember tAccessing = (TMember) result4_black[2];
				// TMember tAccessed = (TMember) result4_black[3];
				// TAccess access = (TAccess) result4_black[4];
				...
				if (result6_black == null) {
					throw new RuntimeException("Pattern matching in node [ActivityNode52] failed." + " Variables: "
							+ "[ad] = " + ad + ", " + "[smell] = " + smell + ".");
				}
