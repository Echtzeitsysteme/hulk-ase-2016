...
public class HLocalMethodAccessCalculatorImpl extends HClassBasedMetricCalculatorImpl
	...
	public HMetric calculateMetric(TClass tClass) {
		...
		for (Object[] result2_black : HLocalMethodAccessCalculatorImpl
			...
			// TMethodDefinition tAnyAccessingMethod = (TMethodDefinition) result2_black[1];
			// TMethodDefinition tAnyAccessedMethod = (TMethodDefinition) result2_black[2];
			// TAccess tAnyAccess = (TAccess) result2_black[3];
			// ActivityNode12
