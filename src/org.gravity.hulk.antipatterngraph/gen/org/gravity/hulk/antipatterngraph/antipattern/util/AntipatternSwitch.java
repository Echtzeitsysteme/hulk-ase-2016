...
public class AntipatternSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case AntipatternPackage.HBLOB_ANTI_PATTERN: {
			...
			if (result == null)
				result = caseTElementWithId(hBlobAntiPattern);
			if (result == null)
		...
		case AntipatternPackage.HGOD_CLASS_ANTI_PATTERN: {
			...
			if (result == null)
				result = caseTElementWithId(hGodClassAntiPattern);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case AntipatternPackage.HSWISS_ARMY_KNIFE_ANTI_PATTERN: {
			...
			if (result == null)
				result = caseTElementWithId(hSwissArmyKnifeAntiPattern);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case AntipatternPackage.HSPAGHETTI_CODE_ANTI_PATTERN: {
			...
			if (result == null)
				result = caseTElementWithId(hSpaghettiCodeAntiPattern);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
