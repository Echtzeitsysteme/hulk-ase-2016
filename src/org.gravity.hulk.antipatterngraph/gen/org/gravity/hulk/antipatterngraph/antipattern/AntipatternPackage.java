...
public interface AntipatternPackage extends EPackage {
	 ...
	 * @generated
	 */
	String eNS_URI = "platform:/plugin/org.gravity.hulk.antipatterngraph/model/Antipatterngraph.ecore#//antipattern";
	 ...
	 * @ordered
	 */
	int HBLOB_ANTI_PATTERN__ID = AntipatterngraphPackage.HANTI_PATTERN__ID;
	 ...
	 * @ordered
	 */
	int HGOD_CLASS_ANTI_PATTERN__ID = AntipatterngraphPackage.HANTI_PATTERN__ID;
	 ...
	 * @ordered
	 */
	int HSWISS_ARMY_KNIFE_ANTI_PATTERN__ID = AntipatterngraphPackage.HANTI_PATTERN__ID;
	 ...
	 * @ordered
	 */
	int HSWISS_ARMY_KNIFE_ANTI_PATTERN__HLARGE_CLASS_SMELL = AntipatterngraphPackage.HANTI_PATTERN_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int HSWISS_ARMY_KNIFE_ANTI_PATTERN__HNUMBER_OF_INCOMMING_INVOCATIONS_METRIC = AntipatterngraphPackage.HANTI_PATTERN_FEATURE_COUNT
			+ 2;
	 ...
	 * @ordered
	 */
	int HSPAGHETTI_CODE_ANTI_PATTERN__ID = AntipatterngraphPackage.HANTI_PATTERN__ID;
	 ...
	 * @ordered
	 */
	int HSPAGHETTI_CODE_ANTI_PATTERN__HNUMBER_OF_CHILD = AntipatterngraphPackage.HANTI_PATTERN_FEATURE_COUNT + 3;

	/**
	 * The feature id for the '<em><b>HDepth Of Inheritance</b></em>' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int HSPAGHETTI_CODE_ANTI_PATTERN__HDEPTH_OF_INHERITANCE = AntipatterngraphPackage.HANTI_PATTERN_FEATURE_COUNT + 4;
	...
	/**
	 * Returns the meta object for the reference '{@link org.gravity.hulk.antipatterngraph.antipattern.HSwissArmyKnifeAntiPattern#getHNumberOfIncommingInvocationsMetric <em>HNumber Of Incomming Invocations Metric</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the reference '<em>HNumber Of Incomming Invocations Metric</em>'.
	 * @see org.gravity.hulk.antipatterngraph.antipattern.HSwissArmyKnifeAntiPattern#getHNumberOfIncommingInvocationsMetric()
	 * @see #getHSwissArmyKnifeAntiPattern()
	 * @generated
	 */
	EReference getHSwissArmyKnifeAntiPattern_HNumberOfIncommingInvocationsMetric();
	...
	/**
	 * Returns the meta object for the reference '{@link org.gravity.hulk.antipatterngraph.antipattern.HSpaghettiCodeAntiPattern#getHDepthOfInheritance <em>HDepth Of Inheritance</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the reference '<em>HDepth Of Inheritance</em>'.
	 * @see org.gravity.hulk.antipatterngraph.antipattern.HSpaghettiCodeAntiPattern#getHDepthOfInheritance()
	 * @see #getHSpaghettiCodeAntiPattern()
	 * @generated
	 */
	EReference getHSpaghettiCodeAntiPattern_HDepthOfInheritance();
	...
	interface Literals {
		 ...
		 * @generated
		 */
		EReference HSWISS_ARMY_KNIFE_ANTI_PATTERN__HNUMBER_OF_INCOMMING_INVOCATIONS_METRIC = eINSTANCE
				.getHSwissArmyKnifeAntiPattern_HNumberOfIncommingInvocationsMetric();
		...
		/**
		 * The meta object literal for the '<em><b>HDepth Of Inheritance</b></em>' reference feature.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @generated
		 */
		EReference HSPAGHETTI_CODE_ANTI_PATTERN__HDEPTH_OF_INHERITANCE = eINSTANCE
				.getHSpaghettiCodeAntiPattern_HDepthOfInheritance();
