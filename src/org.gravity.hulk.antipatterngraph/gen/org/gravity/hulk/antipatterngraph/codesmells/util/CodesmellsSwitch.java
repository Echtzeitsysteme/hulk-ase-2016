...
public class CodesmellsSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case CodesmellsPackage.HCONTROLLER_CLASS_SMELL: {
			...
			if (result == null)
				result = caseTElementWithId(hControllerClassSmell);
			if (result == null)
		...
		case CodesmellsPackage.HDATA_CLASS_SMELL: {
			...
			if (result == null)
				result = caseTElementWithId(hDataClassSmell);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case CodesmellsPackage.HEMPTY_CLASS_SMELL: {
			...
			if (result == null)
				result = caseTElementWithId(hEmptyClassSmell);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case CodesmellsPackage.HGETTER_SETTER_SMELL: {
			...
			if (result == null)
				result = caseTElementWithId(hGetterSetterSmell);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case CodesmellsPackage.HLARGE_CLASS_LOW_COHESION_SMELL: {
			...
			if (result == null)
				result = caseTElementWithId(hLargeClassLowCohesionSmell);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case CodesmellsPackage.HLARGE_CLASS_SMELL: {
			...
			if (result == null)
				result = caseTElementWithId(hLargeClassSmell);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case CodesmellsPackage.HLOW_COHESION_SMELL: {
			...
			if (result == null)
				result = caseTElementWithId(hLowCohesionSmell);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case CodesmellsPackage.HDATA_CLASS_ACCESSOR: {
			...
			if (result == null)
				result = caseTElementWithId(hDataClassAccessor);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case CodesmellsPackage.HMUCH_OVERLOADING_CODE_SMELL: {
			...
			if (result == null)
				result = caseTElementWithId(hMuchOverloadingCodeSmell);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case CodesmellsPackage.HMANY_PARAMETERS_CODE_SMELL: {
			...
			if (result == null)
				result = caseTElementWithId(hManyParametersCodeSmell);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case CodesmellsPackage.HINTENSE_FIELD_USAGE_CODE_SMELL: {
			...
			if (result == null)
				result = caseTElementWithId(hIntenseFieldUsageCodeSmell);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
