...
public interface AntipatterngraphPackage extends EPackage {
	 ...
	 * @generated
	 */
	String eNS_URI = "platform:/plugin/org.gravity.hulk.antipatterngraph/model/Antipatterngraph.ecore";
	 ...
	 * @ordered
	 */
	int HANNOTATION__ID = BasicPackage.TANNOTATION__ID;
	 ...
	 * @ordered
	 */
	int HANNOTATION__TANNOTATED = BasicPackage.TANNOTATION__TANNOTATED;
	 ...
	 * @ordered
	 */
	int HANNOTATION__TYPE = BasicPackage.TANNOTATION__TYPE;
	 ...
	 * @ordered
	 */
	int HANNOTATION__APG = BasicPackage.TANNOTATION_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int HANNOTATION__PART_OF = BasicPackage.TANNOTATION_FEATURE_COUNT + 1;
	 ...
	 * @ordered
	 */
	int HANNOTATION__CHANGED = BasicPackage.TANNOTATION_FEATURE_COUNT + 2;
	 ...
	 * @ordered
	 */
	int HANNOTATION_FEATURE_COUNT = BasicPackage.TANNOTATION_FEATURE_COUNT + 3;
	 ...
	 * @ordered
	 */
	int HANNOTATION_OPERATION_COUNT = BasicPackage.TANNOTATION_OPERATION_COUNT + 0;
	 ...
	 * @ordered
	 */
	int HANTI_PATTERN__ID = HANNOTATION__ID;
	 ...
	 * @ordered
	 */
	int HCODE_SMELL__ID = HANNOTATION__ID;
	 ...
	 * @ordered
	 */
	int HMETRIC__ID = HANNOTATION__ID;
