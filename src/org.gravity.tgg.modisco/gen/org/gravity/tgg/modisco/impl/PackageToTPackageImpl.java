...
public class PackageToTPackageImpl extends AbstractCorrespondenceImpl implements PackageToTPackage {
	 ...
	 * @ordered
	 */
	protected org.eclipse.gmt.modisco.java.Package source;
	 ...
	 * @generated
	 */
	public org.eclipse.gmt.modisco.java.Package getSource() {
		if (source != null && source.eIsProxy()) {
			InternalEObject oldSource = (InternalEObject) source;
			source = (org.eclipse.gmt.modisco.java.Package) eResolveProxy(oldSource);
			if (source != oldSource) {
	 ...
	 * @generated
	 */
	public org.eclipse.gmt.modisco.java.Package basicGetSource() {
		return source;
	}
	 ...
	 * @generated
	 */
	public void setSource(org.eclipse.gmt.modisco.java.Package newSource) {
		org.eclipse.gmt.modisco.java.Package oldSource = source;
		source = newSource;
		if (eNotificationRequired())
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
		case ModiscoPackage.PACKAGE_TO_TPACKAGE__SOURCE:
			setSource((org.eclipse.gmt.modisco.java.Package) newValue);
			return;
		case ModiscoPackage.PACKAGE_TO_TPACKAGE__TARGET:
	...
	public void eUnset(int featureID) {
		switch (featureID) {
		case ModiscoPackage.PACKAGE_TO_TPACKAGE__SOURCE:
			setSource((org.eclipse.gmt.modisco.java.Package) null);
			return;
		case ModiscoPackage.PACKAGE_TO_TPACKAGE__TARGET:
