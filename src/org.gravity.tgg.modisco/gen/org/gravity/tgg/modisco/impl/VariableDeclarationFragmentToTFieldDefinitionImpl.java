 ...
 * <ul>
 *   <li>{@link org.gravity.tgg.modisco.impl.VariableDeclarationFragmentToTFieldDefinitionImpl#getSource <em>Source</em>}</li>
 *   <li>{@link org.gravity.tgg.modisco.impl.VariableDeclarationFragmentToTFieldDefinitionImpl#getTarget <em>Target</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class VariableDeclarationFragmentToTFieldDefinitionImpl extends AbstractCorrespondenceImpl
	...
	protected EClass eStaticClass() {
		return ModiscoPackage.Literals.VARIABLE_DECLARATION_FRAGMENT_TO_TFIELD_DEFINITION;
	}
			...
			if (source != oldSource) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ModiscoPackage.VARIABLE_DECLARATION_FRAGMENT_TO_TFIELD_DEFINITION__SOURCE, oldSource,
							source));
			}
		}
		return source;
	...
	public void setSource(VariableDeclarationFragment newSource) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ModiscoPackage.VARIABLE_DECLARATION_FRAGMENT_TO_TFIELD_DEFINITION__SOURCE, oldSource, source));
	}
	...
	public TFieldDefinition getTarget() {
		if (target != null && target.eIsProxy()) {
			...
			if (target != oldTarget) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ModiscoPackage.VARIABLE_DECLARATION_FRAGMENT_TO_TFIELD_DEFINITION__TARGET, oldTarget,
							target));
			}
		}
		return target;
	...
	public void setTarget(TFieldDefinition newTarget) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ModiscoPackage.VARIABLE_DECLARATION_FRAGMENT_TO_TFIELD_DEFINITION__TARGET, oldTarget, target));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case ModiscoPackage.VARIABLE_DECLARATION_FRAGMENT_TO_TFIELD_DEFINITION__SOURCE:
			if (resolve)
				return getSource();
			return basicGetSource();
		case ModiscoPackage.VARIABLE_DECLARATION_FRAGMENT_TO_TFIELD_DEFINITION__TARGET:
			if (resolve)
				return getTarget();
