 ...
 * <ul>
 *   <li>{@link org.gravity.tgg.modisco.impl.AnnotationToTAnnotationImpl#getSource <em>Source</em>}</li>
 *   <li>{@link org.gravity.tgg.modisco.impl.AnnotationToTAnnotationImpl#getTarget <em>Target</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class AnnotationToTAnnotationImpl extends AbstractCorrespondenceImpl implements AnnotationToTAnnotation {
	...
	protected EClass eStaticClass() {
		return ModiscoPackage.Literals.ANNOTATION_TO_TANNOTATION;
	}
			...
			if (source != oldSource) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ModiscoPackage.ANNOTATION_TO_TANNOTATION__SOURCE, oldSource, source));
			}
		}
		return source;
	}
	...
	public void setSource(Annotation newSource) {
		...
		source = newSource;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModiscoPackage.ANNOTATION_TO_TANNOTATION__SOURCE,
					oldSource, source));
	}
	...
	public TAnnotation getTarget() {
		if (target != null && target.eIsProxy()) {
			...
			if (target != oldTarget) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ModiscoPackage.ANNOTATION_TO_TANNOTATION__TARGET, oldTarget, target));
			}
		}
		return target;
	}
	...
	public void setTarget(TAnnotation newTarget) {
		...
		target = newTarget;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModiscoPackage.ANNOTATION_TO_TANNOTATION__TARGET,
					oldTarget, target));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case ModiscoPackage.ANNOTATION_TO_TANNOTATION__SOURCE:
			if (resolve)
				return getSource();
			return basicGetSource();
		case ModiscoPackage.ANNOTATION_TO_TANNOTATION__TARGET:
			if (resolve)
				return getTarget();
