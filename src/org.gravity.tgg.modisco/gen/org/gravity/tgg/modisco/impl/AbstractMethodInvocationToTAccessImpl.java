 ...
 * <ul>
 *   <li>{@link org.gravity.tgg.modisco.impl.AbstractMethodInvocationToTAccessImpl#getSource <em>Source</em>}</li>
 *   <li>{@link org.gravity.tgg.modisco.impl.AbstractMethodInvocationToTAccessImpl#getTarget <em>Target</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class AbstractMethodInvocationToTAccessImpl extends AbstractCorrespondenceImpl
	...
	protected EClass eStaticClass() {
		return ModiscoPackage.Literals.ABSTRACT_METHOD_INVOCATION_TO_TACCESS;
	}
			...
			if (source != oldSource) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ModiscoPackage.ABSTRACT_METHOD_INVOCATION_TO_TACCESS__SOURCE, oldSource, source));
			}
		}
		return source;
	}
	...
	public TAccess getTarget() {
		if (target != null && target.eIsProxy()) {
			...
			if (target != oldTarget) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ModiscoPackage.ABSTRACT_METHOD_INVOCATION_TO_TACCESS__TARGET, oldTarget, target));
			}
		}
		return target;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case ModiscoPackage.ABSTRACT_METHOD_INVOCATION_TO_TACCESS__SOURCE:
			if (resolve)
				return getSource();
			return basicGetSource();
		case ModiscoPackage.ABSTRACT_METHOD_INVOCATION_TO_TACCESS__TARGET:
			if (resolve)
				return getTarget();
