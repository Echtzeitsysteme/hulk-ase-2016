 ...
 * <ul>
 *   <li>{@link org.gravity.tgg.modisco.impl.TypeToTAbstractTypeImpl#getSource <em>Source</em>}</li>
 *   <li>{@link org.gravity.tgg.modisco.impl.TypeToTAbstractTypeImpl#getTarget <em>Target</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TypeToTAbstractTypeImpl extends AbstractCorrespondenceImpl implements TypeToTAbstractType {
	...
	protected EClass eStaticClass() {
		return ModiscoPackage.Literals.TYPE_TO_TABSTRACT_TYPE;
	}
			...
			if (source != oldSource) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ModiscoPackage.TYPE_TO_TABSTRACT_TYPE__SOURCE, oldSource, source));
			}
		}
		return source;
	}
	...
	public void setSource(Type newSource) {
		...
		source = newSource;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModiscoPackage.TYPE_TO_TABSTRACT_TYPE__SOURCE,
					oldSource, source));
	}
	...
	public TAbstractType getTarget() {
		if (target != null && target.eIsProxy()) {
			...
			if (target != oldTarget) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ModiscoPackage.TYPE_TO_TABSTRACT_TYPE__TARGET, oldTarget, target));
			}
		}
		return target;
	}
	...
	public void setTarget(TAbstractType newTarget) {
		...
		target = newTarget;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModiscoPackage.TYPE_TO_TABSTRACT_TYPE__TARGET,
					oldTarget, target));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case ModiscoPackage.TYPE_TO_TABSTRACT_TYPE__SOURCE:
			if (resolve)
				return getSource();
			return basicGetSource();
		case ModiscoPackage.TYPE_TO_TABSTRACT_TYPE__TARGET:
			if (resolve)
				return getTarget();
