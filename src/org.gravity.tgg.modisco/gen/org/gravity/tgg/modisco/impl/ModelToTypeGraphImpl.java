 ...
 * <ul>
 *   <li>{@link org.gravity.tgg.modisco.impl.ModelToTypeGraphImpl#getSource <em>Source</em>}</li>
 *   <li>{@link org.gravity.tgg.modisco.impl.ModelToTypeGraphImpl#getTarget <em>Target</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ModelToTypeGraphImpl extends AbstractCorrespondenceImpl implements ModelToTypeGraph {
	...
	protected EClass eStaticClass() {
		return ModiscoPackage.Literals.MODEL_TO_TYPE_GRAPH;
	}
			...
			if (source != oldSource) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ModiscoPackage.MODEL_TO_TYPE_GRAPH__SOURCE, oldSource, source));
			}
		}
		return source;
	}
	...
	public void setSource(Model newSource) {
		...
		source = newSource;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModiscoPackage.MODEL_TO_TYPE_GRAPH__SOURCE, oldSource,
					source));
	}
	...
	public TypeGraph getTarget() {
		if (target != null && target.eIsProxy()) {
			...
			if (target != oldTarget) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ModiscoPackage.MODEL_TO_TYPE_GRAPH__TARGET, oldTarget, target));
			}
		}
		return target;
	}
	...
	public void setTarget(TypeGraph newTarget) {
		...
		target = newTarget;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModiscoPackage.MODEL_TO_TYPE_GRAPH__TARGET, oldTarget,
					target));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case ModiscoPackage.MODEL_TO_TYPE_GRAPH__SOURCE:
			if (resolve)
				return getSource();
			return basicGetSource();
		case ModiscoPackage.MODEL_TO_TYPE_GRAPH__TARGET:
			if (resolve)
				return getTarget();
