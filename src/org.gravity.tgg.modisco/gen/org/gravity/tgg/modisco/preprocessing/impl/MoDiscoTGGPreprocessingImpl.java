 ...
 * @generated
 */
public class MoDiscoTGGPreprocessingImpl extends EObjectImpl implements MoDiscoTGGPreprocessing {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected MoDiscoTGGPreprocessingImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return PreprocessingPackage.Literals.MO_DISCO_TGG_PREPROCESSING;
	}
		...
		if (MoDiscoTGGPreprocessingImpl.pattern_MoDiscoTGGPreprocessing_5_2_ActivityNode2_expressionFBB(this, model)) {
			...
			if (MoDiscoTGGPreprocessingImpl.pattern_MoDiscoTGGPreprocessing_5_3_ActivityNode3_expressionFBB(this,
				...
				if (MoDiscoTGGPreprocessingImpl.pattern_MoDiscoTGGPreprocessing_5_4_ActivityNode39_expressionFBB(this,
						model)) {
					return MoDiscoTGGPreprocessingImpl.pattern_MoDiscoTGGPreprocessing_5_5_expressionF();
				} else {
					return MoDiscoTGGPreprocessingImpl.pattern_MoDiscoTGGPreprocessing_5_6_expressionF();
				}

			} else {
				return MoDiscoTGGPreprocessingImpl.pattern_MoDiscoTGGPreprocessing_5_7_expressionF();
			}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
		case PreprocessingPackage.MO_DISCO_TGG_PREPROCESSING___CREATE_PARAM_LIST__MMETHODDEFINITION_MMETHODSIGNATURE:
			return createParamList((MMethodDefinition) arguments.get(0), (MMethodSignature) arguments.get(1));
		case PreprocessingPackage.MO_DISCO_TGG_PREPROCESSING___FIX_STATIC_METHOD_CALL_ON_FIELD__MGRAVITYMODEL:
			return fixStaticMethodCallOnField((MGravityModel) arguments.get(0));
		case PreprocessingPackage.MO_DISCO_TGG_PREPROCESSING___GET_MOST_GENERIC_RETURN_TYPE__MMETHODDEFINITION:
			return getMostGenericReturnType((MMethodDefinition) arguments.get(0));
		case PreprocessingPackage.MO_DISCO_TGG_PREPROCESSING___IS_PARAM_LIST_EQUAL__MMETHODDEFINITION_MMETHODSIGNATURE:
			return isParamListEqual((MMethodDefinition) arguments.get(0), (MMethodSignature) arguments.get(1));
		case PreprocessingPackage.MO_DISCO_TGG_PREPROCESSING___IS_SUPER_TYPE__TYPE_TYPE:
			return isSuperType((Type) arguments.get(0), (Type) arguments.get(1));
		case PreprocessingPackage.MO_DISCO_TGG_PREPROCESSING___PREPROCESS__MGRAVITYMODEL:
			return preprocess((MGravityModel) arguments.get(0));
		case PreprocessingPackage.MO_DISCO_TGG_PREPROCESSING___PREPROCESS_FIELDS__MGRAVITYMODEL:
			return preprocessFields((MGravityModel) arguments.get(0));
		case PreprocessingPackage.MO_DISCO_TGG_PREPROCESSING___PREPROCESS_INV__MGRAVITYMODEL:
			return preprocessInv((MGravityModel) arguments.get(0));
		case PreprocessingPackage.MO_DISCO_TGG_PREPROCESSING___PREPROCESS_METHODS__MGRAVITYMODEL:
			return preprocessMethods((MGravityModel) arguments.get(0));
		case PreprocessingPackage.MO_DISCO_TGG_PREPROCESSING___UPDATE_NAME__MNAME_MDEFINITION:
			return updateName((MName) arguments.get(0), (MDefinition) arguments.get(1));
		case PreprocessingPackage.MO_DISCO_TGG_PREPROCESSING___PREPROCESS_ACCESSES__MGRAVITYMODEL:
			return preprocessAccesses((MGravityModel) arguments.get(0));
		}
	...
	public static final boolean pattern_MoDiscoTGGPreprocessing_5_5_expressionF() {
		boolean _result = Boolean.valueOf(true);
		return _result;
	}

	public static final boolean pattern_MoDiscoTGGPreprocessing_5_6_expressionF() {
		boolean _result = false;
		return _result;
	}

	public static final boolean pattern_MoDiscoTGGPreprocessing_5_7_expressionF() {
		boolean _result = false;
		return _result;
	}
	...
	public static final boolean pattern_MoDiscoTGGPreprocessing_7_3_ActivityNode27_expressionFBBB(
			MoDiscoTGGPreprocessing _this, MName mName, MDefinition mDef) {
	...
	public static final Object[] pattern_MoDiscoTGGPreprocessing_8_6_ActivityNode23_bindingFBB(
			MoDiscoTGGPreprocessing _this, MMethodDefinition mDef) {
	...
	public static final boolean pattern_MoDiscoTGGPreprocessing_8_8_ActivityNode19_expressionFBBB(
			MoDiscoTGGPreprocessing _this, MMethodDefinition mDef, MMethodSignature mSig) {
	...
	public static final boolean pattern_MoDiscoTGGPreprocessing_8_12_ActivityNode21_expressionFBBB(
			MoDiscoTGGPreprocessing _this, MMethodDefinition mDef, MMethodSignature mNewSig) {
