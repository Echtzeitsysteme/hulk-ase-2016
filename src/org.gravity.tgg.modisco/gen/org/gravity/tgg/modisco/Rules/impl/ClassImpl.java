 ...
 * @generated
 */
public class ClassImpl extends AbstractRuleImpl implements org.gravity.tgg.modisco.Rules.Class {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		ClassDeclaration mType = (ClassDeclaration) result1_bindingAndBlack[4];
		...
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching in node [bookkeeping for edges] failed." + " Variables: "
					...
					+ ", " + "[mTypeToTType] = " + mTypeToTType + ", " + "[pg] = " + pg + ", "
					+ "[mBodyToTAnnotation] = " + mBodyToTAnnotation + ", " + "[mType] = " + mType + ".");
		}
		ClassImpl.pattern_Class_1_3_bookkeepingforedges_greenBBBBBBBBFFFFFFFFFFFF(ruleresult, tType, tPackage, mPackage,
		...
		ClassImpl.pattern_Class_1_5_registerobjects_expressionBBBBBBBBBB(this, ruleresult, mPackageToTPackage, tType,
				tPackage, mPackage, mTypeToTType, pg, mBodyToTAnnotation, mType);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		ClassDeclaration mType = (ClassDeclaration) result2_binding[1];
	...
	public CSP isAppropriate_solveCsp_FWD(Match match, org.eclipse.gmt.modisco.java.Package mPackage,
			ClassDeclaration mType) {// Create CSP
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, PackageToTPackage mPackageToTPackage,
			TPackage tPackage, org.eclipse.gmt.modisco.java.Package mPackage, TypeGraph pg, ClassDeclaration mType) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	...
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject mPackageToTPackage, EObject tType,
			EObject tPackage, EObject mPackage, EObject mTypeToTType, EObject pg, EObject mBodyToTAnnotation,
			EObject mType) {
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		ClassDeclaration mType = (ClassDeclaration) result1_green[4];
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_21(EMoflonEdge _edge_ownedElements) {
		// prepare return value
		...
		for (Object[] result2_black : ClassImpl.pattern_Class_20_2_testcorematchandDECs_blackFFB(_edge_ownedElements)) {
			org.eclipse.gmt.modisco.java.Package mPackage = (org.eclipse.gmt.modisco.java.Package) result2_black[0];
			ClassDeclaration mType = (ClassDeclaration) result2_black[1];
			Object[] result2_green = ClassImpl.pattern_Class_20_2_testcorematchandDECs_greenFB(__eClass);
			Match match = (Match) result2_green[0];

			// bookkeeping with generic isAppropriate method
			if (ClassImpl.pattern_Class_20_3_bookkeepingwithgenericisAppropriatemethod_expressionFBBBB(this, match,
					mPackage, mType)) {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_19(EMoflonEdge _edge_ownedTypes) {
		// prepare return value
		...
		// ForEach test core match and DECs
		for (Object[] result2_black : ClassImpl.pattern_Class_21_2_testcorematchandDECs_blackFFFB(_edge_ownedTypes)) {
			...
			// bookkeeping with generic isAppropriate method
			if (ClassImpl.pattern_Class_21_3_bookkeepingwithgenericisAppropriatemethod_expressionFBBBBB(this, match,
					tType, tPackage, pg)) {
				// Ensure that the correct types of elements are matched
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result2_binding = ClassImpl.pattern_Class_24_2_matchcontext_bindingFFFFFBB(targetMatch, sourceMatch);
		if (result2_binding == null) {
		...
		ClassDeclaration mType = (ClassDeclaration) result2_binding[4];
		for (Object[] result2_black : ClassImpl.pattern_Class_24_2_matchcontext_blackFBBBBBBB(tType, tPackage, mPackage,
				pg, mType, sourceMatch, targetMatch)) {
			PackageToTPackage mPackageToTPackage = (PackageToTPackage) result2_black[0];
			Object[] result2_green = ClassImpl.pattern_Class_24_2_matchcontext_greenBBBBBBBFB(mPackageToTPackage, tType,
					tPackage, mPackage, pg, mType, sourceMatch, targetMatch);
			CCMatch isApplicableMatch = (CCMatch) result2_green[7];

			// check csp
			Object[] result3_bindingAndBlack = ClassImpl.pattern_Class_24_3_checkcsp_bindingAndBlackFBBBBBBBBBB(this,
			...
			if (result3_bindingAndBlack != null) {
				...
				Object[] result4_black = ClassImpl.pattern_Class_24_4_createcorrespondence_blackBBBBBB(tType, tPackage,
				...
				ClassImpl.pattern_Class_24_4_createcorrespondence_greenBFFBB(tType, mType, isApplicableMatch);
				...
				Object[] result5_black = ClassImpl.pattern_Class_24_5_addtoreturnedresult_blackBB(result,
						isApplicableMatch);
				if (result5_black == null) {
					throw new RuntimeException(
				...
				ClassImpl.pattern_Class_24_5_addtoreturnedresult_greenBB(result, isApplicableMatch);

			} else {
			}

		}
		return ClassImpl.pattern_Class_24_6_expressionFB(result);
	}
	...
	public CSP isApplicable_solveCsp_CC(CCMatch isApplicableMatch, PackageToTPackage mPackageToTPackage, TClass tType,
			TPackage tPackage, org.eclipse.gmt.modisco.java.Package mPackage, TypeGraph pg, ClassDeclaration mType,
	 ...
	 * @generated
	 */
	public boolean checkDEC_FWD(org.eclipse.gmt.modisco.java.Package mPackage, ClassDeclaration mType) {// match tgg pattern
		...
		for (Object[] result2_black : ClassImpl.pattern_Class_29_2_isapplicablecore_blackFFFFFBB(ruleEntryContainer,
			...
			if (ClassImpl.pattern_Class_29_4_checkCSP_expressionFBB(this, csp)) {
				...
				if (result5_black != null) {
					...
					ClassImpl.pattern_Class_29_6_perform_greenFBBFBFFBB(tPackage, mPackage, pg, ruleResult, csp);
					// TClass tType = (TClass) result6_green[0];
					// TypeToTAbstractType mTypeToTType = (TypeToTAbstractType) result6_green[3];
					// BodyDeclarationToTAnnotatable mBodyToTAnnotation = (BodyDeclarationToTAnnotatable) result6_green[5];
					// ClassDeclaration mType = (ClassDeclaration) result6_green[6];
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
		case RulesPackage.CLASS___IS_APPROPRIATE_FWD__MATCH_PACKAGE_CLASSDECLARATION:
		...
		case RulesPackage.CLASS___REGISTER_OBJECTS_TO_MATCH_FWD__MATCH_PACKAGE_CLASSDECLARATION:
			registerObjectsToMatch_FWD((Match) arguments.get(0),
					(org.eclipse.gmt.modisco.java.Package) arguments.get(1), (ClassDeclaration) arguments.get(2));
			return null;
		case RulesPackage.CLASS___IS_APPROPRIATE_SOLVE_CSP_FWD__MATCH_PACKAGE_CLASSDECLARATION:
			return isAppropriate_solveCsp_FWD((Match) arguments.get(0),
					(org.eclipse.gmt.modisco.java.Package) arguments.get(1), (ClassDeclaration) arguments.get(2));
		case RulesPackage.CLASS___IS_APPROPRIATE_CHECK_CSP_FWD__CSP:
			return isAppropriate_checkCsp_FWD((CSP) arguments.get(0));
		case RulesPackage.CLASS___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_PACKAGETOTPACKAGE_TPACKAGE_PACKAGE_TYPEGRAPH_CLASSDECLARATION:
			return isApplicable_solveCsp_FWD((IsApplicableMatch) arguments.get(0), (PackageToTPackage) arguments.get(1),
					...
					(TypeGraph) arguments.get(4), (ClassDeclaration) arguments.get(5));
		...
		case RulesPackage.CLASS___IS_APPROPRIATE_FWD_EMOFLON_EDGE_21__EMOFLONEDGE:
			return isAppropriate_FWD_EMoflonEdge_21((EMoflonEdge) arguments.get(0));
		case RulesPackage.CLASS___IS_APPROPRIATE_BWD_EMOFLON_EDGE_19__EMOFLONEDGE:
		...
		case RulesPackage.CLASS___IS_APPLICABLE_SOLVE_CSP_CC__CCMATCH_PACKAGETOTPACKAGE_TCLASS_TPACKAGE_PACKAGE_TYPEGRAPH_CLASSDECLARATION_MATCH_MATCH:
		...
		case RulesPackage.CLASS___CHECK_DEC_FWD__PACKAGE_CLASSDECLARATION:
			return checkDEC_FWD((org.eclipse.gmt.modisco.java.Package) arguments.get(0),
					(ClassDeclaration) arguments.get(1));
	...
	public static final Object[] pattern_Class_0_1_initialbindings_blackBBBB(org.gravity.tgg.modisco.Rules.Class _this,
			Match match, org.eclipse.gmt.modisco.java.Package mPackage, ClassDeclaration mType) {
		return new Object[] { _this, match, mPackage, mType };
	}

	public static final Object[] pattern_Class_0_2_SolveCSP_bindingFBBBB(org.gravity.tgg.modisco.Rules.Class _this,
			Match match, org.eclipse.gmt.modisco.java.Package mPackage, ClassDeclaration mType) {
	...
	public static final Object[] pattern_Class_0_2_SolveCSP_bindingAndBlackFBBBB(
			org.gravity.tgg.modisco.Rules.Class _this, Match match, org.eclipse.gmt.modisco.java.Package mPackage,
			ClassDeclaration mType) {
	...
	public static final boolean pattern_Class_0_3_CheckCSP_expressionFBB(org.gravity.tgg.modisco.Rules.Class _this,
			CSP csp) {
	...
	public static final Object[] pattern_Class_0_4_collectelementstobetranslated_blackBBB(Match match,
			org.eclipse.gmt.modisco.java.Package mPackage, ClassDeclaration mType) {
			...
			if (tmpTPackage instanceof TPackage) {
				...
				if (tmpMPackage instanceof org.eclipse.gmt.modisco.java.Package) {
					...
					if (tmpPg instanceof TypeGraph) {
						...
						if (tmpMType instanceof ClassDeclaration) {
							ClassDeclaration mType = (ClassDeclaration) tmpMType;
	...
	public static final Object[] pattern_Class_1_1_performtransformation_blackBBBBBFBB(
			...
			TypeGraph pg, ClassDeclaration mType, org.gravity.tgg.modisco.Rules.Class _this,
			IsApplicableMatch isApplicableMatch) {
	...
	public static final Object[] pattern_Class_1_1_performtransformation_bindingAndBlackFFFFFFBB(
			org.gravity.tgg.modisco.Rules.Class _this, IsApplicableMatch isApplicableMatch) {
		...
		if (result_pattern_Class_1_1_performtransformation_binding != null) {
			...
			org.eclipse.gmt.modisco.java.Package mPackage = (org.eclipse.gmt.modisco.java.Package) result_pattern_Class_1_1_performtransformation_binding[2];
			TypeGraph pg = (TypeGraph) result_pattern_Class_1_1_performtransformation_binding[3];
			ClassDeclaration mType = (ClassDeclaration) result_pattern_Class_1_1_performtransformation_binding[4];
	...
	public static final Object[] pattern_Class_1_1_performtransformation_greenFBFBFBB(TPackage tPackage, TypeGraph pg,
			ClassDeclaration mType, CSP csp) {
	...
	public static final Object[] pattern_Class_1_3_bookkeepingforedges_greenBBBBBBBBFFFFFFFFFFFF(
			PerformRuleResult ruleresult, EObject tType, EObject tPackage, EObject mPackage, EObject mTypeToTType,
			EObject pg, EObject mBodyToTAnnotation, EObject mType) {
		...
		mPackage__mType____ownedElements.setName(mPackage__mType____ownedElements_name_prime);
		mType__mPackage____package.setName(mType__mPackage____package_name_prime);
		return new Object[] { ruleresult, tType, tPackage, mPackage, mTypeToTType, pg, mBodyToTAnnotation, mType,
	...
	public static final void pattern_Class_1_5_registerobjects_expressionBBBBBBBBBB(
			org.gravity.tgg.modisco.Rules.Class _this, PerformRuleResult ruleresult, EObject mPackageToTPackage,
			EObject tType, EObject tPackage, EObject mPackage, EObject mTypeToTType, EObject pg,
			EObject mBodyToTAnnotation, EObject mType) {
		_this.registerObjects_FWD(ruleresult, mPackageToTPackage, tType, tPackage, mPackage, mTypeToTType, pg,
				mBodyToTAnnotation, mType);
	...
	public static final Object[] pattern_Class_2_1_preparereturnvalue_bindingFB(
			org.gravity.tgg.modisco.Rules.Class _this) {
	...
	public static final Iterable<Object[]> pattern_Class_2_2_corematch_blackFFBBB(
			org.eclipse.gmt.modisco.java.Package mPackage, ClassDeclaration mType, Match match) {
	...
	public static final Object[] pattern_Class_2_4_solveCSP_bindingFBBBBBBB(org.gravity.tgg.modisco.Rules.Class _this,
			IsApplicableMatch isApplicableMatch, PackageToTPackage mPackageToTPackage, TPackage tPackage,
			org.eclipse.gmt.modisco.java.Package mPackage, TypeGraph pg, ClassDeclaration mType) {
	...
	public static final Object[] pattern_Class_2_4_solveCSP_bindingAndBlackFBBBBBBB(
			org.gravity.tgg.modisco.Rules.Class _this, IsApplicableMatch isApplicableMatch,
			PackageToTPackage mPackageToTPackage, TPackage tPackage, org.eclipse.gmt.modisco.java.Package mPackage,
			TypeGraph pg, ClassDeclaration mType) {
	...
	public static final boolean pattern_Class_2_5_checkCSP_expressionFBB(org.gravity.tgg.modisco.Rules.Class _this,
			CSP csp) {
	...
	public static final Object[] pattern_Class_10_1_initialbindings_blackBBBBB(
			org.gravity.tgg.modisco.Rules.Class _this, Match match, TClass tType, TPackage tPackage, TypeGraph pg) {
		return new Object[] { _this, match, tType, tPackage, pg };
	}

	public static final Object[] pattern_Class_10_2_SolveCSP_bindingFBBBBB(org.gravity.tgg.modisco.Rules.Class _this,
	...
	public static final boolean pattern_Class_10_3_CheckCSP_expressionFBB(org.gravity.tgg.modisco.Rules.Class _this,
			CSP csp) {
	...
	public static final Object[] pattern_Class_11_1_performtransformation_blackBBBBBFBB(
			...
			org.eclipse.gmt.modisco.java.Package mPackage, TypeGraph pg, org.gravity.tgg.modisco.Rules.Class _this,
			IsApplicableMatch isApplicableMatch) {
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
	...
	public static final Object[] pattern_Class_11_1_performtransformation_bindingAndBlackFFFFFFBB(
		...
		if (result_pattern_Class_11_1_performtransformation_binding != null) {
			...
			org.eclipse.gmt.modisco.java.Package mPackage = (org.eclipse.gmt.modisco.java.Package) result_pattern_Class_11_1_performtransformation_binding[3];
	...
	public static final Object[] pattern_Class_11_1_performtransformation_greenBBFFFB(TClass tType,
		...
		BodyDeclarationToTAnnotatable mBodyToTAnnotation = ModiscoFactory.eINSTANCE
				.createBodyDeclarationToTAnnotatable();
		ClassDeclaration mType = JavaFactory.eINSTANCE.createClassDeclaration();
	...
	public static final void pattern_Class_11_5_registerobjects_expressionBBBBBBBBBB(
			...
			EObject tType, EObject tPackage, EObject mPackage, EObject mTypeToTType, EObject pg,
			EObject mBodyToTAnnotation, EObject mType) {
		_this.registerObjects_BWD(ruleresult, mPackageToTPackage, tType, tPackage, mPackage, mTypeToTType, pg,
				mBodyToTAnnotation, mType);
	...
	public static final Object[] pattern_Class_12_4_solveCSP_bindingFBBBBBBB(org.gravity.tgg.modisco.Rules.Class _this,
	...
	public static final boolean pattern_Class_12_5_checkCSP_expressionFBB(org.gravity.tgg.modisco.Rules.Class _this,
			CSP csp) {
	...
	public static final Iterable<Object[]> pattern_Class_20_2_testcorematchandDECs_blackFFB(
	...
	public static final boolean pattern_Class_20_3_bookkeepingwithgenericisAppropriatemethod_expressionFBBBB(
			org.gravity.tgg.modisco.Rules.Class _this, Match match, org.eclipse.gmt.modisco.java.Package mPackage,
			ClassDeclaration mType) {
	...
	public static final boolean pattern_Class_20_4_Ensurethatthecorrecttypesofelementsarematched_expressionFBB(
			org.gravity.tgg.modisco.Rules.Class _this, Match match) {
	...
	public static final Object[] pattern_Class_21_2_testcorematchandDECs_black_nac_0BB(TClass tType,
			TPackage tPackage) {
		for (TPackage __DEC_tType_classes_561900 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tType, TPackage.class, "classes")) {
			if (!tPackage.equals(__DEC_tType_classes_561900)) {
	...
	public static final Object[] pattern_Class_21_2_testcorematchandDECs_black_nac_1BB(TClass tType, TypeGraph pg) {
		for (TypeGraph __DEC_tType_classes_451564 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tType, TypeGraph.class, "classes")) {
			if (!pg.equals(__DEC_tType_classes_451564)) {
	...
	public static final Object[] pattern_Class_21_2_testcorematchandDECs_black_nac_2BB(TClass tType,
			TPackage tPackage) {
		TPackage __DEC_tType_ownedTypes_855931 = tType.getPackage();
		if (__DEC_tType_ownedTypes_855931 != null) {
			if (!tPackage.equals(__DEC_tType_ownedTypes_855931)) {
				return new Object[] { tType, tPackage };
			}
		}
	...
	public static final Iterable<Object[]> pattern_Class_21_2_testcorematchandDECs_blackFFFB(
				...
				if (tPackage.getOwnedTypes().contains(tType)) {
					if (tPackage.getClasses().contains(tType)) {
						...
						if (pg != null) {
							if (pg.getClasses().contains(tType)) {
								if (pg.getOwnedTypes().contains(tType)) {
									if (pattern_Class_21_2_testcorematchandDECs_black_nac_0BB(tType,
											tPackage) == null) {
										if (pattern_Class_21_2_testcorematchandDECs_black_nac_2BB(tType,
												tPackage) == null) {
											if (pattern_Class_21_2_testcorematchandDECs_black_nac_1BB(tType,
													pg) == null) {
	...
	public static final boolean pattern_Class_21_3_bookkeepingwithgenericisAppropriatemethod_expressionFBBBBB(
			org.gravity.tgg.modisco.Rules.Class _this, Match match, TClass tType, TPackage tPackage, TypeGraph pg) {
	...
	public static final Object[] pattern_Class_24_1_prepare_blackB(org.gravity.tgg.modisco.Rules.Class _this) {
	...
	public static final Object[] pattern_Class_24_2_matchcontext_bindingFFFFFBB(Match targetMatch, Match sourceMatch) {
	...
	public static final Iterable<Object[]> pattern_Class_24_2_matchcontext_blackFBBBBBBB(TClass tType,
			TPackage tPackage, org.eclipse.gmt.modisco.java.Package mPackage, TypeGraph pg, ClassDeclaration mType,
	...
	public static final Object[] pattern_Class_24_2_matchcontext_greenBBBBBBBFB(PackageToTPackage mPackageToTPackage,
			TClass tType, TPackage tPackage, org.eclipse.gmt.modisco.java.Package mPackage, TypeGraph pg,
			ClassDeclaration mType, Match sourceMatch, Match targetMatch) {
	...
	public static final Object[] pattern_Class_24_3_checkcsp_bindingFBBBBBBBBBB(
			org.gravity.tgg.modisco.Rules.Class _this, CCMatch isApplicableMatch, PackageToTPackage mPackageToTPackage,
			TClass tType, TPackage tPackage, org.eclipse.gmt.modisco.java.Package mPackage, TypeGraph pg,
			ClassDeclaration mType, Match sourceMatch, Match targetMatch) {
	...
	public static final Object[] pattern_Class_24_3_checkcsp_blackB(CSP csp) {
		return new Object[] { csp };
	}

	public static final Object[] pattern_Class_24_3_checkcsp_bindingAndBlackFBBBBBBBBBB(
			org.gravity.tgg.modisco.Rules.Class _this, CCMatch isApplicableMatch, PackageToTPackage mPackageToTPackage,
			TClass tType, TPackage tPackage, org.eclipse.gmt.modisco.java.Package mPackage, TypeGraph pg,
			ClassDeclaration mType, Match sourceMatch, Match targetMatch) {
		Object[] result_pattern_Class_24_3_checkcsp_binding = pattern_Class_24_3_checkcsp_bindingFBBBBBBBBBB(_this,
				isApplicableMatch, mPackageToTPackage, tType, tPackage, mPackage, pg, mType, sourceMatch, targetMatch);
		if (result_pattern_Class_24_3_checkcsp_binding != null) {
			CSP csp = (CSP) result_pattern_Class_24_3_checkcsp_binding[0];

			Object[] result_pattern_Class_24_3_checkcsp_black = pattern_Class_24_3_checkcsp_blackB(csp);
			if (result_pattern_Class_24_3_checkcsp_black != null) {
	...
	public static final Object[] pattern_Class_24_4_createcorrespondence_blackBBBBBB(TClass tType, TPackage tPackage,
			org.eclipse.gmt.modisco.java.Package mPackage, TypeGraph pg, ClassDeclaration mType,
			CCMatch isApplicableMatch) {
		return new Object[] { tType, tPackage, mPackage, pg, mType, isApplicableMatch };
	}

	public static final Object[] pattern_Class_24_4_createcorrespondence_greenBFFBB(TClass tType,
			ClassDeclaration mType, CCMatch isApplicableMatch) {
		TypeToTAbstractType mTypeToTType = ModiscoFactory.eINSTANCE.createTypeToTAbstractType();
		BodyDeclarationToTAnnotatable mBodyToTAnnotation = ModiscoFactory.eINSTANCE
				.createBodyDeclarationToTAnnotatable();
		mTypeToTType.setTarget(tType);
	...
	public static final Object[] pattern_Class_24_5_addtoreturnedresult_blackBB(IsApplicableRuleResult result,
			CCMatch isApplicableMatch) {
		return new Object[] { result, isApplicableMatch };
	}

	public static final Object[] pattern_Class_24_5_addtoreturnedresult_greenBB(IsApplicableRuleResult result,
			CCMatch isApplicableMatch) {
	...
	public static final IsApplicableRuleResult pattern_Class_24_6_expressionFB(IsApplicableRuleResult result) {
		IsApplicableRuleResult _result = result;
		return _result;
	}

	public static final Object[] pattern_Class_27_1_matchtggpattern_blackBB(
			org.eclipse.gmt.modisco.java.Package mPackage, ClassDeclaration mType) {
		if (mPackage.getOwnedElements().contains(mType)) {
	...
	public static final Object[] pattern_Class_28_1_matchtggpattern_black_nac_0BB(TClass tType, TPackage tPackage) {
		for (TPackage __DEC_tType_classes_886339 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tType, TPackage.class, "classes")) {
			if (!tPackage.equals(__DEC_tType_classes_886339)) {
				return new Object[] { tType, tPackage };
			}
		}
		return null;
	...
	public static final Object[] pattern_Class_28_1_matchtggpattern_black_nac_1BB(TClass tType, TypeGraph pg) {
		for (TypeGraph __DEC_tType_classes_119972 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tType, TypeGraph.class, "classes")) {
			if (!pg.equals(__DEC_tType_classes_119972)) {
				return new Object[] { tType, pg };
			}
		}
		return null;
	...
	public static final Object[] pattern_Class_28_1_matchtggpattern_black_nac_2BB(TClass tType, TPackage tPackage) {
		TPackage __DEC_tType_ownedTypes_31407 = tType.getPackage();
		if (__DEC_tType_ownedTypes_31407 != null) {
			if (!tPackage.equals(__DEC_tType_ownedTypes_31407)) {
				return new Object[] { tType, tPackage };
			}
		}
	...
	public static final Object[] pattern_Class_29_1_createresult_blackB(org.gravity.tgg.modisco.Rules.Class _this) {
		return new Object[] { _this };
	}
	...
	public static final Object[] pattern_Class_29_3_solveCSP_bindingFBBBBBBB(org.gravity.tgg.modisco.Rules.Class _this,
			IsApplicableMatch isApplicableMatch, PackageToTPackage mPackageToTPackage, TPackage tPackage,
	...
	public static final boolean pattern_Class_29_4_checkCSP_expressionFBB(org.gravity.tgg.modisco.Rules.Class _this,
			CSP csp) {
	...
	public static final Object[] pattern_Class_29_6_perform_greenFBBFBFFBB(TPackage tPackage,
		...
		return new Object[] { tType, tPackage, mPackage, mTypeToTType, pg, mBodyToTAnnotation, mType, ruleResult, csp };
	}
