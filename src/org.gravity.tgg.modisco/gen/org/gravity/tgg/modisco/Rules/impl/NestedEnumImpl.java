...
public class NestedEnumImpl extends AbstractRuleImpl implements NestedEnum {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result1_green = NestedEnumImpl.pattern_NestedEnum_1_1_performtransformation_greenBFFBFFBB(eNestedType,
				typeGraph, tOuterPackage, csp);
		...
		Object[] result2_black = NestedEnumImpl.pattern_NestedEnum_1_2_collecttranslatedelements_blackBBBBB(eNestedType,
				tNestedPackage, eNestedTypeToTNestedType, tNestedType, mBodyToTAnnotation);
		...
		Object[] result2_green = NestedEnumImpl.pattern_NestedEnum_1_2_collecttranslatedelements_greenFBBBBB(
				eNestedType, tNestedPackage, eNestedTypeToTNestedType, tNestedType, mBodyToTAnnotation);
		PerformRuleResult ruleresult = (PerformRuleResult) result2_green[0];

		// bookkeeping for edges
		Object[] result3_black = NestedEnumImpl.pattern_NestedEnum_1_3_bookkeepingforedges_blackBBBBBBBBBBB(ruleresult,
		...
		NestedEnumImpl.pattern_NestedEnum_1_3_bookkeepingforedges_greenBBBBBBBBBFFFFFFFFFFFFFFF(ruleresult, eNestedType,
				tNestedPackage, eNestedTypeToTNestedType, typeGraph, tNestedType, mBodyToTAnnotation, eOuterType,
				tOuterPackage);
		...
		// EMoflonEdge tOuterPackage__tNestedPackage____subpackage = (EMoflonEdge) result3_green[13];
		// EMoflonEdge tNestedPackage__tOuterPackage____parent = (EMoflonEdge) result3_green[14];
		...
		// register objects
		NestedEnumImpl.pattern_NestedEnum_1_5_registerobjects_expressionBBBBBBBBBBBB(this, ruleresult, eNestedType,
	...
	public boolean isAppropriate_BWD(Match match, TPackage tNestedPackage, TypeGraph typeGraph, TClass tNestedType,
		...
		// initial bindings
		Object[] result1_black = NestedEnumImpl.pattern_NestedEnum_10_1_initialbindings_blackBBBBBBB(this, match,
		...
		// Solve CSP
		Object[] result2_bindingAndBlack = NestedEnumImpl.pattern_NestedEnum_10_2_SolveCSP_bindingAndBlackFBBBBBBB(this,
		...
		if (NestedEnumImpl.pattern_NestedEnum_10_3_CheckCSP_expressionFBB(this, csp)) {
			...
			// collect elements to be translated
			Object[] result4_black = NestedEnumImpl.pattern_NestedEnum_10_4_collectelementstobetranslated_blackBBBBBB(
					match, tNestedPackage, typeGraph, tNestedType, tOuterType, tOuterPackage);
			if (result4_black == null) {
				throw new RuntimeException("Pattern matching in node [collect elements to be translated] failed."
			...
			NestedEnumImpl.pattern_NestedEnum_10_4_collectelementstobetranslated_greenBBBBBFFFFFFFFF(match,
					tNestedPackage, typeGraph, tNestedType, tOuterPackage);
			// EMoflonEdge tNestedPackage__tNestedType____classes = (EMoflonEdge) result4_green[5];
			// EMoflonEdge tNestedPackage__tNestedType____ownedTypes = (EMoflonEdge) result4_green[6];
			// EMoflonEdge tNestedType__tNestedPackage____package = (EMoflonEdge) result4_green[7];
			// EMoflonEdge tOuterPackage__tNestedPackage____subpackage = (EMoflonEdge) result4_green[8];
			// EMoflonEdge tNestedPackage__tOuterPackage____parent = (EMoflonEdge) result4_green[9];
			...
			// collect context elements
			Object[] result5_black = NestedEnumImpl.pattern_NestedEnum_10_5_collectcontextelements_blackBBBBBB(match,
					tNestedPackage, typeGraph, tNestedType, tOuterType, tOuterPackage);
			if (result5_black == null) {
				throw new RuntimeException("Pattern matching in node [collect context elements] failed."
						+ " Variables: " + "[match] = " + match + ", " + "[tNestedPackage] = " + tNestedPackage + ", "
			...
			// register objects to match
			NestedEnumImpl.pattern_NestedEnum_10_6_registerobjectstomatch_expressionBBBBBBB(this, match, tNestedPackage,
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		// perform transformation
		Object[] result1_bindingAndBlack = NestedEnumImpl
				.pattern_NestedEnum_11_1_performtransformation_bindingAndBlackFFFFFFFFBB(this, isApplicableMatch);
		if (result1_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching in node [perform transformation] failed." + " Variables: "
					+ "[this] = " + this + ", " + "[isApplicableMatch] = " + isApplicableMatch + ".");
		}
		...
		// collect translated elements
		Object[] result2_black = NestedEnumImpl.pattern_NestedEnum_11_2_collecttranslatedelements_blackBBBBB(
				eNestedType, tNestedPackage, eNestedTypeToTNestedType, tNestedType, mBodyToTAnnotation);
		if (result2_black == null) {
			throw new RuntimeException("Pattern matching in node [collect translated elements] failed." + " Variables: "
					+ "[eNestedType] = " + eNestedType + ", " + "[tNestedPackage] = " + tNestedPackage + ", "
		...
		Object[] result2_green = NestedEnumImpl.pattern_NestedEnum_11_2_collecttranslatedelements_greenFBBBBB(
				eNestedType, tNestedPackage, eNestedTypeToTNestedType, tNestedType, mBodyToTAnnotation);
		PerformRuleResult ruleresult = (PerformRuleResult) result2_green[0];

		// bookkeeping for edges
		Object[] result3_black = NestedEnumImpl.pattern_NestedEnum_11_3_bookkeepingforedges_blackBBBBBBBBBBB(ruleresult,
				eNestedType, tNestedPackage, eNestedTypeToTNestedType, typeGraph, tNestedType, tOuterType,
				eOuterTypeToTOuterInterface, mBodyToTAnnotation, eOuterType, tOuterPackage);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching in node [bookkeeping for edges] failed." + " Variables: "
		...
		NestedEnumImpl.pattern_NestedEnum_11_3_bookkeepingforedges_greenBBBBBBBBBFFFFFFFFFFFFFFF(ruleresult,
				eNestedType, tNestedPackage, eNestedTypeToTNestedType, typeGraph, tNestedType, mBodyToTAnnotation,
		...
		// perform postprocessing story node is empty
		// register objects
		NestedEnumImpl.pattern_NestedEnum_11_5_registerobjects_expressionBBBBBBBBBBBB(this, ruleresult, eNestedType,
				tNestedPackage, eNestedTypeToTNestedType, typeGraph, tNestedType, tOuterType,
				eOuterTypeToTOuterInterface, mBodyToTAnnotation, eOuterType, tOuterPackage);
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		// ForEach core match
		Object[] result2_binding = NestedEnumImpl.pattern_NestedEnum_12_2_corematch_bindingFFFFFB(match);
		if (result2_binding == null) {
			throw new RuntimeException(
					"Binding in node core match failed." + " Variables: " + "[match] = " + match + ".");
		}
		...
		for (Object[] result2_black : NestedEnumImpl.pattern_NestedEnum_12_2_corematch_blackBBBBFFBB(tNestedPackage,
			...
			// ForEach find context
			for (Object[] result3_black : NestedEnumImpl.pattern_NestedEnum_12_3_findcontext_blackBBBBBBB(
				...
				Object[] result3_green = NestedEnumImpl
						.pattern_NestedEnum_12_3_findcontext_greenBBBBBBBFFFFFFFFFFFFFFFFF(tNestedPackage, typeGraph,
				...
				// EMoflonEdge tNestedPackage__tNestedType____ownedTypes = (EMoflonEdge) result3_green[9];
				// EMoflonEdge tNestedType__tNestedPackage____package = (EMoflonEdge) result3_green[10];
				...
				// EMoflonEdge typeGraph__tOuterType____ownedTypes = (EMoflonEdge) result3_green[16];
				// EMoflonEdge tOuterType__typeGraph____pg = (EMoflonEdge) result3_green[17];
				...
				// solve CSP
				Object[] result4_bindingAndBlack = NestedEnumImpl
						.pattern_NestedEnum_12_4_solveCSP_bindingAndBlackFBBBBBBBBB(this, isApplicableMatch,
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_39(EMoflonEdge _edge_abstractTypeDeclaration) {
		// prepare return value
		Object[] result1_bindingAndBlack = NestedEnumImpl
		...
		for (Object[] result2_black : NestedEnumImpl
				.pattern_NestedEnum_20_2_testcorematchandDECs_blackFFB(_edge_abstractTypeDeclaration)) {
			...
			if (NestedEnumImpl.pattern_NestedEnum_20_3_bookkeepingwithgenericisAppropriatemethod_expressionFBBBB(this,
					match, eNestedType, eOuterType)) {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_36(EMoflonEdge _edge_classes) {
		// prepare return value
		Object[] result1_bindingAndBlack = NestedEnumImpl
		...
		// ForEach test core match and DECs
		for (Object[] result2_black : NestedEnumImpl
				.pattern_NestedEnum_21_2_testcorematchandDECs_blackFFFFFB(_edge_classes)) {
			...
			// bookkeeping with generic isAppropriate method
			if (NestedEnumImpl.pattern_NestedEnum_21_3_bookkeepingwithgenericisAppropriatemethod_expressionFBBBBBBB(
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result2_binding = NestedEnumImpl.pattern_NestedEnum_24_2_matchcontext_bindingFFFFFFFBB(sourceMatch,
				targetMatch);
		if (result2_binding == null) {
		...
		for (Object[] result2_black : NestedEnumImpl.pattern_NestedEnum_24_2_matchcontext_blackBBBBBFBBBB(eNestedType,
			...
			Object[] result2_green = NestedEnumImpl.pattern_NestedEnum_24_2_matchcontext_greenBBBBBBBBBFB(eNestedType,
					tNestedPackage, typeGraph, tNestedType, tOuterType, eOuterTypeToTOuterInterface, eOuterType,
					tOuterPackage, sourceMatch, targetMatch);
			CCMatch isApplicableMatch = (CCMatch) result2_green[9];

			// check csp
			Object[] result3_bindingAndBlack = NestedEnumImpl
					.pattern_NestedEnum_24_3_checkcsp_bindingAndBlackFBBBBBBBBBBBB(this, isApplicableMatch, eNestedType,
							tNestedPackage, typeGraph, tNestedType, tOuterType, eOuterTypeToTOuterInterface, eOuterType,
							tOuterPackage, sourceMatch, targetMatch);
			if (result3_bindingAndBlack != null) {
				...
				Object[] result4_black = NestedEnumImpl.pattern_NestedEnum_24_4_createcorrespondence_blackBBBBBBBB(
				...
				NestedEnumImpl.pattern_NestedEnum_24_4_createcorrespondence_greenBFBFB(eNestedType, tNestedType,
						isApplicableMatch);
				...
				Object[] result5_black = NestedEnumImpl.pattern_NestedEnum_24_5_addtoreturnedresult_blackBB(result,
						isApplicableMatch);
				if (result5_black == null) {
					throw new RuntimeException(
				...
				NestedEnumImpl.pattern_NestedEnum_24_5_addtoreturnedresult_greenBB(result, isApplicableMatch);

			} else {
			}

		}
		return NestedEnumImpl.pattern_NestedEnum_24_6_expressionFB(result);
	}
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(CCMatch isApplicableMatch, EnumDeclaration eNestedType, TPackage tNestedPackage,
			TypeGraph typeGraph, TClass tNestedType, TAbstractType tOuterType,
	 ...
	 * @generated
	 */
	public boolean checkDEC_FWD(EnumDeclaration eNestedType, AbstractTypeDeclaration eOuterType) {// match tgg pattern
	...
	public boolean checkDEC_BWD(TPackage tNestedPackage, TypeGraph typeGraph, TClass tNestedType,
		...
		Object[] result1_black = NestedEnumImpl.pattern_NestedEnum_28_1_matchtggpattern_blackBBBBB(tNestedPackage,
				typeGraph, tNestedType, tOuterType, tOuterPackage);
		if (result1_black != null) {
		...
		for (Object[] result2_black : NestedEnumImpl
			...
			if (NestedEnumImpl.pattern_NestedEnum_29_4_checkCSP_expressionFBB(this, csp)) {
				...
				if (result5_black != null) {
					...
					NestedEnumImpl.pattern_NestedEnum_29_6_perform_greenFFFBFFBBBB(typeGraph, eOuterType, tOuterPackage,
							ruleResult, csp);
					// EnumDeclaration eNestedType = (EnumDeclaration) result6_green[0];
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.NESTED_ENUM___REGISTER_OBJECTS_FWD__PERFORMRULERESULT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT:
		...
		case RulesPackage.NESTED_ENUM___IS_APPROPRIATE_BWD__MATCH_TPACKAGE_TYPEGRAPH_TCLASS_TABSTRACTTYPE_TPACKAGE:
		...
		case RulesPackage.NESTED_ENUM___REGISTER_OBJECTS_TO_MATCH_BWD__MATCH_TPACKAGE_TYPEGRAPH_TCLASS_TABSTRACTTYPE_TPACKAGE:
			registerObjectsToMatch_BWD((Match) arguments.get(0), (TPackage) arguments.get(1),
					(TypeGraph) arguments.get(2), (TClass) arguments.get(3), (TAbstractType) arguments.get(4),
					(TPackage) arguments.get(5));
			return null;
		case RulesPackage.NESTED_ENUM___IS_APPROPRIATE_SOLVE_CSP_BWD__MATCH_TPACKAGE_TYPEGRAPH_TCLASS_TABSTRACTTYPE_TPACKAGE:
		...
		case RulesPackage.NESTED_ENUM___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_TPACKAGE_TYPEGRAPH_TCLASS_TABSTRACTTYPE_TYPETOTABSTRACTTYPE_ABSTRACTTYPEDECLARATION_TPACKAGE:
		...
		case RulesPackage.NESTED_ENUM___REGISTER_OBJECTS_BWD__PERFORMRULERESULT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT:
		...
		case RulesPackage.NESTED_ENUM___IS_APPROPRIATE_FWD_EMOFLON_EDGE_39__EMOFLONEDGE:
			return isAppropriate_FWD_EMoflonEdge_39((EMoflonEdge) arguments.get(0));
		case RulesPackage.NESTED_ENUM___IS_APPROPRIATE_BWD_EMOFLON_EDGE_36__EMOFLONEDGE:
		...
		case RulesPackage.NESTED_ENUM___IS_APPLICABLE_SOLVE_CSP_CC__CCMATCH_ENUMDECLARATION_TPACKAGE_TYPEGRAPH_TCLASS_TABSTRACTTYPE_TYPETOTABSTRACTTYPE_ABSTRACTTYPEDECLARATION_TPACKAGE_MATCH_MATCH:
			return isApplicable_solveCsp_CC((CCMatch) arguments.get(0), (EnumDeclaration) arguments.get(1),
		...
		case RulesPackage.NESTED_ENUM___CHECK_DEC_BWD__TPACKAGE_TYPEGRAPH_TCLASS_TABSTRACTTYPE_TPACKAGE:
	...
	public static final Object[] pattern_NestedEnum_1_1_performtransformation_greenBFFBFFBB(EnumDeclaration eNestedType,
			TypeGraph typeGraph, TPackage tOuterPackage, CSP csp) {
	...
	public static final Object[] pattern_NestedEnum_1_2_collecttranslatedelements_blackBBBBB(
			EnumDeclaration eNestedType, TPackage tNestedPackage, TypeToTAbstractType eNestedTypeToTNestedType,
	...
	public static final Object[] pattern_NestedEnum_1_2_collecttranslatedelements_greenFBBBBB(
			EnumDeclaration eNestedType, TPackage tNestedPackage, TypeToTAbstractType eNestedTypeToTNestedType,
			TClass tNestedType, BodyDeclarationToTAnnotatable mBodyToTAnnotation) {
	...
	public static final Object[] pattern_NestedEnum_1_3_bookkeepingforedges_blackBBBBBBBBBBB(
	...
	public static final Object[] pattern_NestedEnum_1_3_bookkeepingforedges_greenBBBBBBBBBFFFFFFFFFFFFFFF(
			PerformRuleResult ruleresult, EObject eNestedType, EObject tNestedPackage, EObject eNestedTypeToTNestedType,
	...
	public static final void pattern_NestedEnum_1_5_registerobjects_expressionBBBBBBBBBBBB(NestedEnum _this,
			PerformRuleResult ruleresult, EObject eNestedType, EObject tNestedPackage, EObject eNestedTypeToTNestedType,
			EObject typeGraph, EObject tNestedType, EObject tOuterType, EObject eOuterTypeToTOuterInterface,
			EObject mBodyToTAnnotation, EObject eOuterType, EObject tOuterPackage) {
	...
	public static final Object[] pattern_NestedEnum_10_1_initialbindings_blackBBBBBBB(NestedEnum _this, Match match,
	...
	public static final Object[] pattern_NestedEnum_10_2_SolveCSP_bindingFBBBBBBB(NestedEnum _this, Match match,
			TPackage tNestedPackage, TypeGraph typeGraph, TClass tNestedType, TAbstractType tOuterType,
			TPackage tOuterPackage) {
	...
	public static final Object[] pattern_NestedEnum_10_2_SolveCSP_bindingAndBlackFBBBBBBB(NestedEnum _this, Match match,
			TPackage tNestedPackage, TypeGraph typeGraph, TClass tNestedType, TAbstractType tOuterType,
			TPackage tOuterPackage) {
		Object[] result_pattern_NestedEnum_10_2_SolveCSP_binding = pattern_NestedEnum_10_2_SolveCSP_bindingFBBBBBBB(
	...
	public static final Object[] pattern_NestedEnum_10_4_collectelementstobetranslated_blackBBBBBB(Match match,
			TPackage tNestedPackage, TypeGraph typeGraph, TClass tNestedType, TAbstractType tOuterType,
			TPackage tOuterPackage) {
		if (!tNestedPackage.equals(tOuterPackage)) {
			if (!tNestedType.equals(tOuterType)) {
	...
	public static final Object[] pattern_NestedEnum_10_4_collectelementstobetranslated_greenBBBBBFFFFFFFFF(Match match,
			TPackage tNestedPackage, TypeGraph typeGraph, TClass tNestedType, TPackage tOuterPackage) {
		EMoflonEdge tNestedPackage__tNestedType____classes = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		EMoflonEdge tNestedPackage__tNestedType____ownedTypes = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		EMoflonEdge tNestedType__tNestedPackage____package = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		EMoflonEdge tOuterPackage__tNestedPackage____subpackage = RuntimeFactory.eINSTANCE.createEMoflonEdge();
	...
	public static final Object[] pattern_NestedEnum_10_5_collectcontextelements_blackBBBBBB(Match match,
			TPackage tNestedPackage, TypeGraph typeGraph, TClass tNestedType, TAbstractType tOuterType,
			TPackage tOuterPackage) {
		if (!tNestedPackage.equals(tOuterPackage)) {
			if (!tNestedType.equals(tOuterType)) {
	...
	public static final void pattern_NestedEnum_10_6_registerobjectstomatch_expressionBBBBBBB(NestedEnum _this,
	...
	public static final Object[] pattern_NestedEnum_11_1_performtransformation_bindingFFFFFFFB(
			IsApplicableMatch isApplicableMatch) {
	...
	public static final Object[] pattern_NestedEnum_11_1_performtransformation_blackBBBBBBBFBB(TPackage tNestedPackage,
			TypeGraph typeGraph, TClass tNestedType, TAbstractType tOuterType,
			TypeToTAbstractType eOuterTypeToTOuterInterface, AbstractTypeDeclaration eOuterType, TPackage tOuterPackage,
			NestedEnum _this, IsApplicableMatch isApplicableMatch) {
		if (!tNestedPackage.equals(tOuterPackage)) {
	...
	public static final Object[] pattern_NestedEnum_11_1_performtransformation_bindingAndBlackFFFFFFFFBB(
			NestedEnum _this, IsApplicableMatch isApplicableMatch) {
		Object[] result_pattern_NestedEnum_11_1_performtransformation_binding = pattern_NestedEnum_11_1_performtransformation_bindingFFFFFFFB(
				isApplicableMatch);
		if (result_pattern_NestedEnum_11_1_performtransformation_binding != null) {
			TPackage tNestedPackage = (TPackage) result_pattern_NestedEnum_11_1_performtransformation_binding[0];
			TypeGraph typeGraph = (TypeGraph) result_pattern_NestedEnum_11_1_performtransformation_binding[1];
			TClass tNestedType = (TClass) result_pattern_NestedEnum_11_1_performtransformation_binding[2];
			TAbstractType tOuterType = (TAbstractType) result_pattern_NestedEnum_11_1_performtransformation_binding[3];
			TypeToTAbstractType eOuterTypeToTOuterInterface = (TypeToTAbstractType) result_pattern_NestedEnum_11_1_performtransformation_binding[4];
			AbstractTypeDeclaration eOuterType = (AbstractTypeDeclaration) result_pattern_NestedEnum_11_1_performtransformation_binding[5];
			TPackage tOuterPackage = (TPackage) result_pattern_NestedEnum_11_1_performtransformation_binding[6];

			Object[] result_pattern_NestedEnum_11_1_performtransformation_black = pattern_NestedEnum_11_1_performtransformation_blackBBBBBBBFBB(
					tNestedPackage, typeGraph, tNestedType, tOuterType, eOuterTypeToTOuterInterface, eOuterType,
					tOuterPackage, _this, isApplicableMatch);
			if (result_pattern_NestedEnum_11_1_performtransformation_black != null) {
				CSP csp = (CSP) result_pattern_NestedEnum_11_1_performtransformation_black[7];
	...
	public static final Object[] pattern_NestedEnum_11_2_collecttranslatedelements_blackBBBBB(
			EnumDeclaration eNestedType, TPackage tNestedPackage, TypeToTAbstractType eNestedTypeToTNestedType,
			TClass tNestedType, BodyDeclarationToTAnnotatable mBodyToTAnnotation) {
		return new Object[] { eNestedType, tNestedPackage, eNestedTypeToTNestedType, tNestedType, mBodyToTAnnotation };
	}

	public static final Object[] pattern_NestedEnum_11_2_collecttranslatedelements_greenFBBBBB(
			EnumDeclaration eNestedType, TPackage tNestedPackage, TypeToTAbstractType eNestedTypeToTNestedType,
			TClass tNestedType, BodyDeclarationToTAnnotatable mBodyToTAnnotation) {
		PerformRuleResult ruleresult = RuntimeFactory.eINSTANCE.createPerformRuleResult();
	...
	public static final Object[] pattern_NestedEnum_11_3_bookkeepingforedges_blackBBBBBBBBBBB(
			PerformRuleResult ruleresult, EObject eNestedType, EObject tNestedPackage, EObject eNestedTypeToTNestedType,
			EObject typeGraph, EObject tNestedType, EObject tOuterType, EObject eOuterTypeToTOuterInterface,
			EObject mBodyToTAnnotation, EObject eOuterType, EObject tOuterPackage) {
		if (!eNestedType.equals(tNestedPackage)) {
	...
	public static final Object[] pattern_NestedEnum_11_3_bookkeepingforedges_greenBBBBBBBBBFFFFFFFFFFFFFFF(
			PerformRuleResult ruleresult, EObject eNestedType, EObject tNestedPackage, EObject eNestedTypeToTNestedType,
			EObject typeGraph, EObject tNestedType, EObject mBodyToTAnnotation, EObject eOuterType,
			EObject tOuterPackage) {
		EMoflonEdge tNestedPackage__tNestedType____classes = RuntimeFactory.eINSTANCE.createEMoflonEdge();
	...
	public static final void pattern_NestedEnum_11_5_registerobjects_expressionBBBBBBBBBBBB(NestedEnum _this,
			PerformRuleResult ruleresult, EObject eNestedType, EObject tNestedPackage, EObject eNestedTypeToTNestedType,
			EObject typeGraph, EObject tNestedType, EObject tOuterType, EObject eOuterTypeToTOuterInterface,
			EObject mBodyToTAnnotation, EObject eOuterType, EObject tOuterPackage) {
	...
	public static final Object[] pattern_NestedEnum_12_2_corematch_bindingFFFFFB(Match match) {
	...
	public static final Iterable<Object[]> pattern_NestedEnum_12_2_corematch_blackBBBBFFBB(TPackage tNestedPackage,
			TypeGraph typeGraph, TClass tNestedType, TAbstractType tOuterType, TPackage tOuterPackage, Match match) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!tNestedPackage.equals(tOuterPackage)) {
			if (!tNestedType.equals(tOuterType)) {
				for (TypeToTAbstractType eOuterTypeToTOuterInterface : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Iterable<Object[]> pattern_NestedEnum_12_3_findcontext_blackBBBBBBB(TPackage tNestedPackage,
			TypeGraph typeGraph, TClass tNestedType, TAbstractType tOuterType,
			TypeToTAbstractType eOuterTypeToTOuterInterface, AbstractTypeDeclaration eOuterType,
			TPackage tOuterPackage) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
	...
	public static final Object[] pattern_NestedEnum_12_3_findcontext_greenBBBBBBBFFFFFFFFFFFFFFFFF(
			TPackage tNestedPackage, TypeGraph typeGraph, TClass tNestedType, TAbstractType tOuterType,
			TypeToTAbstractType eOuterTypeToTOuterInterface, AbstractTypeDeclaration eOuterType,
			TPackage tOuterPackage) {
		IsApplicableMatch isApplicableMatch = RuntimeFactory.eINSTANCE.createIsApplicableMatch();
		...
		return new Object[] { tNestedPackage, typeGraph, tNestedType, tOuterType, eOuterTypeToTOuterInterface,
				...
				tNestedType__typeGraph____pg, typeGraph__tOuterType____ownedTypes, tOuterType__typeGraph____pg,
				tOuterPackage__tOuterType____ownedTypes, tOuterType__tOuterPackage____package,
				tNestedPackage__typeGraph____typeGraph, typeGraph__tNestedType____classes,
				tOuterPackage__typeGraph____typeGraph, eOuterTypeToTOuterInterface__tOuterType____target };
	}

	public static final Object[] pattern_NestedEnum_12_4_solveCSP_bindingFBBBBBBBBB(NestedEnum _this,
	...
	public static final Object[] pattern_NestedEnum_12_4_solveCSP_bindingAndBlackFBBBBBBBBB(NestedEnum _this,
			IsApplicableMatch isApplicableMatch, TPackage tNestedPackage, TypeGraph typeGraph, TClass tNestedType,
			TAbstractType tOuterType, TypeToTAbstractType eOuterTypeToTOuterInterface,
			AbstractTypeDeclaration eOuterType, TPackage tOuterPackage) {
		Object[] result_pattern_NestedEnum_12_4_solveCSP_binding = pattern_NestedEnum_12_4_solveCSP_bindingFBBBBBBBBB(
	...
	public static final Iterable<Object[]> pattern_NestedEnum_20_2_testcorematchandDECs_blackFFB(
	...
	public static final boolean pattern_NestedEnum_20_3_bookkeepingwithgenericisAppropriatemethod_expressionFBBBB(
	...
	public static final Object[] pattern_NestedEnum_21_2_testcorematchandDECs_black_nac_0BB(TPackage tNestedPackage,
			TPackage tOuterPackage) {
		if (!tNestedPackage.equals(tOuterPackage)) {
			TPackage __DEC_tNestedPackage_parent_62605 = tNestedPackage.getParent();
			if (__DEC_tNestedPackage_parent_62605 != null) {
				if (!tNestedPackage.equals(__DEC_tNestedPackage_parent_62605)) {
					if (!tOuterPackage.equals(__DEC_tNestedPackage_parent_62605)) {
	...
	public static final Object[] pattern_NestedEnum_21_2_testcorematchandDECs_black_nac_1BB(TPackage tNestedPackage,
			TypeGraph typeGraph) {
		TypeGraph __DEC_tNestedPackage_packages_289179 = tNestedPackage.getPg();
		if (__DEC_tNestedPackage_packages_289179 != null) {
			if (!typeGraph.equals(__DEC_tNestedPackage_packages_289179)) {
	...
	public static final Object[] pattern_NestedEnum_21_2_testcorematchandDECs_black_nac_2BBB(TClass tNestedType,
			TPackage tNestedPackage, TPackage tOuterPackage) {
		if (!tNestedPackage.equals(tOuterPackage)) {
			for (TPackage __DEC_tNestedType_classes_997111 : org.moflon.core.utilities.eMoflonEMFUtil
					.getOppositeReferenceTyped(tNestedType, TPackage.class, "classes")) {
				if (!tNestedPackage.equals(__DEC_tNestedType_classes_997111)) {
					if (!tOuterPackage.equals(__DEC_tNestedType_classes_997111)) {
	...
	public static final Object[] pattern_NestedEnum_21_2_testcorematchandDECs_black_nac_3BB(TClass tNestedType,
			TypeGraph typeGraph) {
		for (TypeGraph __DEC_tNestedType_classes_971885 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tNestedType, TypeGraph.class, "classes")) {
			if (!typeGraph.equals(__DEC_tNestedType_classes_971885)) {
	...
	public static final Object[] pattern_NestedEnum_21_2_testcorematchandDECs_black_nac_4BBB(TClass tNestedType,
			TPackage tNestedPackage, TPackage tOuterPackage) {
		if (!tNestedPackage.equals(tOuterPackage)) {
			TPackage __DEC_tNestedType_ownedTypes_775937 = tNestedType.getPackage();
			if (__DEC_tNestedType_ownedTypes_775937 != null) {
				if (!tNestedPackage.equals(__DEC_tNestedType_ownedTypes_775937)) {
					if (!tOuterPackage.equals(__DEC_tNestedType_ownedTypes_775937)) {
						return new Object[] { tNestedType, tNestedPackage, tOuterPackage };
					}
				}
			}
	...
	public static final Object[] pattern_NestedEnum_21_2_testcorematchandDECs_black_nac_5BB(TypeGraph typeGraph,
	...
	public static final Object[] pattern_NestedEnum_21_2_testcorematchandDECs_black_nac_6BB(TPackage tOuterPackage,
			TClass tNestedType) {
	...
	public static final Object[] pattern_NestedEnum_21_2_testcorematchandDECs_black_nac_7BB(TPackage tOuterPackage,
			TClass tNestedType) {
	...
	public static final Iterable<Object[]> pattern_NestedEnum_21_2_testcorematchandDECs_blackFFFFFB(
							...
							if (!tNestedPackage.equals(tOuterPackage)) {
								...
								if (typeGraph != null) {
									if (typeGraph.getOwnedTypes().contains(tNestedType)) {
										if (typeGraph.getClasses().contains(tNestedType)) {
											if (typeGraph.equals(tOuterPackage.getTypeGraph())) {
												if (pattern_NestedEnum_21_2_testcorematchandDECs_black_nac_0BB(
														tNestedPackage, tOuterPackage) == null) {
													if (pattern_NestedEnum_21_2_testcorematchandDECs_black_nac_2BBB(
															tNestedType, tNestedPackage, tOuterPackage) == null) {
														if (pattern_NestedEnum_21_2_testcorematchandDECs_black_nac_4BBB(
																tNestedType, tNestedPackage, tOuterPackage) == null) {
															if (pattern_NestedEnum_21_2_testcorematchandDECs_black_nac_6BB(
																	tOuterPackage, tNestedType) == null) {
																if (pattern_NestedEnum_21_2_testcorematchandDECs_black_nac_7BB(
																		tOuterPackage, tNestedType) == null) {
																	if (pattern_NestedEnum_21_2_testcorematchandDECs_black_nac_1BB(
																			tNestedPackage, typeGraph) == null) {
																		if (pattern_NestedEnum_21_2_testcorematchandDECs_black_nac_3BB(
																				tNestedType, typeGraph) == null) {
																			if (pattern_NestedEnum_21_2_testcorematchandDECs_black_nac_5BB(
																					typeGraph,
																					tNestedPackage) == null) {
	...
	public static final boolean pattern_NestedEnum_21_3_bookkeepingwithgenericisAppropriatemethod_expressionFBBBBBBB(
			NestedEnum _this, Match match, TPackage tNestedPackage, TypeGraph typeGraph, TClass tNestedType,
			TAbstractType tOuterType, TPackage tOuterPackage) {
	...
	public static final Object[] pattern_NestedEnum_24_2_matchcontext_bindingFFFFFFFBB(Match sourceMatch,
			Match targetMatch) {
	...
	public static final Iterable<Object[]> pattern_NestedEnum_24_2_matchcontext_blackBBBBBFBBBB(
	...
	public static final Object[] pattern_NestedEnum_24_2_matchcontext_greenBBBBBBBBBFB(EnumDeclaration eNestedType,
			TPackage tNestedPackage, TypeGraph typeGraph, TClass tNestedType, TAbstractType tOuterType,
			TypeToTAbstractType eOuterTypeToTOuterInterface, AbstractTypeDeclaration eOuterType, TPackage tOuterPackage,
	...
	public static final Object[] pattern_NestedEnum_24_3_checkcsp_bindingFBBBBBBBBBBBB(NestedEnum _this,
			CCMatch isApplicableMatch, EnumDeclaration eNestedType, TPackage tNestedPackage, TypeGraph typeGraph,
	...
	public static final Object[] pattern_NestedEnum_24_3_checkcsp_blackB(CSP csp) {
		return new Object[] { csp };
	}

	public static final Object[] pattern_NestedEnum_24_3_checkcsp_bindingAndBlackFBBBBBBBBBBBB(NestedEnum _this,
			CCMatch isApplicableMatch, EnumDeclaration eNestedType, TPackage tNestedPackage, TypeGraph typeGraph,
			TClass tNestedType, TAbstractType tOuterType, TypeToTAbstractType eOuterTypeToTOuterInterface,
			AbstractTypeDeclaration eOuterType, TPackage tOuterPackage, Match sourceMatch, Match targetMatch) {
		Object[] result_pattern_NestedEnum_24_3_checkcsp_binding = pattern_NestedEnum_24_3_checkcsp_bindingFBBBBBBBBBBBB(
		...
		if (result_pattern_NestedEnum_24_3_checkcsp_binding != null) {
			CSP csp = (CSP) result_pattern_NestedEnum_24_3_checkcsp_binding[0];

			Object[] result_pattern_NestedEnum_24_3_checkcsp_black = pattern_NestedEnum_24_3_checkcsp_blackB(csp);
			if (result_pattern_NestedEnum_24_3_checkcsp_black != null) {
	...
	public static final Object[] pattern_NestedEnum_24_4_createcorrespondence_blackBBBBBBBB(EnumDeclaration eNestedType,
			TPackage tNestedPackage, TypeGraph typeGraph, TClass tNestedType, TAbstractType tOuterType,
			AbstractTypeDeclaration eOuterType, TPackage tOuterPackage, CCMatch isApplicableMatch) {
		if (!eNestedType.equals(eOuterType)) {
			if (!tNestedPackage.equals(tOuterPackage)) {
				if (!tNestedType.equals(tOuterType)) {
	...
	public static final Object[] pattern_NestedEnum_24_4_createcorrespondence_greenBFBFB(EnumDeclaration eNestedType,
			TClass tNestedType, CCMatch isApplicableMatch) {
		TypeToTAbstractType eNestedTypeToTNestedType = ModiscoFactory.eINSTANCE.createTypeToTAbstractType();
		BodyDeclarationToTAnnotatable mBodyToTAnnotation = ModiscoFactory.eINSTANCE
				.createBodyDeclarationToTAnnotatable();
		eNestedTypeToTNestedType.setSource(eNestedType);
	...
	public static final Object[] pattern_NestedEnum_24_5_addtoreturnedresult_blackBB(IsApplicableRuleResult result,
			CCMatch isApplicableMatch) {
		return new Object[] { result, isApplicableMatch };
	}

	public static final Object[] pattern_NestedEnum_24_5_addtoreturnedresult_greenBB(IsApplicableRuleResult result,
			CCMatch isApplicableMatch) {
	...
	public static final IsApplicableRuleResult pattern_NestedEnum_24_6_expressionFB(IsApplicableRuleResult result) {
	...
	public static final Object[] pattern_NestedEnum_28_1_matchtggpattern_black_nac_0BB(TPackage tNestedPackage,
			TPackage tOuterPackage) {
		if (!tNestedPackage.equals(tOuterPackage)) {
			TPackage __DEC_tNestedPackage_parent_904818 = tNestedPackage.getParent();
			if (__DEC_tNestedPackage_parent_904818 != null) {
				if (!tNestedPackage.equals(__DEC_tNestedPackage_parent_904818)) {
					if (!tOuterPackage.equals(__DEC_tNestedPackage_parent_904818)) {
						return new Object[] { tNestedPackage, tOuterPackage };
					}
				}
			}
	...
	public static final Object[] pattern_NestedEnum_28_1_matchtggpattern_black_nac_1BB(TPackage tNestedPackage,
			TypeGraph typeGraph) {
		TypeGraph __DEC_tNestedPackage_packages_758091 = tNestedPackage.getPg();
		if (__DEC_tNestedPackage_packages_758091 != null) {
			if (!typeGraph.equals(__DEC_tNestedPackage_packages_758091)) {
				return new Object[] { tNestedPackage, typeGraph };
			}
		}
	...
	public static final Object[] pattern_NestedEnum_28_1_matchtggpattern_black_nac_2BBB(TClass tNestedType,
			TPackage tNestedPackage, TPackage tOuterPackage) {
		if (!tNestedPackage.equals(tOuterPackage)) {
			for (TPackage __DEC_tNestedType_classes_933972 : org.moflon.core.utilities.eMoflonEMFUtil
					.getOppositeReferenceTyped(tNestedType, TPackage.class, "classes")) {
				if (!tNestedPackage.equals(__DEC_tNestedType_classes_933972)) {
					if (!tOuterPackage.equals(__DEC_tNestedType_classes_933972)) {
						return new Object[] { tNestedType, tNestedPackage, tOuterPackage };
					}
				}
			}
	...
	public static final Object[] pattern_NestedEnum_28_1_matchtggpattern_black_nac_3BB(TClass tNestedType,
			TypeGraph typeGraph) {
		for (TypeGraph __DEC_tNestedType_classes_889458 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tNestedType, TypeGraph.class, "classes")) {
			if (!typeGraph.equals(__DEC_tNestedType_classes_889458)) {
				return new Object[] { tNestedType, typeGraph };
			}
		}
		return null;
	...
	public static final Object[] pattern_NestedEnum_28_1_matchtggpattern_black_nac_4BBB(TClass tNestedType,
			TPackage tNestedPackage, TPackage tOuterPackage) {
		if (!tNestedPackage.equals(tOuterPackage)) {
			TPackage __DEC_tNestedType_ownedTypes_36971 = tNestedType.getPackage();
			if (__DEC_tNestedType_ownedTypes_36971 != null) {
				if (!tNestedPackage.equals(__DEC_tNestedType_ownedTypes_36971)) {
					if (!tOuterPackage.equals(__DEC_tNestedType_ownedTypes_36971)) {
						return new Object[] { tNestedType, tNestedPackage, tOuterPackage };
					}
				}
			}
	...
	public static final Object[] pattern_NestedEnum_28_1_matchtggpattern_black_nac_5BB(TypeGraph typeGraph,
			TPackage tNestedPackage) {
		if (typeGraph.getPackages().contains(tNestedPackage)) {
			return new Object[] { typeGraph, tNestedPackage };
		}
	...
	public static final Object[] pattern_NestedEnum_28_1_matchtggpattern_black_nac_6BB(TPackage tOuterPackage,
			TClass tNestedType) {
		if (tOuterPackage.getClasses().contains(tNestedType)) {
			return new Object[] { tOuterPackage, tNestedType };
		}
	...
	public static final Object[] pattern_NestedEnum_28_1_matchtggpattern_black_nac_7BB(TPackage tOuterPackage,
			TClass tNestedType) {
		if (tOuterPackage.getOwnedTypes().contains(tNestedType)) {
			return new Object[] { tOuterPackage, tNestedType };
		}
	...
	public static final Object[] pattern_NestedEnum_28_1_matchtggpattern_blackBBBBB(TPackage tNestedPackage,
								...
								if (typeGraph.getOwnedTypes().contains(tOuterType)) {
									if (tOuterPackage.getOwnedTypes().contains(tOuterType)) {
										if (typeGraph.equals(tNestedPackage.getTypeGraph())) {
											if (typeGraph.getClasses().contains(tNestedType)) {
												if (typeGraph.equals(tOuterPackage.getTypeGraph())) {
													if (pattern_NestedEnum_28_1_matchtggpattern_black_nac_0BB(
															tNestedPackage, tOuterPackage) == null) {
														if (pattern_NestedEnum_28_1_matchtggpattern_black_nac_1BB(
																tNestedPackage, typeGraph) == null) {
															if (pattern_NestedEnum_28_1_matchtggpattern_black_nac_2BBB(
																	tNestedType, tNestedPackage,
																	tOuterPackage) == null) {
																if (pattern_NestedEnum_28_1_matchtggpattern_black_nac_3BB(
																		tNestedType, typeGraph) == null) {
																	if (pattern_NestedEnum_28_1_matchtggpattern_black_nac_4BBB(
																			tNestedType, tNestedPackage,
																			tOuterPackage) == null) {
																		if (pattern_NestedEnum_28_1_matchtggpattern_black_nac_5BB(
					...
					if (tOuterType != null) {
						...
						if (tmpEOuterType instanceof AbstractTypeDeclaration) {
							...
							if (typeGraph != null) {
								...
								if (tOuterPackage != null) {
									if (typeGraph.equals(tOuterPackage.getTypeGraph())) {
										if (pattern_NestedEnum_29_2_isapplicablecore_black_nac_2BB(ruleResult,
											...
											if (pattern_NestedEnum_29_2_isapplicablecore_black_nac_1BB(ruleResult,
												...
												if (pattern_NestedEnum_29_2_isapplicablecore_black_nac_3BB(ruleResult,
													...
													if (pattern_NestedEnum_29_2_isapplicablecore_black_nac_0BB(
														...
														if (pattern_NestedEnum_29_2_isapplicablecore_black_nac_4BB(
	...
	public static final Object[] pattern_NestedEnum_29_6_perform_greenFFFBFFBBBB(TypeGraph typeGraph,
