...
public class MethodParameterLinkImpl extends AbstractRuleImpl implements MethodParameterLink {
	...
	public boolean isAppropriate_FWD(Match match, MEntry mPrevEntry, MEntry mEntry) {
		...
		if (result1_black == null) {
			throw new RuntimeException("Pattern matching in node [initial bindings] failed." + " Variables: "
					+ "[this] = " + this + ", " + "[match] = " + match + ", " + "[mPrevEntry] = " + mPrevEntry + ", "
					+ "[mEntry] = " + mEntry + ".");
		}
		...
		if (result2_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching in node [Solve CSP] failed." + " Variables: " + "[this] = "
					+ this + ", " + "[match] = " + match + ", " + "[mPrevEntry] = " + mPrevEntry + ", " + "[mEntry] = "
					+ mEntry + ".");
		}
		...
		if (MethodParameterLinkImpl.pattern_MethodParameterLink_0_3_CheckCSP_expressionFBB(this, csp)) {
			...
			if (result4_black == null) {
				throw new RuntimeException("Pattern matching in node [collect elements to be translated] failed."
						+ " Variables: " + "[match] = " + match + ", " + "[mPrevEntry] = " + mPrevEntry + ", "
						+ "[mEntry] = " + mEntry + ".");
			}
			MethodParameterLinkImpl.pattern_MethodParameterLink_0_4_collectelementstobetranslated_greenBBBFF(match,
					mPrevEntry, mEntry);
			// EMoflonEdge mPrevEntry__mEntry____mNext = (EMoflonEdge) result4_green[3];
			// EMoflonEdge mEntry__mPrevEntry____mPrevious = (EMoflonEdge) result4_green[4];
			...
			if (result5_black == null) {
				throw new RuntimeException(
						"Pattern matching in node [collect context elements] failed." + " Variables: " + "[match] = "
								+ match + ", " + "[mPrevEntry] = " + mPrevEntry + ", " + "[mEntry] = " + mEntry + ".");
			}
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		MEntry mPrevEntry = (MEntry) result1_bindingAndBlack[0];
		MEntryToTParameter mmethodSignatureToTMethodSignature = (MEntryToTParameter) result1_bindingAndBlack[1];
		...
		Object[] result3_black = MethodParameterLinkImpl
				.pattern_MethodParameterLink_1_3_bookkeepingforedges_blackBBBBBBB(ruleresult, mPrevEntry,
						mmethodSignatureToTMethodSignature, tPrevParameter, mEntry, tParameter,
						eSingleVariableDeclarationToTParameter);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching in node [bookkeeping for edges] failed." + " Variables: "
					+ "[ruleresult] = " + ruleresult + ", " + "[mPrevEntry] = " + mPrevEntry + ", "
					+ "[mmethodSignatureToTMethodSignature] = " + mmethodSignatureToTMethodSignature + ", "
					+ "[tPrevParameter] = " + tPrevParameter + ", " + "[mEntry] = " + mEntry + ", " + "[tParameter] = "
		...
		// EMoflonEdge mPrevEntry__mEntry____mNext = (EMoflonEdge) result3_green[5];
		// EMoflonEdge mEntry__mPrevEntry____mPrevious = (EMoflonEdge) result3_green[6];
		// EMoflonEdge tPrevParameter__tParameter____next = (EMoflonEdge) result3_green[7];
		// EMoflonEdge tParameter__tPrevParameter____previous = (EMoflonEdge) result3_green[8];

		// perform postprocessing story node is empty
		// register objects
		MethodParameterLinkImpl.pattern_MethodParameterLink_1_5_registerobjects_expressionBBBBBBBB(this, ruleresult,
				mPrevEntry, mmethodSignatureToTMethodSignature, tPrevParameter, mEntry, tParameter,
				eSingleVariableDeclarationToTParameter);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : MethodParameterLinkImpl
				.pattern_MethodParameterLink_2_2_corematch_blackBFFBFFB(mPrevEntry, mEntry, match)) {
			...
			for (Object[] result3_black : MethodParameterLinkImpl
					.pattern_MethodParameterLink_2_3_findcontext_blackBBBBBB(mPrevEntry,
							mmethodSignatureToTMethodSignature, tPrevParameter, mEntry, tParameter,
							eSingleVariableDeclarationToTParameter)) {
				Object[] result3_green = MethodParameterLinkImpl
						.pattern_MethodParameterLink_2_3_findcontext_greenBBBBBBFFFFFFF(mPrevEntry,
								mmethodSignatureToTMethodSignature, tPrevParameter, mEntry, tParameter,
								eSingleVariableDeclarationToTParameter);
				IsApplicableMatch isApplicableMatch = (IsApplicableMatch) result3_green[6];
				// EMoflonEdge mPrevEntry__mEntry____mNext = (EMoflonEdge) result3_green[7];
				// EMoflonEdge mEntry__mPrevEntry____mPrevious = (EMoflonEdge) result3_green[8];
				// EMoflonEdge mmethodSignatureToTMethodSignature__mPrevEntry____source = (EMoflonEdge) result3_green[9];
				// EMoflonEdge mmethodSignatureToTMethodSignature__tPrevParameter____target = (EMoflonEdge) result3_green[10];
				// EMoflonEdge eSingleVariableDeclarationToTParameter__mEntry____source = (EMoflonEdge) result3_green[11];
				// EMoflonEdge eSingleVariableDeclarationToTParameter__tParameter____target = (EMoflonEdge) result3_green[12];
				...
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching in node [solve CSP] failed." + " Variables: "
							+ "[this] = " + this + ", " + "[isApplicableMatch] = " + isApplicableMatch + ", "
							+ "[mPrevEntry] = " + mPrevEntry + ", " + "[mmethodSignatureToTMethodSignature] = "
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, MEntry mPrevEntry,
			MEntryToTParameter mmethodSignatureToTMethodSignature, TParameter tPrevParameter, MEntry mEntry,
			TParameter tParameter, MEntryToTParameter eSingleVariableDeclarationToTParameter) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject mPrevEntry,
			EObject mmethodSignatureToTMethodSignature, EObject tPrevParameter, EObject mEntry, EObject tParameter,
	...
	public boolean isAppropriate_BWD(Match match, TParameter tPrevParameter, TParameter tParameter) {
		...
		if (result1_black == null) {
			throw new RuntimeException("Pattern matching in node [initial bindings] failed." + " Variables: "
					+ "[this] = " + this + ", " + "[match] = " + match + ", " + "[tPrevParameter] = " + tPrevParameter
		...
		if (result2_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching in node [Solve CSP] failed." + " Variables: " + "[this] = "
					+ this + ", " + "[match] = " + match + ", " + "[tPrevParameter] = " + tPrevParameter + ", "
					+ "[tParameter] = " + tParameter + ".");
		}
		CSP csp = (CSP) result2_bindingAndBlack[0];
		// Check CSP
		if (MethodParameterLinkImpl.pattern_MethodParameterLink_10_3_CheckCSP_expressionFBB(this, csp)) {
			...
			if (result4_black == null) {
				throw new RuntimeException("Pattern matching in node [collect elements to be translated] failed."
						+ " Variables: " + "[match] = " + match + ", " + "[tPrevParameter] = " + tPrevParameter + ", "
						+ "[tParameter] = " + tParameter + ".");
			}
			...
			// EMoflonEdge tPrevParameter__tParameter____next = (EMoflonEdge) result4_green[3];
			// EMoflonEdge tParameter__tPrevParameter____previous = (EMoflonEdge) result4_green[4];
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		// bookkeeping for edges
		Object[] result3_black = MethodParameterLinkImpl
				.pattern_MethodParameterLink_11_3_bookkeepingforedges_blackBBBBBBB(ruleresult, mPrevEntry,
						mmethodSignatureToTMethodSignature, tPrevParameter, mEntry, tParameter,
						eSingleVariableDeclarationToTParameter);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching in node [bookkeeping for edges] failed." + " Variables: "
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : MethodParameterLinkImpl
			...
			// ForEach find context
			for (Object[] result3_black : MethodParameterLinkImpl
					.pattern_MethodParameterLink_12_3_findcontext_blackBBBBBB(mPrevEntry,
							mmethodSignatureToTMethodSignature, tPrevParameter, mEntry, tParameter,
							eSingleVariableDeclarationToTParameter)) {
				Object[] result3_green = MethodParameterLinkImpl
						.pattern_MethodParameterLink_12_3_findcontext_greenBBBBBBFFFFFFF(mPrevEntry,
								mmethodSignatureToTMethodSignature, tPrevParameter, mEntry, tParameter,
								eSingleVariableDeclarationToTParameter);
				IsApplicableMatch isApplicableMatch = (IsApplicableMatch) result3_green[6];
				// EMoflonEdge mmethodSignatureToTMethodSignature__mPrevEntry____source = (EMoflonEdge) result3_green[7];
				// EMoflonEdge mmethodSignatureToTMethodSignature__tPrevParameter____target = (EMoflonEdge) result3_green[8];
				// EMoflonEdge tPrevParameter__tParameter____next = (EMoflonEdge) result3_green[9];
				// EMoflonEdge tParameter__tPrevParameter____previous = (EMoflonEdge) result3_green[10];
				// EMoflonEdge eSingleVariableDeclarationToTParameter__mEntry____source = (EMoflonEdge) result3_green[11];
				// EMoflonEdge eSingleVariableDeclarationToTParameter__tParameter____target = (EMoflonEdge) result3_green[12];
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_BWD(IsApplicableMatch isApplicableMatch, MEntry mPrevEntry,
			MEntryToTParameter mmethodSignatureToTMethodSignature, TParameter tPrevParameter, MEntry mEntry,
			TParameter tParameter, MEntryToTParameter eSingleVariableDeclarationToTParameter) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
		isApplicableMatch.getAttributeInfo().add(csp);
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject mPrevEntry,
			EObject mmethodSignatureToTMethodSignature, EObject tPrevParameter, EObject mEntry, EObject tParameter,
			EObject eSingleVariableDeclarationToTParameter) {
		ruleresult.registerObject("mPrevEntry", mPrevEntry);
		ruleresult.registerObject("mmethodSignatureToTMethodSignature", mmethodSignatureToTMethodSignature);
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_42(EMoflonEdge _edge_mNext) {
		// prepare return value
		Object[] result1_bindingAndBlack = MethodParameterLinkImpl
		...
		for (Object[] result2_black : MethodParameterLinkImpl
				.pattern_MethodParameterLink_20_2_testcorematchandDECs_blackFFB(_edge_mNext)) {
			MEntry mPrevEntry = (MEntry) result2_black[0];
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_39(EMoflonEdge _edge_next) {
		// prepare return value
		Object[] result1_bindingAndBlack = MethodParameterLinkImpl
		...
		// ForEach test core match and DECs
		for (Object[] result2_black : MethodParameterLinkImpl
				.pattern_MethodParameterLink_21_2_testcorematchandDECs_blackFFB(_edge_next)) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result2_binding = MethodParameterLinkImpl
				.pattern_MethodParameterLink_24_2_matchcontext_bindingFFFFBB(sourceMatch, targetMatch);
		if (result2_binding == null) {
		...
		for (Object[] result2_black : MethodParameterLinkImpl
				.pattern_MethodParameterLink_24_2_matchcontext_blackBFBBBFBB(mPrevEntry, tPrevParameter, mEntry,
						tParameter, sourceMatch, targetMatch)) {
			MEntryToTParameter mmethodSignatureToTMethodSignature = (MEntryToTParameter) result2_black[1];
			MEntryToTParameter eSingleVariableDeclarationToTParameter = (MEntryToTParameter) result2_black[5];
			Object[] result2_green = MethodParameterLinkImpl
					.pattern_MethodParameterLink_24_2_matchcontext_greenBBBBBBBFB(mPrevEntry,
							mmethodSignatureToTMethodSignature, tPrevParameter, mEntry, tParameter,
			...
			Object[] result3_bindingAndBlack = MethodParameterLinkImpl
					.pattern_MethodParameterLink_24_3_checkcsp_bindingAndBlackFBBBBBBBBBB(this, isApplicableMatch,
							mPrevEntry, mmethodSignatureToTMethodSignature, tPrevParameter, mEntry, tParameter,
							eSingleVariableDeclarationToTParameter, sourceMatch, targetMatch);
			if (result3_bindingAndBlack != null) {
				...
				Object[] result4_black = MethodParameterLinkImpl
						.pattern_MethodParameterLink_24_4_createcorrespondence_blackBBBBB(mPrevEntry, tPrevParameter,
								mEntry, tParameter, isApplicableMatch);
				if (result4_black == null) {
					throw new RuntimeException("Pattern matching in node [create correspondence] failed."
							+ " Variables: " + "[mPrevEntry] = " + mPrevEntry + ", " + "[tPrevParameter] = "
							+ tPrevParameter + ", " + "[mEntry] = " + mEntry + ", " + "[tParameter] = " + tParameter
							+ ", " + "[isApplicableMatch] = " + isApplicableMatch + ".");
				}

				// add to returned result
				Object[] result5_black = MethodParameterLinkImpl
						.pattern_MethodParameterLink_24_5_addtoreturnedresult_blackBB(result, isApplicableMatch);
				if (result5_black == null) {
					throw new RuntimeException(
							"Pattern matching in node [add to returned result] failed." + " Variables: " + "[result] = "
									+ result + ", " + "[isApplicableMatch] = " + isApplicableMatch + ".");
				}
				MethodParameterLinkImpl.pattern_MethodParameterLink_24_5_addtoreturnedresult_greenBB(result,
						isApplicableMatch);
		...
		return MethodParameterLinkImpl.pattern_MethodParameterLink_24_6_expressionFB(result);
	}
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(CCMatch isApplicableMatch, MEntry mPrevEntry,
			MEntryToTParameter mmethodSignatureToTMethodSignature, TParameter tPrevParameter, MEntry mEntry,
			TParameter tParameter, MEntryToTParameter eSingleVariableDeclarationToTParameter, Match sourceMatch,
	 ...
	 * @generated
	 */
	public boolean checkDEC_FWD(MEntry mPrevEntry, MEntry mEntry) {// match tgg pattern
		Object[] result1_black = MethodParameterLinkImpl
	 ...
	 * @generated
	 */
	public boolean checkDEC_BWD(TParameter tPrevParameter, TParameter tParameter) {// match tgg pattern
		Object[] result1_black = MethodParameterLinkImpl
		...
		for (Object[] result2_black : MethodParameterLinkImpl
			...
			if (result3_bindingAndBlack == null) {
				throw new RuntimeException(
						"Pattern matching in node [solve CSP] failed." + " Variables: " + "[this] = " + this + ", "
								+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[mPrevEntry] = " + mPrevEntry
								+ ", " + "[mmethodSignatureToTMethodSignature] = " + mmethodSignatureToTMethodSignature
								+ ", " + "[tPrevParameter] = " + tPrevParameter + ", " + "[mEntry] = " + mEntry + ", "
			...
			if (MethodParameterLinkImpl.pattern_MethodParameterLink_29_4_checkCSP_expressionFBB(this, csp)) {
				...
				if (result5_black != null) {
					...
					// perform
					Object[] result6_black = MethodParameterLinkImpl
							.pattern_MethodParameterLink_29_6_perform_blackBBBBBBB(mPrevEntry,
									mmethodSignatureToTMethodSignature, tPrevParameter, mEntry, tParameter,
									eSingleVariableDeclarationToTParameter, ruleResult);
					if (result6_black == null) {
	 ...
	 * @generated
	 */
	public CSP generateModel_solveCsp_BWD(IsApplicableMatch isApplicableMatch, MEntry mPrevEntry,
			MEntryToTParameter mmethodSignatureToTMethodSignature, TParameter tPrevParameter, MEntry mEntry,
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.METHOD_PARAMETER_LINK___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_MENTRY_MENTRYTOTPARAMETER_TPARAMETER_MENTRY_TPARAMETER_MENTRYTOTPARAMETER:
			return isApplicable_solveCsp_FWD((IsApplicableMatch) arguments.get(0), (MEntry) arguments.get(1),
					(MEntryToTParameter) arguments.get(2), (TParameter) arguments.get(3), (MEntry) arguments.get(4),
					(TParameter) arguments.get(5), (MEntryToTParameter) arguments.get(6));
		...
		case RulesPackage.METHOD_PARAMETER_LINK___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_MENTRY_MENTRYTOTPARAMETER_TPARAMETER_MENTRY_TPARAMETER_MENTRYTOTPARAMETER:
			return isApplicable_solveCsp_BWD((IsApplicableMatch) arguments.get(0), (MEntry) arguments.get(1),
					(MEntryToTParameter) arguments.get(2), (TParameter) arguments.get(3), (MEntry) arguments.get(4),
					(TParameter) arguments.get(5), (MEntryToTParameter) arguments.get(6));
		...
		case RulesPackage.METHOD_PARAMETER_LINK___IS_APPROPRIATE_FWD_EMOFLON_EDGE_42__EMOFLONEDGE:
			return isAppropriate_FWD_EMoflonEdge_42((EMoflonEdge) arguments.get(0));
		case RulesPackage.METHOD_PARAMETER_LINK___IS_APPROPRIATE_BWD_EMOFLON_EDGE_39__EMOFLONEDGE:
		...
		case RulesPackage.METHOD_PARAMETER_LINK___IS_APPLICABLE_SOLVE_CSP_CC__CCMATCH_MENTRY_MENTRYTOTPARAMETER_TPARAMETER_MENTRY_TPARAMETER_MENTRYTOTPARAMETER_MATCH_MATCH:
			return isApplicable_solveCsp_CC((CCMatch) arguments.get(0), (MEntry) arguments.get(1),
					(MEntryToTParameter) arguments.get(2), (TParameter) arguments.get(3), (MEntry) arguments.get(4),
					(TParameter) arguments.get(5), (MEntryToTParameter) arguments.get(6), (Match) arguments.get(7),
		...
		case RulesPackage.METHOD_PARAMETER_LINK___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_MENTRY_MENTRYTOTPARAMETER_TPARAMETER_MENTRY_TPARAMETER_MENTRYTOTPARAMETER_MODELGENERATORRULERESULT:
	...
	public static final Object[] pattern_MethodParameterLink_1_1_performtransformation_bindingFFFFFFB(
			IsApplicableMatch isApplicableMatch) {
		EObject _localVariable_0 = isApplicableMatch.getObject("mPrevEntry");
		EObject _localVariable_1 = isApplicableMatch.getObject("mmethodSignatureToTMethodSignature");
		...
		EObject tmpMmethodSignatureToTMethodSignature = _localVariable_1;
					...
					if (tmpMEntry instanceof MEntry) {
						...
						if (tmpTParameter instanceof TParameter) {
							...
							if (tmpESingleVariableDeclarationToTParameter instanceof MEntryToTParameter) {
								...
								return new Object[] { mPrevEntry, mmethodSignatureToTMethodSignature, tPrevParameter,
	...
	public static final Object[] pattern_MethodParameterLink_1_1_performtransformation_blackBBBBBBFBB(MEntry mPrevEntry,
			MEntryToTParameter mmethodSignatureToTMethodSignature, TParameter tPrevParameter, MEntry mEntry,
			TParameter tParameter, MEntryToTParameter eSingleVariableDeclarationToTParameter, MethodParameterLink _this,
			IsApplicableMatch isApplicableMatch) {
		if (!mEntry.equals(mPrevEntry)) {
	...
	public static final Object[] pattern_MethodParameterLink_1_1_performtransformation_bindingAndBlackFFFFFFFBB(
		...
		if (result_pattern_MethodParameterLink_1_1_performtransformation_binding != null) {
			MEntry mPrevEntry = (MEntry) result_pattern_MethodParameterLink_1_1_performtransformation_binding[0];
			MEntryToTParameter mmethodSignatureToTMethodSignature = (MEntryToTParameter) result_pattern_MethodParameterLink_1_1_performtransformation_binding[1];
			...
			if (result_pattern_MethodParameterLink_1_1_performtransformation_black != null) {
				...
				return new Object[] { mPrevEntry, mmethodSignatureToTMethodSignature, tPrevParameter, mEntry,
	...
	public static final Object[] pattern_MethodParameterLink_1_3_bookkeepingforedges_blackBBBBBBB(
			PerformRuleResult ruleresult, EObject mPrevEntry, EObject mmethodSignatureToTMethodSignature,
	...
	public static final void pattern_MethodParameterLink_1_5_registerobjects_expressionBBBBBBBB(
			MethodParameterLink _this, PerformRuleResult ruleresult, EObject mPrevEntry,
			EObject mmethodSignatureToTMethodSignature, EObject tPrevParameter, EObject mEntry, EObject tParameter,
			EObject eSingleVariableDeclarationToTParameter) {
		_this.registerObjects_FWD(ruleresult, mPrevEntry, mmethodSignatureToTMethodSignature, tPrevParameter, mEntry,
				tParameter, eSingleVariableDeclarationToTParameter);
	...
	public static final Iterable<Object[]> pattern_MethodParameterLink_2_2_corematch_blackBFFBFFB(MEntry mPrevEntry,
				...
				if (tPrevParameter != null) {
					for (MEntryToTParameter eSingleVariableDeclarationToTParameter : org.moflon.core.utilities.eMoflonEMFUtil
						...
						if (!eSingleVariableDeclarationToTParameter.equals(mmethodSignatureToTMethodSignature)) {
							...
							if (tParameter != null) {
								if (!tParameter.equals(tPrevParameter)) {
									_result.add(new Object[] { mPrevEntry, mmethodSignatureToTMethodSignature,
	...
	public static final Iterable<Object[]> pattern_MethodParameterLink_2_3_findcontext_blackBBBBBB(MEntry mPrevEntry,
			MEntryToTParameter mmethodSignatureToTMethodSignature, TParameter tPrevParameter, MEntry mEntry,
			TParameter tParameter, MEntryToTParameter eSingleVariableDeclarationToTParameter) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!mEntry.equals(mPrevEntry)) {
	...
	public static final Object[] pattern_MethodParameterLink_2_3_findcontext_greenBBBBBBFFFFFFF(MEntry mPrevEntry,
			MEntryToTParameter mmethodSignatureToTMethodSignature, TParameter tPrevParameter, MEntry mEntry,
			TParameter tParameter, MEntryToTParameter eSingleVariableDeclarationToTParameter) {
		...
		return new Object[] { mPrevEntry, mmethodSignatureToTMethodSignature, tPrevParameter, mEntry, tParameter,
				eSingleVariableDeclarationToTParameter, isApplicableMatch, mPrevEntry__mEntry____mNext,
				mEntry__mPrevEntry____mPrevious, mmethodSignatureToTMethodSignature__mPrevEntry____source,
				mmethodSignatureToTMethodSignature__tPrevParameter____target,
				eSingleVariableDeclarationToTParameter__mEntry____source,
				eSingleVariableDeclarationToTParameter__tParameter____target };
	}
	...
	public static final Object[] pattern_MethodParameterLink_2_4_solveCSP_bindingFBBBBBBBB(MethodParameterLink _this,
			IsApplicableMatch isApplicableMatch, MEntry mPrevEntry,
			MEntryToTParameter mmethodSignatureToTMethodSignature, TParameter tPrevParameter, MEntry mEntry,
			TParameter tParameter, MEntryToTParameter eSingleVariableDeclarationToTParameter) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, mPrevEntry,
				mmethodSignatureToTMethodSignature, tPrevParameter, mEntry, tParameter,
				eSingleVariableDeclarationToTParameter);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, mPrevEntry, mmethodSignatureToTMethodSignature,
					tPrevParameter, mEntry, tParameter, eSingleVariableDeclarationToTParameter };
		}
		return null;
	}
	...
	public static final Object[] pattern_MethodParameterLink_2_4_solveCSP_bindingAndBlackFBBBBBBBB(
			MethodParameterLink _this, IsApplicableMatch isApplicableMatch, MEntry mPrevEntry,
			MEntryToTParameter mmethodSignatureToTMethodSignature, TParameter tPrevParameter, MEntry mEntry,
			TParameter tParameter, MEntryToTParameter eSingleVariableDeclarationToTParameter) {
		Object[] result_pattern_MethodParameterLink_2_4_solveCSP_binding = pattern_MethodParameterLink_2_4_solveCSP_bindingFBBBBBBBB(
				_this, isApplicableMatch, mPrevEntry, mmethodSignatureToTMethodSignature, tPrevParameter, mEntry,
				tParameter, eSingleVariableDeclarationToTParameter);
	...
	public static final Object[] pattern_MethodParameterLink_11_1_performtransformation_blackBBBBBBFBB(
			MEntry mPrevEntry, MEntryToTParameter mmethodSignatureToTMethodSignature, TParameter tPrevParameter,
	...
	public static final Object[] pattern_MethodParameterLink_11_1_performtransformation_bindingAndBlackFFFFFFFBB(
		...
		if (result_pattern_MethodParameterLink_11_1_performtransformation_binding != null) {
			MEntry mPrevEntry = (MEntry) result_pattern_MethodParameterLink_11_1_performtransformation_binding[0];
			MEntryToTParameter mmethodSignatureToTMethodSignature = (MEntryToTParameter) result_pattern_MethodParameterLink_11_1_performtransformation_binding[1];
	...
	public static final void pattern_MethodParameterLink_11_5_registerobjects_expressionBBBBBBBB(
			...
			EObject mmethodSignatureToTMethodSignature, EObject tPrevParameter, EObject mEntry, EObject tParameter,
			EObject eSingleVariableDeclarationToTParameter) {
		_this.registerObjects_BWD(ruleresult, mPrevEntry, mmethodSignatureToTMethodSignature, tPrevParameter, mEntry,
				tParameter, eSingleVariableDeclarationToTParameter);
	...
	public static final Iterable<Object[]> pattern_MethodParameterLink_12_3_findcontext_blackBBBBBB(MEntry mPrevEntry,
			MEntryToTParameter mmethodSignatureToTMethodSignature, TParameter tPrevParameter, MEntry mEntry,
			TParameter tParameter, MEntryToTParameter eSingleVariableDeclarationToTParameter) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!mEntry.equals(mPrevEntry)) {
	...
	public static final Object[] pattern_MethodParameterLink_12_3_findcontext_greenBBBBBBFFFFFFF(MEntry mPrevEntry,
			MEntryToTParameter mmethodSignatureToTMethodSignature, TParameter tPrevParameter, MEntry mEntry,
			TParameter tParameter, MEntryToTParameter eSingleVariableDeclarationToTParameter) {
		IsApplicableMatch isApplicableMatch = RuntimeFactory.eINSTANCE.createIsApplicableMatch();
		EMoflonEdge mmethodSignatureToTMethodSignature__mPrevEntry____source = RuntimeFactory.eINSTANCE
		...
		return new Object[] { mPrevEntry, mmethodSignatureToTMethodSignature, tPrevParameter, mEntry, tParameter,
				...
				tParameter__tPrevParameter____previous, eSingleVariableDeclarationToTParameter__mEntry____source,
				eSingleVariableDeclarationToTParameter__tParameter____target };
	}
	...
	public static final Object[] pattern_MethodParameterLink_12_4_solveCSP_bindingFBBBBBBBB(MethodParameterLink _this,
			...
			MEntryToTParameter mmethodSignatureToTMethodSignature, TParameter tPrevParameter, MEntry mEntry,
			TParameter tParameter, MEntryToTParameter eSingleVariableDeclarationToTParameter) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, mPrevEntry,
				mmethodSignatureToTMethodSignature, tPrevParameter, mEntry, tParameter,
				eSingleVariableDeclarationToTParameter);
		CSP csp = _localVariable_0;
		if (csp != null) {
	...
	public static final Object[] pattern_MethodParameterLink_24_2_matchcontext_bindingFFFFBB(Match sourceMatch,
			Match targetMatch) {
	...
	public static final Iterable<Object[]> pattern_MethodParameterLink_24_2_matchcontext_blackBFBBBFBB(
								...
								if (tPrevParameter.equals(mmethodSignatureToTMethodSignature.getTarget())) {
									for (MEntryToTParameter eSingleVariableDeclarationToTParameter : org.moflon.core.utilities.eMoflonEMFUtil
										...
										if (!eSingleVariableDeclarationToTParameter
												.equals(mmethodSignatureToTMethodSignature)) {
											if (tParameter.equals(eSingleVariableDeclarationToTParameter.getTarget())) {
												_result.add(new Object[] { mPrevEntry,
														mmethodSignatureToTMethodSignature, tPrevParameter, mEntry,
														tParameter, eSingleVariableDeclarationToTParameter, sourceMatch,
														targetMatch });
											}
										}
									}
	...
	public static final Object[] pattern_MethodParameterLink_24_2_matchcontext_greenBBBBBBBFB(MEntry mPrevEntry,
			MEntryToTParameter mmethodSignatureToTMethodSignature, TParameter tPrevParameter, MEntry mEntry,
			TParameter tParameter, MEntryToTParameter eSingleVariableDeclarationToTParameter, Match sourceMatch,
			Match targetMatch) {
		...
		isApplicableMatch.setRuleName(isApplicableMatch_ruleName_prime);
		return new Object[] { mPrevEntry, mmethodSignatureToTMethodSignature, tPrevParameter, mEntry, tParameter,
				eSingleVariableDeclarationToTParameter, sourceMatch, isApplicableMatch, targetMatch };
	}

	public static final Object[] pattern_MethodParameterLink_24_3_checkcsp_bindingFBBBBBBBBBB(MethodParameterLink _this,
			CCMatch isApplicableMatch, MEntry mPrevEntry, MEntryToTParameter mmethodSignatureToTMethodSignature,
			TParameter tPrevParameter, MEntry mEntry, TParameter tParameter,
			MEntryToTParameter eSingleVariableDeclarationToTParameter, Match sourceMatch, Match targetMatch) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_CC(isApplicableMatch, mPrevEntry,
				mmethodSignatureToTMethodSignature, tPrevParameter, mEntry, tParameter,
				eSingleVariableDeclarationToTParameter, sourceMatch, targetMatch);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, mPrevEntry, mmethodSignatureToTMethodSignature,
					tPrevParameter, mEntry, tParameter, eSingleVariableDeclarationToTParameter, sourceMatch,
					targetMatch };
		}
		return null;
	}

	public static final Object[] pattern_MethodParameterLink_24_3_checkcsp_blackB(CSP csp) {
		return new Object[] { csp };
	}

	public static final Object[] pattern_MethodParameterLink_24_3_checkcsp_bindingAndBlackFBBBBBBBBBB(
			MethodParameterLink _this, CCMatch isApplicableMatch, MEntry mPrevEntry,
			MEntryToTParameter mmethodSignatureToTMethodSignature, TParameter tPrevParameter, MEntry mEntry,
			TParameter tParameter, MEntryToTParameter eSingleVariableDeclarationToTParameter, Match sourceMatch,
			Match targetMatch) {
		Object[] result_pattern_MethodParameterLink_24_3_checkcsp_binding = pattern_MethodParameterLink_24_3_checkcsp_bindingFBBBBBBBBBB(
				_this, isApplicableMatch, mPrevEntry, mmethodSignatureToTMethodSignature, tPrevParameter, mEntry,
				tParameter, eSingleVariableDeclarationToTParameter, sourceMatch, targetMatch);
		if (result_pattern_MethodParameterLink_24_3_checkcsp_binding != null) {
			CSP csp = (CSP) result_pattern_MethodParameterLink_24_3_checkcsp_binding[0];

			Object[] result_pattern_MethodParameterLink_24_3_checkcsp_black = pattern_MethodParameterLink_24_3_checkcsp_blackB(
					csp);
			if (result_pattern_MethodParameterLink_24_3_checkcsp_black != null) {
	...
	public static final Object[] pattern_MethodParameterLink_24_4_createcorrespondence_blackBBBBB(MEntry mPrevEntry,
			TParameter tPrevParameter, MEntry mEntry, TParameter tParameter, CCMatch isApplicableMatch) {
		if (!mEntry.equals(mPrevEntry)) {
			if (!tParameter.equals(tPrevParameter)) {
				return new Object[] { mPrevEntry, tPrevParameter, mEntry, tParameter, isApplicableMatch };
			}
		}
		return null;
	}

	public static final Object[] pattern_MethodParameterLink_24_5_addtoreturnedresult_blackBB(
			IsApplicableRuleResult result, CCMatch isApplicableMatch) {
		return new Object[] { result, isApplicableMatch };
	}

	public static final Object[] pattern_MethodParameterLink_24_5_addtoreturnedresult_greenBB(
			IsApplicableRuleResult result, CCMatch isApplicableMatch) {
	...
	public static final IsApplicableRuleResult pattern_MethodParameterLink_24_6_expressionFB(
	...
	public static final Object[] pattern_MethodParameterLink_29_3_solveCSP_bindingFBBBBBBBBB(MethodParameterLink _this,
		...
		CSP _localVariable_0 = _this.generateModel_solveCsp_BWD(isApplicableMatch, mPrevEntry,
				mmethodSignatureToTMethodSignature, tPrevParameter, mEntry, tParameter,
				eSingleVariableDeclarationToTParameter, ruleResult);
		CSP csp = _localVariable_0;
		if (csp != null) {
	...
	public static final Object[] pattern_MethodParameterLink_29_5_checknacs_blackBBBBBB(MEntry mPrevEntry,
			MEntryToTParameter mmethodSignatureToTMethodSignature, TParameter tPrevParameter, MEntry mEntry,
			TParameter tParameter, MEntryToTParameter eSingleVariableDeclarationToTParameter) {
		if (!mEntry.equals(mPrevEntry)) {
			if (!tParameter.equals(tPrevParameter)) {
	...
	public static final Object[] pattern_MethodParameterLink_29_6_perform_blackBBBBBBB(MEntry mPrevEntry,
			MEntryToTParameter mmethodSignatureToTMethodSignature, TParameter tPrevParameter, MEntry mEntry,
			TParameter tParameter, MEntryToTParameter eSingleVariableDeclarationToTParameter,
			ModelgeneratorRuleResult ruleResult) {
		if (!mEntry.equals(mPrevEntry)) {
