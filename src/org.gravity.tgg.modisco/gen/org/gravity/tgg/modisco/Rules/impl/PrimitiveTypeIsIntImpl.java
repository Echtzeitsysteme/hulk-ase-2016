...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Primitive Type Is Int</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * </p>
 *
 * @generated
 */
public class PrimitiveTypeIsIntImpl extends AbstractRuleImpl implements PrimitiveTypeIsInt {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected PrimitiveTypeIsIntImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return RulesPackage.eINSTANCE.getPrimitiveTypeIsInt();
	}
	 ...
	 * @generated
	 */
	public boolean isAppropriate_FWD(Match match, PrimitiveTypeInt ePrimitiveType, Model eModel) {
		// initial bindings
		Object[] result1_black = PrimitiveTypeIsIntImpl.pattern_PrimitiveTypeIsInt_0_1_initialbindings_blackBBBB(this,
		...
		Object[] result2_bindingAndBlack = PrimitiveTypeIsIntImpl
				.pattern_PrimitiveTypeIsInt_0_2_SolveCSP_bindingAndBlackFBBBB(this, match, ePrimitiveType, eModel);
		...
		// Check CSP
		if (PrimitiveTypeIsIntImpl.pattern_PrimitiveTypeIsInt_0_3_CheckCSP_expressionFBB(this, csp)) {

			// collect elements to be translated
			Object[] result4_black = PrimitiveTypeIsIntImpl
					.pattern_PrimitiveTypeIsInt_0_4_collectelementstobetranslated_blackBBB(match, ePrimitiveType,
							eModel);
			...
			PrimitiveTypeIsIntImpl.pattern_PrimitiveTypeIsInt_0_4_collectelementstobetranslated_greenBBBF(match,
			...
			Object[] result5_black = PrimitiveTypeIsIntImpl
					.pattern_PrimitiveTypeIsInt_0_5_collectcontextelements_blackBBB(match, ePrimitiveType, eModel);
			if (result5_black == null) {
				throw new RuntimeException("Pattern matching in node [collect context elements] failed."
						+ " Variables: " + "[match] = " + match + ", " + "[ePrimitiveType] = " + ePrimitiveType + ", "
						+ "[eModel] = " + eModel + ".");
			}
			PrimitiveTypeIsIntImpl.pattern_PrimitiveTypeIsInt_0_5_collectcontextelements_greenBB(match, eModel);

			// register objects to match
			PrimitiveTypeIsIntImpl.pattern_PrimitiveTypeIsInt_0_6_registerobjectstomatch_expressionBBBB(this, match,
					ePrimitiveType, eModel);
			return PrimitiveTypeIsIntImpl.pattern_PrimitiveTypeIsInt_0_7_expressionF();
		} else {
			return PrimitiveTypeIsIntImpl.pattern_PrimitiveTypeIsInt_0_8_expressionF();
		}
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result1_green = PrimitiveTypeIsIntImpl
				.pattern_PrimitiveTypeIsInt_1_1_performtransformation_greenBBFFF(ePrimitiveType, typeGraph);
		...
		Object[] result2_black = PrimitiveTypeIsIntImpl
				.pattern_PrimitiveTypeIsInt_1_2_collecttranslatedelements_blackBBBB(ePrimitiveType,
		...
		Object[] result2_green = PrimitiveTypeIsIntImpl
				.pattern_PrimitiveTypeIsInt_1_2_collecttranslatedelements_greenFBBBB(ePrimitiveType,
						ePrimitiveTypeToTPrimitiveClass, typeToTAbstractType, tPrimitiveClass);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		Object[] result1_bindingAndBlack = PrimitiveTypeIsIntImpl
				.pattern_PrimitiveTypeIsInt_2_1_preparereturnvalue_bindingAndBlackFFB(this);
		if (result1_bindingAndBlack == null) {
		...
		Object[] result1_green = PrimitiveTypeIsIntImpl
				.pattern_PrimitiveTypeIsInt_2_1_preparereturnvalue_greenBF(performOperation);
		IsApplicableRuleResult ruleresult = (IsApplicableRuleResult) result1_green[1];

		// ForEach core match
		Object[] result2_binding = PrimitiveTypeIsIntImpl.pattern_PrimitiveTypeIsInt_2_2_corematch_bindingFFB(match);
		if (result2_binding == null) {
			throw new RuntimeException(
					"Binding in node core match failed." + " Variables: " + "[match] = " + match + ".");
		}
		PrimitiveTypeInt ePrimitiveType = (PrimitiveTypeInt) result2_binding[0];
		Model eModel = (Model) result2_binding[1];
		for (Object[] result2_black : PrimitiveTypeIsIntImpl
				.pattern_PrimitiveTypeIsInt_2_2_corematch_blackBFFBB(ePrimitiveType, eModel, match)) {
			...
			for (Object[] result3_black : PrimitiveTypeIsIntImpl.pattern_PrimitiveTypeIsInt_2_3_findcontext_blackBBBB(
				...
				// check CSP
				if (PrimitiveTypeIsIntImpl.pattern_PrimitiveTypeIsInt_2_5_checkCSP_expressionFBB(this, csp)) {

					// add match to rule result
					Object[] result6_black = PrimitiveTypeIsIntImpl
							.pattern_PrimitiveTypeIsInt_2_6_addmatchtoruleresult_blackBB(ruleresult, isApplicableMatch);
					if (result6_black == null) {
						throw new RuntimeException("Pattern matching in node [add match to rule result] failed."
								+ " Variables: " + "[ruleresult] = " + ruleresult + ", " + "[isApplicableMatch] = "
								+ isApplicableMatch + ".");
					}
					PrimitiveTypeIsIntImpl.pattern_PrimitiveTypeIsInt_2_6_addmatchtoruleresult_greenBB(ruleresult,
							isApplicableMatch);
		...
		return PrimitiveTypeIsIntImpl.pattern_PrimitiveTypeIsInt_2_7_expressionFB(ruleresult);
	}
	 ...
	 * @generated
	 */
	public void registerObjectsToMatch_FWD(Match match, PrimitiveTypeInt ePrimitiveType, Model eModel) {
	 ...
	 * @generated
	 */
	public CSP isAppropriate_solveCsp_FWD(Match match, PrimitiveTypeInt ePrimitiveType, Model eModel) {// Create CSP
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		// CSP csp = (CSP) result1_bindingAndBlack[4];
		Object[] result1_green = PrimitiveTypeIsIntImpl
				.pattern_PrimitiveTypeIsInt_11_1_performtransformation_greenFFFBB(tPrimitiveClass, eModel);
		...
		// collect translated elements
		Object[] result2_black = PrimitiveTypeIsIntImpl
				.pattern_PrimitiveTypeIsInt_11_2_collecttranslatedelements_blackBBBB(ePrimitiveType,
						ePrimitiveTypeToTPrimitiveClass, typeToTAbstractType, tPrimitiveClass);
		if (result2_black == null) {
			throw new RuntimeException("Pattern matching in node [collect translated elements] failed." + " Variables: "
					+ "[ePrimitiveType] = " + ePrimitiveType + ", " + "[ePrimitiveTypeToTPrimitiveClass] = "
		...
		Object[] result2_green = PrimitiveTypeIsIntImpl
				.pattern_PrimitiveTypeIsInt_11_2_collecttranslatedelements_greenFBBBB(ePrimitiveType,
						ePrimitiveTypeToTPrimitiveClass, typeToTAbstractType, tPrimitiveClass);
		PerformRuleResult ruleresult = (PerformRuleResult) result2_green[0];
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		// prepare return value
		Object[] result1_bindingAndBlack = PrimitiveTypeIsIntImpl
				.pattern_PrimitiveTypeIsInt_12_1_preparereturnvalue_bindingAndBlackFFB(this);
		if (result1_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching in node [prepare return value] failed." + " Variables: "
					+ "[this] = " + this + ".");
		}
		...
		// EClass eClass = (EClass) result1_bindingAndBlack[1];
		Object[] result1_green = PrimitiveTypeIsIntImpl
				.pattern_PrimitiveTypeIsInt_12_1_preparereturnvalue_greenBF(performOperation);
		IsApplicableRuleResult ruleresult = (IsApplicableRuleResult) result1_green[1];
		...
		for (Object[] result2_black : PrimitiveTypeIsIntImpl
			...
			for (Object[] result3_black : PrimitiveTypeIsIntImpl.pattern_PrimitiveTypeIsInt_12_3_findcontext_blackBBBB(
				...
				CSP csp = (CSP) result4_bindingAndBlack[0];
				// check CSP
				if (PrimitiveTypeIsIntImpl.pattern_PrimitiveTypeIsInt_12_5_checkCSP_expressionFBB(this, csp)) {

					// add match to rule result
					Object[] result6_black = PrimitiveTypeIsIntImpl
							.pattern_PrimitiveTypeIsInt_12_6_addmatchtoruleresult_blackBB(ruleresult,
									isApplicableMatch);
					if (result6_black == null) {
						throw new RuntimeException("Pattern matching in node [add match to rule result] failed."
								+ " Variables: " + "[ruleresult] = " + ruleresult + ", " + "[isApplicableMatch] = "
					...
					PrimitiveTypeIsIntImpl.pattern_PrimitiveTypeIsInt_12_6_addmatchtoruleresult_greenBB(ruleresult,
							isApplicableMatch);
		...
		return PrimitiveTypeIsIntImpl.pattern_PrimitiveTypeIsInt_12_7_expressionFB(ruleresult);
	}
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_25(EMoflonEdge _edge_orphanTypes) {
		// prepare return value
		Object[] result1_bindingAndBlack = PrimitiveTypeIsIntImpl
		...
		Object[] result1_green = PrimitiveTypeIsIntImpl.pattern_PrimitiveTypeIsInt_20_1_preparereturnvalue_greenF();
		EObjectContainer __result = (EObjectContainer) result1_green[0];

		// ForEach test core match and DECs
		for (Object[] result2_black : PrimitiveTypeIsIntImpl
				.pattern_PrimitiveTypeIsInt_20_2_testcorematchandDECs_blackFFB(_edge_orphanTypes)) {
			PrimitiveTypeInt ePrimitiveType = (PrimitiveTypeInt) result2_black[0];
			...
			if (PrimitiveTypeIsIntImpl
				...
				if (PrimitiveTypeIsIntImpl
					...
					// Add match to rule result
					Object[] result5_black = PrimitiveTypeIsIntImpl
							.pattern_PrimitiveTypeIsInt_20_5_Addmatchtoruleresult_blackBBBB(match, __performOperation,
					...
					PrimitiveTypeIsIntImpl.pattern_PrimitiveTypeIsInt_20_5_Addmatchtoruleresult_greenBBBB(match,
		...
		return PrimitiveTypeIsIntImpl.pattern_PrimitiveTypeIsInt_20_6_expressionFB(__result);
	}
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_23(EMoflonEdge _edge_classes) {
		// prepare return value
		Object[] result1_bindingAndBlack = PrimitiveTypeIsIntImpl
		...
		EClass __eClass = (EClass) result1_bindingAndBlack[1];
		EOperation isApplicableCC = (EOperation) result1_bindingAndBlack[3];
		Object[] result1_green = PrimitiveTypeIsIntImpl.pattern_PrimitiveTypeIsInt_21_1_preparereturnvalue_greenF();
		EObjectContainer __result = (EObjectContainer) result1_green[0];

		// ForEach test core match and DECs
		for (Object[] result2_black : PrimitiveTypeIsIntImpl
				.pattern_PrimitiveTypeIsInt_21_2_testcorematchandDECs_blackFFB(_edge_classes)) {
			TypeGraph typeGraph = (TypeGraph) result2_black[0];
			TClass tPrimitiveClass = (TClass) result2_black[1];
			Object[] result2_green = PrimitiveTypeIsIntImpl
					.pattern_PrimitiveTypeIsInt_21_2_testcorematchandDECs_greenFB(__eClass);
			Match match = (Match) result2_green[0];

			// bookkeeping with generic isAppropriate method
			if (PrimitiveTypeIsIntImpl
					.pattern_PrimitiveTypeIsInt_21_3_bookkeepingwithgenericisAppropriatemethod_expressionFBBBB(this,
							match, typeGraph, tPrimitiveClass)) {
				// Ensure that the correct types of elements are matched
				if (PrimitiveTypeIsIntImpl
						.pattern_PrimitiveTypeIsInt_21_4_Ensurethatthecorrecttypesofelementsarematched_expressionFBB(
								this, match)) {

					// Add match to rule result
					Object[] result5_black = PrimitiveTypeIsIntImpl
							.pattern_PrimitiveTypeIsInt_21_5_Addmatchtoruleresult_blackBBBB(match, __performOperation,
									__result, isApplicableCC);
					if (result5_black == null) {
						throw new RuntimeException("Pattern matching in node [Add match to rule result] failed."
								+ " Variables: " + "[match] = " + match + ", " + "[__performOperation] = "
					...
					PrimitiveTypeIsIntImpl.pattern_PrimitiveTypeIsInt_21_5_Addmatchtoruleresult_greenBBBB(match,
							__performOperation, __result, isApplicableCC);
		...
		return PrimitiveTypeIsIntImpl.pattern_PrimitiveTypeIsInt_21_6_expressionFB(__result);
	}
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		// prepare
		Object[] result1_black = PrimitiveTypeIsIntImpl.pattern_PrimitiveTypeIsInt_24_1_prepare_blackB(this);
		if (result1_black == null) {
			throw new RuntimeException(
					"Pattern matching in node [prepare] failed." + " Variables: " + "[this] = " + this + ".");
		}
		Object[] result1_green = PrimitiveTypeIsIntImpl.pattern_PrimitiveTypeIsInt_24_1_prepare_greenF();
		IsApplicableRuleResult result = (IsApplicableRuleResult) result1_green[0];

		// ForEach match context
		Object[] result2_binding = PrimitiveTypeIsIntImpl
				.pattern_PrimitiveTypeIsInt_24_2_matchcontext_bindingFFFFBB(sourceMatch, targetMatch);
		if (result2_binding == null) {
		...
		for (Object[] result2_black : PrimitiveTypeIsIntImpl.pattern_PrimitiveTypeIsInt_24_2_matchcontext_blackBFBBBBB(
				ePrimitiveType, typeGraph, tPrimitiveClass, eModel, sourceMatch, targetMatch)) {
			ModelToTypeGraph eModelToTypeGraph = (ModelToTypeGraph) result2_black[1];
			Object[] result2_green = PrimitiveTypeIsIntImpl.pattern_PrimitiveTypeIsInt_24_2_matchcontext_greenBBBBBBFB(
					ePrimitiveType, eModelToTypeGraph, typeGraph, tPrimitiveClass, eModel, sourceMatch, targetMatch);
			CCMatch isApplicableMatch = (CCMatch) result2_green[6];

			// check csp
			Object[] result3_bindingAndBlack = PrimitiveTypeIsIntImpl
					.pattern_PrimitiveTypeIsInt_24_3_checkcsp_bindingAndBlackFBBBBBBBBB(this, isApplicableMatch,
			...
			if (result3_bindingAndBlack != null) {
				...
				Object[] result4_black = PrimitiveTypeIsIntImpl
						.pattern_PrimitiveTypeIsInt_24_4_createcorrespondence_blackBBBBB(ePrimitiveType, typeGraph,
				...
				PrimitiveTypeIsIntImpl.pattern_PrimitiveTypeIsInt_24_4_createcorrespondence_greenBFFBB(ePrimitiveType,
				...
				Object[] result5_black = PrimitiveTypeIsIntImpl
						.pattern_PrimitiveTypeIsInt_24_5_addtoreturnedresult_blackBB(result, isApplicableMatch);
				if (result5_black == null) {
					throw new RuntimeException(
							"Pattern matching in node [add to returned result] failed." + " Variables: " + "[result] = "
									+ result + ", " + "[isApplicableMatch] = " + isApplicableMatch + ".");
				}
				PrimitiveTypeIsIntImpl.pattern_PrimitiveTypeIsInt_24_5_addtoreturnedresult_greenBB(result,
						isApplicableMatch);
		...
		return PrimitiveTypeIsIntImpl.pattern_PrimitiveTypeIsInt_24_6_expressionFB(result);
	}
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(CCMatch isApplicableMatch, PrimitiveTypeInt ePrimitiveType,
	 ...
	 * @generated
	 */
	public boolean checkDEC_FWD(PrimitiveTypeInt ePrimitiveType, Model eModel) {// match tgg pattern
		Object[] result1_black = PrimitiveTypeIsIntImpl
				.pattern_PrimitiveTypeIsInt_27_1_matchtggpattern_blackBB(ePrimitiveType, eModel);
		if (result1_black != null) {
			return PrimitiveTypeIsIntImpl.pattern_PrimitiveTypeIsInt_27_2_expressionF();
		} else {
			return PrimitiveTypeIsIntImpl.pattern_PrimitiveTypeIsInt_27_3_expressionF();
		}
	...
	public boolean checkDEC_BWD(TypeGraph typeGraph, TClass tPrimitiveClass) {// match tgg pattern
		...
		if (result1_black != null) {
			...
			return PrimitiveTypeIsIntImpl.pattern_PrimitiveTypeIsInt_28_2_expressionF();
		} else {
			return PrimitiveTypeIsIntImpl.pattern_PrimitiveTypeIsInt_28_3_expressionF();
		}
	...
	public ModelgeneratorRuleResult generateModel(RuleEntryContainer ruleEntryContainer,
		...
		// create result
		Object[] result1_black = PrimitiveTypeIsIntImpl.pattern_PrimitiveTypeIsInt_29_1_createresult_blackB(this);
		if (result1_black == null) {
			throw new RuntimeException(
					"Pattern matching in node [create result] failed." + " Variables: " + "[this] = " + this + ".");
		}
		Object[] result1_green = PrimitiveTypeIsIntImpl.pattern_PrimitiveTypeIsInt_29_1_createresult_greenFF();
		...
		for (Object[] result2_black : PrimitiveTypeIsIntImpl
			...
			if (PrimitiveTypeIsIntImpl.pattern_PrimitiveTypeIsInt_29_4_checkCSP_expressionFBB(this, csp)) {
				...
				if (result5_black != null) {
					...
					PrimitiveTypeIsIntImpl.pattern_PrimitiveTypeIsInt_29_6_perform_greenFBFFFBB(typeGraph, eModel,
							ruleResult);
					// PrimitiveTypeInt ePrimitiveType = (PrimitiveTypeInt) result6_green[0];
		...
		return PrimitiveTypeIsIntImpl.pattern_PrimitiveTypeIsInt_29_7_expressionFB(ruleResult);
	}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
		case RulesPackage.PRIMITIVE_TYPE_IS_INT___IS_APPROPRIATE_FWD__MATCH_PRIMITIVETYPEINT_MODEL:
			return isAppropriate_FWD((Match) arguments.get(0), (PrimitiveTypeInt) arguments.get(1),
					(Model) arguments.get(2));
		case RulesPackage.PRIMITIVE_TYPE_IS_INT___PERFORM_FWD__ISAPPLICABLEMATCH:
			return perform_FWD((IsApplicableMatch) arguments.get(0));
		case RulesPackage.PRIMITIVE_TYPE_IS_INT___IS_APPLICABLE_FWD__MATCH:
			return isApplicable_FWD((Match) arguments.get(0));
		case RulesPackage.PRIMITIVE_TYPE_IS_INT___REGISTER_OBJECTS_TO_MATCH_FWD__MATCH_PRIMITIVETYPEINT_MODEL:
			registerObjectsToMatch_FWD((Match) arguments.get(0), (PrimitiveTypeInt) arguments.get(1),
					(Model) arguments.get(2));
			return null;
		case RulesPackage.PRIMITIVE_TYPE_IS_INT___IS_APPROPRIATE_SOLVE_CSP_FWD__MATCH_PRIMITIVETYPEINT_MODEL:
			return isAppropriate_solveCsp_FWD((Match) arguments.get(0), (PrimitiveTypeInt) arguments.get(1),
					(Model) arguments.get(2));
		...
		case RulesPackage.PRIMITIVE_TYPE_IS_INT___IS_APPROPRIATE_FWD_EMOFLON_EDGE_25__EMOFLONEDGE:
			return isAppropriate_FWD_EMoflonEdge_25((EMoflonEdge) arguments.get(0));
		case RulesPackage.PRIMITIVE_TYPE_IS_INT___IS_APPROPRIATE_BWD_EMOFLON_EDGE_23__EMOFLONEDGE:
		...
		case RulesPackage.PRIMITIVE_TYPE_IS_INT___IS_APPLICABLE_SOLVE_CSP_CC__CCMATCH_PRIMITIVETYPEINT_MODELTOTYPEGRAPH_TYPEGRAPH_TCLASS_MODEL_MATCH_MATCH:
			return isApplicable_solveCsp_CC((CCMatch) arguments.get(0), (PrimitiveTypeInt) arguments.get(1),
	...
	public static final Object[] pattern_PrimitiveTypeIsInt_0_1_initialbindings_blackBBBB(PrimitiveTypeIsInt _this,
			Match match, PrimitiveTypeInt ePrimitiveType, Model eModel) {
		return new Object[] { _this, match, ePrimitiveType, eModel };
	}

	public static final Object[] pattern_PrimitiveTypeIsInt_0_2_SolveCSP_bindingFBBBB(PrimitiveTypeIsInt _this,
			Match match, PrimitiveTypeInt ePrimitiveType, Model eModel) {
	...
	public static final Object[] pattern_PrimitiveTypeIsInt_0_2_SolveCSP_blackB(CSP csp) {
		return new Object[] { csp };
	}

	public static final Object[] pattern_PrimitiveTypeIsInt_0_2_SolveCSP_bindingAndBlackFBBBB(PrimitiveTypeIsInt _this,
			Match match, PrimitiveTypeInt ePrimitiveType, Model eModel) {
		Object[] result_pattern_PrimitiveTypeIsInt_0_2_SolveCSP_binding = pattern_PrimitiveTypeIsInt_0_2_SolveCSP_bindingFBBBB(
				_this, match, ePrimitiveType, eModel);
		if (result_pattern_PrimitiveTypeIsInt_0_2_SolveCSP_binding != null) {
			CSP csp = (CSP) result_pattern_PrimitiveTypeIsInt_0_2_SolveCSP_binding[0];

			Object[] result_pattern_PrimitiveTypeIsInt_0_2_SolveCSP_black = pattern_PrimitiveTypeIsInt_0_2_SolveCSP_blackB(
					csp);
			if (result_pattern_PrimitiveTypeIsInt_0_2_SolveCSP_black != null) {
	...
	public static final boolean pattern_PrimitiveTypeIsInt_0_3_CheckCSP_expressionFBB(PrimitiveTypeIsInt _this,
			CSP csp) {
	...
	public static final Object[] pattern_PrimitiveTypeIsInt_0_4_collectelementstobetranslated_blackBBB(Match match,
			PrimitiveTypeInt ePrimitiveType, Model eModel) {
		return new Object[] { match, ePrimitiveType, eModel };
	}

	public static final Object[] pattern_PrimitiveTypeIsInt_0_4_collectelementstobetranslated_greenBBBF(Match match,
			PrimitiveTypeInt ePrimitiveType, Model eModel) {
	...
	public static final Object[] pattern_PrimitiveTypeIsInt_0_5_collectcontextelements_blackBBB(Match match,
			PrimitiveTypeInt ePrimitiveType, Model eModel) {
		return new Object[] { match, ePrimitiveType, eModel };
	}

	public static final Object[] pattern_PrimitiveTypeIsInt_0_5_collectcontextelements_greenBB(Match match,
			Model eModel) {
		match.getContextNodes().add(eModel);
		return new Object[] { match, eModel };
	}

	public static final void pattern_PrimitiveTypeIsInt_0_6_registerobjectstomatch_expressionBBBB(
			PrimitiveTypeIsInt _this, Match match, PrimitiveTypeInt ePrimitiveType, Model eModel) {
		_this.registerObjectsToMatch_FWD(match, ePrimitiveType, eModel);

	}

	public static final boolean pattern_PrimitiveTypeIsInt_0_7_expressionF() {
		boolean _result = Boolean.valueOf(true);
		return _result;
	}

	public static final boolean pattern_PrimitiveTypeIsInt_0_8_expressionF() {
	...
	public static final Object[] pattern_PrimitiveTypeIsInt_1_1_performtransformation_greenBBFFF(
	...
	public static final Object[] pattern_PrimitiveTypeIsInt_1_2_collecttranslatedelements_blackBBBB(
			PrimitiveTypeInt ePrimitiveType, PrimitiveTypeToTClass ePrimitiveTypeToTPrimitiveClass,
	...
	public static final Object[] pattern_PrimitiveTypeIsInt_1_2_collecttranslatedelements_greenFBBBB(
			PrimitiveTypeInt ePrimitiveType, PrimitiveTypeToTClass ePrimitiveTypeToTPrimitiveClass,
			TypeToTAbstractType typeToTAbstractType, TClass tPrimitiveClass) {
	...
	public static final PerformRuleResult pattern_PrimitiveTypeIsInt_1_6_expressionFB(PerformRuleResult ruleresult) {
		PerformRuleResult _result = ruleresult;
		return _result;
	}

	public static final Object[] pattern_PrimitiveTypeIsInt_2_1_preparereturnvalue_bindingFB(PrimitiveTypeIsInt _this) {
	...
	public static final Object[] pattern_PrimitiveTypeIsInt_2_1_preparereturnvalue_blackFBB(EClass eClass,
			PrimitiveTypeIsInt _this) {
	...
	public static final Object[] pattern_PrimitiveTypeIsInt_2_1_preparereturnvalue_bindingAndBlackFFB(
			PrimitiveTypeIsInt _this) {
		Object[] result_pattern_PrimitiveTypeIsInt_2_1_preparereturnvalue_binding = pattern_PrimitiveTypeIsInt_2_1_preparereturnvalue_bindingFB(
				_this);
		if (result_pattern_PrimitiveTypeIsInt_2_1_preparereturnvalue_binding != null) {
			EClass eClass = (EClass) result_pattern_PrimitiveTypeIsInt_2_1_preparereturnvalue_binding[0];

			Object[] result_pattern_PrimitiveTypeIsInt_2_1_preparereturnvalue_black = pattern_PrimitiveTypeIsInt_2_1_preparereturnvalue_blackFBB(
					eClass, _this);
			if (result_pattern_PrimitiveTypeIsInt_2_1_preparereturnvalue_black != null) {
				EOperation performOperation = (EOperation) result_pattern_PrimitiveTypeIsInt_2_1_preparereturnvalue_black[0];
	...
	public static final Object[] pattern_PrimitiveTypeIsInt_2_1_preparereturnvalue_greenBF(
			EOperation performOperation) {
		IsApplicableRuleResult ruleresult = RuntimeFactory.eINSTANCE.createIsApplicableRuleResult();
		boolean ruleresult_success_prime = false;
		String ruleresult_rule_prime = "PrimitiveTypeIsInt";
	...
	public static final Object[] pattern_PrimitiveTypeIsInt_2_2_corematch_bindingFFB(Match match) {
	...
	public static final Iterable<Object[]> pattern_PrimitiveTypeIsInt_2_2_corematch_blackBFFBB(
			PrimitiveTypeInt ePrimitiveType, Model eModel, Match match) {
	...
	public static final Object[] pattern_PrimitiveTypeIsInt_2_4_solveCSP_blackB(CSP csp) {
		return new Object[] { csp };
	}
	...
	public static final Object[] pattern_PrimitiveTypeIsInt_2_4_solveCSP_bindingAndBlackFBBBBBB(
		...
		if (result_pattern_PrimitiveTypeIsInt_2_4_solveCSP_binding != null) {
			...
			Object[] result_pattern_PrimitiveTypeIsInt_2_4_solveCSP_black = pattern_PrimitiveTypeIsInt_2_4_solveCSP_blackB(
					csp);
	...
	public static final boolean pattern_PrimitiveTypeIsInt_2_5_checkCSP_expressionFBB(PrimitiveTypeIsInt _this,
			CSP csp) {
	...
	public static final Object[] pattern_PrimitiveTypeIsInt_2_6_addmatchtoruleresult_blackBB(
			IsApplicableRuleResult ruleresult, IsApplicableMatch isApplicableMatch) {
		return new Object[] { ruleresult, isApplicableMatch };
	}

	public static final Object[] pattern_PrimitiveTypeIsInt_2_6_addmatchtoruleresult_greenBB(
			IsApplicableRuleResult ruleresult, IsApplicableMatch isApplicableMatch) {
		ruleresult.getIsApplicableMatch().add(isApplicableMatch);
		boolean ruleresult_success_prime = Boolean.valueOf(true);
		String isApplicableMatch_ruleName_prime = "PrimitiveTypeIsInt";
		ruleresult.setSuccess(Boolean.valueOf(ruleresult_success_prime));
		isApplicableMatch.setRuleName(isApplicableMatch_ruleName_prime);
		return new Object[] { ruleresult, isApplicableMatch };
	}

	public static final IsApplicableRuleResult pattern_PrimitiveTypeIsInt_2_7_expressionFB(
	...
	public static final Object[] pattern_PrimitiveTypeIsInt_10_2_SolveCSP_blackB(CSP csp) {
		return new Object[] { csp };
	}
	...
	public static final Object[] pattern_PrimitiveTypeIsInt_10_2_SolveCSP_bindingAndBlackFBBBB(PrimitiveTypeIsInt _this,
		...
		if (result_pattern_PrimitiveTypeIsInt_10_2_SolveCSP_binding != null) {
			...
			Object[] result_pattern_PrimitiveTypeIsInt_10_2_SolveCSP_black = pattern_PrimitiveTypeIsInt_10_2_SolveCSP_blackB(
					csp);
	...
	public static final boolean pattern_PrimitiveTypeIsInt_10_3_CheckCSP_expressionFBB(PrimitiveTypeIsInt _this,
			CSP csp) {
	...
	public static final boolean pattern_PrimitiveTypeIsInt_10_7_expressionF() {
		boolean _result = Boolean.valueOf(true);
		return _result;
	}

	public static final boolean pattern_PrimitiveTypeIsInt_10_8_expressionF() {
		boolean _result = false;
		return _result;
	}
	...
	public static final Object[] pattern_PrimitiveTypeIsInt_11_1_performtransformation_greenFFFBB(
	...
	public static final Object[] pattern_PrimitiveTypeIsInt_11_2_collecttranslatedelements_blackBBBB(
			PrimitiveTypeInt ePrimitiveType, PrimitiveTypeToTClass ePrimitiveTypeToTPrimitiveClass,
			TypeToTAbstractType typeToTAbstractType, TClass tPrimitiveClass) {
		return new Object[] { ePrimitiveType, ePrimitiveTypeToTPrimitiveClass, typeToTAbstractType, tPrimitiveClass };
	}

	public static final Object[] pattern_PrimitiveTypeIsInt_11_2_collecttranslatedelements_greenFBBBB(
			PrimitiveTypeInt ePrimitiveType, PrimitiveTypeToTClass ePrimitiveTypeToTPrimitiveClass,
			TypeToTAbstractType typeToTAbstractType, TClass tPrimitiveClass) {
		PerformRuleResult ruleresult = RuntimeFactory.eINSTANCE.createPerformRuleResult();
	...
	public static final PerformRuleResult pattern_PrimitiveTypeIsInt_11_6_expressionFB(PerformRuleResult ruleresult) {
		PerformRuleResult _result = ruleresult;
		return _result;
	}

	public static final Object[] pattern_PrimitiveTypeIsInt_12_1_preparereturnvalue_bindingFB(
			PrimitiveTypeIsInt _this) {
		EClass _localVariable_0 = _this.eClass();
		EClass eClass = _localVariable_0;
		if (eClass != null) {
	...
	public static final Object[] pattern_PrimitiveTypeIsInt_12_1_preparereturnvalue_blackFBB(EClass eClass,
			PrimitiveTypeIsInt _this) {
		for (EOperation performOperation : eClass.getEOperations()) {
			String performOperation_name = performOperation.getName();
	...
	public static final Object[] pattern_PrimitiveTypeIsInt_12_1_preparereturnvalue_bindingAndBlackFFB(
			PrimitiveTypeIsInt _this) {
		Object[] result_pattern_PrimitiveTypeIsInt_12_1_preparereturnvalue_binding = pattern_PrimitiveTypeIsInt_12_1_preparereturnvalue_bindingFB(
				_this);
		if (result_pattern_PrimitiveTypeIsInt_12_1_preparereturnvalue_binding != null) {
			EClass eClass = (EClass) result_pattern_PrimitiveTypeIsInt_12_1_preparereturnvalue_binding[0];

			Object[] result_pattern_PrimitiveTypeIsInt_12_1_preparereturnvalue_black = pattern_PrimitiveTypeIsInt_12_1_preparereturnvalue_blackFBB(
					eClass, _this);
			if (result_pattern_PrimitiveTypeIsInt_12_1_preparereturnvalue_black != null) {
				EOperation performOperation = (EOperation) result_pattern_PrimitiveTypeIsInt_12_1_preparereturnvalue_black[0];
	...
	public static final Object[] pattern_PrimitiveTypeIsInt_12_1_preparereturnvalue_greenBF(
			EOperation performOperation) {
		IsApplicableRuleResult ruleresult = RuntimeFactory.eINSTANCE.createIsApplicableRuleResult();
		boolean ruleresult_success_prime = false;
		String ruleresult_rule_prime = "PrimitiveTypeIsInt";
	...
	public static final Object[] pattern_PrimitiveTypeIsInt_12_4_solveCSP_blackB(CSP csp) {
		return new Object[] { csp };
	}
	...
	public static final Object[] pattern_PrimitiveTypeIsInt_12_4_solveCSP_bindingAndBlackFBBBBBB(
		...
		if (result_pattern_PrimitiveTypeIsInt_12_4_solveCSP_binding != null) {
			...
			Object[] result_pattern_PrimitiveTypeIsInt_12_4_solveCSP_black = pattern_PrimitiveTypeIsInt_12_4_solveCSP_blackB(
					csp);
	...
	public static final boolean pattern_PrimitiveTypeIsInt_12_5_checkCSP_expressionFBB(PrimitiveTypeIsInt _this,
			CSP csp) {
	...
	public static final Object[] pattern_PrimitiveTypeIsInt_12_6_addmatchtoruleresult_blackBB(
			IsApplicableRuleResult ruleresult, IsApplicableMatch isApplicableMatch) {
		return new Object[] { ruleresult, isApplicableMatch };
	}

	public static final Object[] pattern_PrimitiveTypeIsInt_12_6_addmatchtoruleresult_greenBB(
			IsApplicableRuleResult ruleresult, IsApplicableMatch isApplicableMatch) {
		ruleresult.getIsApplicableMatch().add(isApplicableMatch);
		boolean ruleresult_success_prime = Boolean.valueOf(true);
		String isApplicableMatch_ruleName_prime = "PrimitiveTypeIsInt";
	...
	public static final IsApplicableRuleResult pattern_PrimitiveTypeIsInt_12_7_expressionFB(
			IsApplicableRuleResult ruleresult) {
		IsApplicableRuleResult _result = ruleresult;
		return _result;
	}

	public static final Object[] pattern_PrimitiveTypeIsInt_20_1_preparereturnvalue_bindingFB(
			PrimitiveTypeIsInt _this) {
		EClass _localVariable_0 = _this.eClass();
	...
	public static final Object[] pattern_PrimitiveTypeIsInt_20_1_preparereturnvalue_blackFBBF(EClass __eClass,
			PrimitiveTypeIsInt _this) {
	...
	public static final Object[] pattern_PrimitiveTypeIsInt_20_1_preparereturnvalue_bindingAndBlackFFBF(
			PrimitiveTypeIsInt _this) {
		Object[] result_pattern_PrimitiveTypeIsInt_20_1_preparereturnvalue_binding = pattern_PrimitiveTypeIsInt_20_1_preparereturnvalue_bindingFB(
				_this);
		if (result_pattern_PrimitiveTypeIsInt_20_1_preparereturnvalue_binding != null) {
			EClass __eClass = (EClass) result_pattern_PrimitiveTypeIsInt_20_1_preparereturnvalue_binding[0];

			Object[] result_pattern_PrimitiveTypeIsInt_20_1_preparereturnvalue_black = pattern_PrimitiveTypeIsInt_20_1_preparereturnvalue_blackFBBF(
					__eClass, _this);
			if (result_pattern_PrimitiveTypeIsInt_20_1_preparereturnvalue_black != null) {
				EOperation __performOperation = (EOperation) result_pattern_PrimitiveTypeIsInt_20_1_preparereturnvalue_black[0];
				EOperation isApplicableCC = (EOperation) result_pattern_PrimitiveTypeIsInt_20_1_preparereturnvalue_black[3];
	...
	public static final Object[] pattern_PrimitiveTypeIsInt_20_1_preparereturnvalue_greenF() {
	...
	public static final Object[] pattern_PrimitiveTypeIsInt_20_2_testcorematchandDECs_greenFB(EClass __eClass) {
	...
	public static final boolean pattern_PrimitiveTypeIsInt_20_4_Ensurethatthecorrecttypesofelementsarematched_expressionFBB(
			PrimitiveTypeIsInt _this, Match match) {
		boolean _localVariable_0 = _this.checkTypes_FWD(match);
		boolean _result = Boolean.valueOf(_localVariable_0);
		return _result;
	}

	public static final Object[] pattern_PrimitiveTypeIsInt_20_5_Addmatchtoruleresult_blackBBBB(Match match,
	...
	public static final Object[] pattern_PrimitiveTypeIsInt_20_5_Addmatchtoruleresult_greenBBBB(Match match,
			EOperation __performOperation, EObjectContainer __result, EOperation isApplicableCC) {
	...
	public static final EObjectContainer pattern_PrimitiveTypeIsInt_20_6_expressionFB(EObjectContainer __result) {
		EObjectContainer _result = __result;
		return _result;
	}

	public static final Object[] pattern_PrimitiveTypeIsInt_21_1_preparereturnvalue_bindingFB(
			PrimitiveTypeIsInt _this) {
		EClass _localVariable_0 = _this.eClass();
		EClass __eClass = _localVariable_0;
		if (__eClass != null) {
	...
	public static final Object[] pattern_PrimitiveTypeIsInt_21_1_preparereturnvalue_blackFBBF(EClass __eClass,
			PrimitiveTypeIsInt _this) {
		for (EOperation __performOperation : __eClass.getEOperations()) {
			String __performOperation_name = __performOperation.getName();
	...
	public static final Object[] pattern_PrimitiveTypeIsInt_21_1_preparereturnvalue_bindingAndBlackFFBF(
			PrimitiveTypeIsInt _this) {
		Object[] result_pattern_PrimitiveTypeIsInt_21_1_preparereturnvalue_binding = pattern_PrimitiveTypeIsInt_21_1_preparereturnvalue_bindingFB(
				_this);
		if (result_pattern_PrimitiveTypeIsInt_21_1_preparereturnvalue_binding != null) {
			EClass __eClass = (EClass) result_pattern_PrimitiveTypeIsInt_21_1_preparereturnvalue_binding[0];

			Object[] result_pattern_PrimitiveTypeIsInt_21_1_preparereturnvalue_black = pattern_PrimitiveTypeIsInt_21_1_preparereturnvalue_blackFBBF(
					__eClass, _this);
			if (result_pattern_PrimitiveTypeIsInt_21_1_preparereturnvalue_black != null) {
				EOperation __performOperation = (EOperation) result_pattern_PrimitiveTypeIsInt_21_1_preparereturnvalue_black[0];
				EOperation isApplicableCC = (EOperation) result_pattern_PrimitiveTypeIsInt_21_1_preparereturnvalue_black[3];
	...
	public static final Object[] pattern_PrimitiveTypeIsInt_21_1_preparereturnvalue_greenF() {
		EObjectContainer __result = RuntimeFactory.eINSTANCE.createEObjectContainer();
		return new Object[] { __result };
	}

	public static final Object[] pattern_PrimitiveTypeIsInt_21_2_testcorematchandDECs_black_nac_0B(
			TClass tPrimitiveClass) {
		for (TPackage __DEC_tPrimitiveClass_classes_987167 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_PrimitiveTypeIsInt_21_2_testcorematchandDECs_black_nac_1BB(
			TClass tPrimitiveClass, TypeGraph typeGraph) {
		for (TypeGraph __DEC_tPrimitiveClass_classes_124574 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tPrimitiveClass, TypeGraph.class, "classes")) {
			if (!typeGraph.equals(__DEC_tPrimitiveClass_classes_124574)) {
	...
	public static final Object[] pattern_PrimitiveTypeIsInt_21_2_testcorematchandDECs_black_nac_2B(
			TClass tPrimitiveClass) {
		TPackage __DEC_tPrimitiveClass_ownedTypes_530990 = tPrimitiveClass.getPackage();
		if (__DEC_tPrimitiveClass_ownedTypes_530990 != null) {
			return new Object[] { tPrimitiveClass };
		}
	...
	public static final Iterable<Object[]> pattern_PrimitiveTypeIsInt_21_2_testcorematchandDECs_blackFFB(
				...
				if (typeGraph.getClasses().contains(tPrimitiveClass)) {
					if (typeGraph.getOwnedTypes().contains(tPrimitiveClass)) {
						...
						if (tPrimitiveClass_tName.equals("int")) {
							boolean tPrimitiveClass_tLib = tPrimitiveClass.isTLib();
							if (Boolean.valueOf(tPrimitiveClass_tLib).equals(Boolean.valueOf(true))) {
								if (pattern_PrimitiveTypeIsInt_21_2_testcorematchandDECs_black_nac_0B(
										tPrimitiveClass) == null) {
									if (pattern_PrimitiveTypeIsInt_21_2_testcorematchandDECs_black_nac_1BB(
											tPrimitiveClass, typeGraph) == null) {
										if (pattern_PrimitiveTypeIsInt_21_2_testcorematchandDECs_black_nac_2B(
												tPrimitiveClass) == null) {
	...
	public static final Object[] pattern_PrimitiveTypeIsInt_21_2_testcorematchandDECs_greenFB(EClass __eClass) {
		Match match = RuntimeFactory.eINSTANCE.createMatch();
		String __eClass_name = __eClass.getName();
		String match_ruleName_prime = __eClass_name;
		match.setRuleName(match_ruleName_prime);
	...
	public static final boolean pattern_PrimitiveTypeIsInt_21_3_bookkeepingwithgenericisAppropriatemethod_expressionFBBBB(
			PrimitiveTypeIsInt _this, Match match, TypeGraph typeGraph, TClass tPrimitiveClass) {
	...
	public static final boolean pattern_PrimitiveTypeIsInt_21_4_Ensurethatthecorrecttypesofelementsarematched_expressionFBB(
			PrimitiveTypeIsInt _this, Match match) {
	...
	public static final Object[] pattern_PrimitiveTypeIsInt_21_5_Addmatchtoruleresult_blackBBBB(Match match,
			EOperation __performOperation, EObjectContainer __result, EOperation isApplicableCC) {
		if (!__performOperation.equals(isApplicableCC)) {
			return new Object[] { match, __performOperation, __result, isApplicableCC };
		}
	...
	public static final Object[] pattern_PrimitiveTypeIsInt_21_5_Addmatchtoruleresult_greenBBBB(Match match,
			EOperation __performOperation, EObjectContainer __result, EOperation isApplicableCC) {
		__result.getContents().add(match);
		match.setIsApplicableOperation(__performOperation);
		match.setIsApplicableCCOperation(isApplicableCC);
	...
	public static final EObjectContainer pattern_PrimitiveTypeIsInt_21_6_expressionFB(EObjectContainer __result) {
		EObjectContainer _result = __result;
		return _result;
	}

	public static final Object[] pattern_PrimitiveTypeIsInt_24_1_prepare_blackB(PrimitiveTypeIsInt _this) {
		return new Object[] { _this };
	}

	public static final Object[] pattern_PrimitiveTypeIsInt_24_1_prepare_greenF() {
		IsApplicableRuleResult result = RuntimeFactory.eINSTANCE.createIsApplicableRuleResult();
		return new Object[] { result };
	}

	public static final Object[] pattern_PrimitiveTypeIsInt_24_2_matchcontext_bindingFFFFBB(Match sourceMatch,
			Match targetMatch) {
	...
	public static final Iterable<Object[]> pattern_PrimitiveTypeIsInt_24_2_matchcontext_blackBFBBBBB(
	...
	public static final Object[] pattern_PrimitiveTypeIsInt_24_2_matchcontext_greenBBBBBBFB(
			PrimitiveTypeInt ePrimitiveType, ModelToTypeGraph eModelToTypeGraph, TypeGraph typeGraph,
	...
	public static final Object[] pattern_PrimitiveTypeIsInt_24_3_checkcsp_bindingFBBBBBBBBB(PrimitiveTypeIsInt _this,
			CCMatch isApplicableMatch, PrimitiveTypeInt ePrimitiveType, ModelToTypeGraph eModelToTypeGraph,
	...
	public static final Object[] pattern_PrimitiveTypeIsInt_24_3_checkcsp_blackB(CSP csp) {
		return new Object[] { csp };
	}

	public static final Object[] pattern_PrimitiveTypeIsInt_24_3_checkcsp_bindingAndBlackFBBBBBBBBB(
			PrimitiveTypeIsInt _this, CCMatch isApplicableMatch, PrimitiveTypeInt ePrimitiveType,
			ModelToTypeGraph eModelToTypeGraph, TypeGraph typeGraph, TClass tPrimitiveClass, Model eModel,
			Match sourceMatch, Match targetMatch) {
		Object[] result_pattern_PrimitiveTypeIsInt_24_3_checkcsp_binding = pattern_PrimitiveTypeIsInt_24_3_checkcsp_bindingFBBBBBBBBB(
				_this, isApplicableMatch, ePrimitiveType, eModelToTypeGraph, typeGraph, tPrimitiveClass, eModel,
				sourceMatch, targetMatch);
		if (result_pattern_PrimitiveTypeIsInt_24_3_checkcsp_binding != null) {
			CSP csp = (CSP) result_pattern_PrimitiveTypeIsInt_24_3_checkcsp_binding[0];

			Object[] result_pattern_PrimitiveTypeIsInt_24_3_checkcsp_black = pattern_PrimitiveTypeIsInt_24_3_checkcsp_blackB(
					csp);
			if (result_pattern_PrimitiveTypeIsInt_24_3_checkcsp_black != null) {
	...
	public static final Object[] pattern_PrimitiveTypeIsInt_24_4_createcorrespondence_blackBBBBB(
			PrimitiveTypeInt ePrimitiveType, TypeGraph typeGraph, TClass tPrimitiveClass, Model eModel,
			CCMatch isApplicableMatch) {
		return new Object[] { ePrimitiveType, typeGraph, tPrimitiveClass, eModel, isApplicableMatch };
	}

	public static final Object[] pattern_PrimitiveTypeIsInt_24_4_createcorrespondence_greenBFFBB(
			PrimitiveTypeInt ePrimitiveType, TClass tPrimitiveClass, CCMatch isApplicableMatch) {
		PrimitiveTypeToTClass ePrimitiveTypeToTPrimitiveClass = ModiscoFactory.eINSTANCE.createPrimitiveTypeToTClass();
		TypeToTAbstractType typeToTAbstractType = ModiscoFactory.eINSTANCE.createTypeToTAbstractType();
		ePrimitiveTypeToTPrimitiveClass.setSource(ePrimitiveType);
		ePrimitiveTypeToTPrimitiveClass.setTarget(tPrimitiveClass);
	...
	public static final Object[] pattern_PrimitiveTypeIsInt_24_5_addtoreturnedresult_blackBB(
			IsApplicableRuleResult result, CCMatch isApplicableMatch) {
		return new Object[] { result, isApplicableMatch };
	}

	public static final Object[] pattern_PrimitiveTypeIsInt_24_5_addtoreturnedresult_greenBB(
			IsApplicableRuleResult result, CCMatch isApplicableMatch) {
	...
	public static final IsApplicableRuleResult pattern_PrimitiveTypeIsInt_24_6_expressionFB(
			IsApplicableRuleResult result) {
		IsApplicableRuleResult _result = result;
		return _result;
	}

	public static final Object[] pattern_PrimitiveTypeIsInt_27_1_matchtggpattern_blackBB(
			PrimitiveTypeInt ePrimitiveType, Model eModel) {
		if (eModel.getOrphanTypes().contains(ePrimitiveType)) {
	...
	public static final boolean pattern_PrimitiveTypeIsInt_27_2_expressionF() {
		boolean _result = Boolean.valueOf(true);
		return _result;
	}

	public static final boolean pattern_PrimitiveTypeIsInt_27_3_expressionF() {
		boolean _result = false;
		return _result;
	}

	public static final Object[] pattern_PrimitiveTypeIsInt_28_1_matchtggpattern_black_nac_0B(TClass tPrimitiveClass) {
		for (TPackage __DEC_tPrimitiveClass_classes_125917 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tPrimitiveClass, TPackage.class, "classes")) {
			return new Object[] { tPrimitiveClass };
		}
		return null;
	...
	public static final Object[] pattern_PrimitiveTypeIsInt_28_1_matchtggpattern_black_nac_1BB(TClass tPrimitiveClass,
			TypeGraph typeGraph) {
		for (TypeGraph __DEC_tPrimitiveClass_classes_906956 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tPrimitiveClass, TypeGraph.class, "classes")) {
			if (!typeGraph.equals(__DEC_tPrimitiveClass_classes_906956)) {
				return new Object[] { tPrimitiveClass, typeGraph };
			}
		}
		return null;
	...
	public static final Object[] pattern_PrimitiveTypeIsInt_28_1_matchtggpattern_black_nac_2B(TClass tPrimitiveClass) {
		TPackage __DEC_tPrimitiveClass_ownedTypes_310845 = tPrimitiveClass.getPackage();
		if (__DEC_tPrimitiveClass_ownedTypes_310845 != null) {
			return new Object[] { tPrimitiveClass };
		}
	...
	public static final Object[] pattern_PrimitiveTypeIsInt_28_1_matchtggpattern_greenB(TClass tPrimitiveClass) {
		String tPrimitiveClass_tName_prime = "int";
		boolean tPrimitiveClass_tLib_prime = Boolean.valueOf(true);
		tPrimitiveClass.setTName(tPrimitiveClass_tName_prime);
		tPrimitiveClass.setTLib(Boolean.valueOf(tPrimitiveClass_tLib_prime));
	...
	public static final boolean pattern_PrimitiveTypeIsInt_28_2_expressionF() {
		boolean _result = Boolean.valueOf(true);
		return _result;
	}

	public static final boolean pattern_PrimitiveTypeIsInt_28_3_expressionF() {
		boolean _result = false;
		return _result;
	}

	public static final Object[] pattern_PrimitiveTypeIsInt_29_1_createresult_blackB(PrimitiveTypeIsInt _this) {
		return new Object[] { _this };
	}

	public static final Object[] pattern_PrimitiveTypeIsInt_29_1_createresult_greenFF() {
		IsApplicableMatch isApplicableMatch = RuntimeFactory.eINSTANCE.createIsApplicableMatch();
	...
	public static final Object[] pattern_PrimitiveTypeIsInt_29_2_isapplicablecore_black_nac_0BB(
	...
	public static final Object[] pattern_PrimitiveTypeIsInt_29_2_isapplicablecore_black_nac_1BB(
			...
			for (EObject tmpEModelToTypeGraph : eModelToTypeGraphList.getEntryObjects()) {
				if (tmpEModelToTypeGraph instanceof ModelToTypeGraph) {
					...
					if (eModel != null) {
						TypeGraph typeGraph = eModelToTypeGraph.getTarget();
						if (typeGraph != null) {
							if (pattern_PrimitiveTypeIsInt_29_2_isapplicablecore_black_nac_0BB(ruleResult,
	...
	public static final Object[] pattern_PrimitiveTypeIsInt_29_3_solveCSP_blackB(CSP csp) {
		return new Object[] { csp };
	}
	...
	public static final Object[] pattern_PrimitiveTypeIsInt_29_3_solveCSP_bindingAndBlackFBBBBBB(
		...
		if (result_pattern_PrimitiveTypeIsInt_29_3_solveCSP_binding != null) {
			...
			Object[] result_pattern_PrimitiveTypeIsInt_29_3_solveCSP_black = pattern_PrimitiveTypeIsInt_29_3_solveCSP_blackB(
					csp);
	...
	public static final boolean pattern_PrimitiveTypeIsInt_29_4_checkCSP_expressionFBB(PrimitiveTypeIsInt _this,
			CSP csp) {
	...
	public static final Object[] pattern_PrimitiveTypeIsInt_29_6_perform_greenFBFFFBB(TypeGraph typeGraph, Model eModel,
			ModelgeneratorRuleResult ruleResult) {
		PrimitiveTypeInt ePrimitiveType = JavaFactory.eINSTANCE.createPrimitiveTypeInt();
		PrimitiveTypeToTClass ePrimitiveTypeToTPrimitiveClass = ModiscoFactory.eINSTANCE.createPrimitiveTypeToTClass();
		TypeToTAbstractType typeToTAbstractType = ModiscoFactory.eINSTANCE.createTypeToTAbstractType();
