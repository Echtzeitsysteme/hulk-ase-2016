...
public class InterfaceImpl extends AbstractRuleImpl implements Interface {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result1_green = InterfaceImpl.pattern_Interface_1_1_performtransformation_greenFBFBFBB(tPackage, pg,
				mType, csp);
		...
		Object[] result2_black = InterfaceImpl.pattern_Interface_1_2_collecttranslatedelements_blackBBBB(tType,
				mTypeToTType, mBodyToTAnnotation, mType);
		if (result2_black == null) {
			throw new RuntimeException("Pattern matching in node [collect translated elements] failed." + " Variables: "
					+ "[tType] = " + tType + ", " + "[mTypeToTType] = " + mTypeToTType + ", "
					+ "[mBodyToTAnnotation] = " + mBodyToTAnnotation + ", " + "[mType] = " + mType + ".");
		}
		Object[] result2_green = InterfaceImpl.pattern_Interface_1_2_collecttranslatedelements_greenFBBBB(tType,
				mTypeToTType, mBodyToTAnnotation, mType);
		PerformRuleResult ruleresult = (PerformRuleResult) result2_green[0];

		// bookkeeping for edges
		Object[] result3_black = InterfaceImpl.pattern_Interface_1_3_bookkeepingforedges_blackBBBBBBBBB(ruleresult,
		...
		InterfaceImpl.pattern_Interface_1_3_bookkeepingforedges_greenBBBBBBBBFFFFFFFFFFFF(ruleresult, tType, tPackage,
		...
		// EMoflonEdge pg__tType____interfaces = (EMoflonEdge) result3_green[11];
		...
		// EMoflonEdge tPackage__tType____interfaces = (EMoflonEdge) result3_green[14];
		// EMoflonEdge mTypeToTType__mType____source = (EMoflonEdge) result3_green[15];
		// EMoflonEdge pg__tType____ownedTypes = (EMoflonEdge) result3_green[16];
		// EMoflonEdge tType__pg____pg = (EMoflonEdge) result3_green[17];
		...
		// register objects
		InterfaceImpl.pattern_Interface_1_5_registerobjects_expressionBBBBBBBBBB(this, ruleresult, mPackageToTPackage,
				tType, tPackage, mTypeToTType, mPackage, pg, mBodyToTAnnotation, mType);
	 ...
	 * @generated
	 */
	public boolean isAppropriate_BWD(Match match, TInterface tType, TPackage tPackage, TypeGraph pg) {
		// initial bindings
		Object[] result1_black = InterfaceImpl.pattern_Interface_10_1_initialbindings_blackBBBBB(this, match, tType,
				tPackage, pg);
		if (result1_black == null) {
			throw new RuntimeException("Pattern matching in node [initial bindings] failed." + " Variables: "
		...
		if (InterfaceImpl.pattern_Interface_10_3_CheckCSP_expressionFBB(this, csp)) {
			...
			InterfaceImpl.pattern_Interface_10_4_collectelementstobetranslated_greenBBBBFFFFFF(match, tType, tPackage,
					pg);
			...
			// EMoflonEdge pg__tType____interfaces = (EMoflonEdge) result4_green[6];
			// EMoflonEdge tPackage__tType____interfaces = (EMoflonEdge) result4_green[7];
			// EMoflonEdge pg__tType____ownedTypes = (EMoflonEdge) result4_green[8];
			// EMoflonEdge tType__pg____pg = (EMoflonEdge) result4_green[9];

			// collect context elements
			Object[] result5_black = InterfaceImpl.pattern_Interface_10_5_collectcontextelements_blackBBBB(match, tType,
					tPackage, pg);
			if (result5_black == null) {
			...
			// register objects to match
			InterfaceImpl.pattern_Interface_10_6_registerobjectstomatch_expressionBBBBB(this, match, tType, tPackage,
					pg);
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		PackageToTPackage mPackageToTPackage = (PackageToTPackage) result1_bindingAndBlack[0];
		TInterface tType = (TInterface) result1_bindingAndBlack[1];
		...
		CSP csp = (CSP) result1_bindingAndBlack[5];
		Object[] result1_green = InterfaceImpl.pattern_Interface_11_1_performtransformation_greenBFBFFB(tType, mPackage,
				csp);
		...
		// collect translated elements
		Object[] result2_black = InterfaceImpl.pattern_Interface_11_2_collecttranslatedelements_blackBBBB(tType,
				mTypeToTType, mBodyToTAnnotation, mType);
		if (result2_black == null) {
			throw new RuntimeException("Pattern matching in node [collect translated elements] failed." + " Variables: "
					+ "[tType] = " + tType + ", " + "[mTypeToTType] = " + mTypeToTType + ", "
		...
		Object[] result2_green = InterfaceImpl.pattern_Interface_11_2_collecttranslatedelements_greenFBBBB(tType,
				mTypeToTType, mBodyToTAnnotation, mType);
		PerformRuleResult ruleresult = (PerformRuleResult) result2_green[0];

		// bookkeeping for edges
		Object[] result3_black = InterfaceImpl.pattern_Interface_11_3_bookkeepingforedges_blackBBBBBBBBB(ruleresult,
				mPackageToTPackage, tType, tPackage, mTypeToTType, mPackage, pg, mBodyToTAnnotation, mType);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching in node [bookkeeping for edges] failed." + " Variables: "
					+ "[ruleresult] = " + ruleresult + ", " + "[mPackageToTPackage] = " + mPackageToTPackage + ", "
		...
		InterfaceImpl.pattern_Interface_11_3_bookkeepingforedges_greenBBBBBBBBFFFFFFFFFFFF(ruleresult, tType, tPackage,
				mTypeToTType, mPackage, pg, mBodyToTAnnotation, mType);
		// EMoflonEdge tPackage__tType____ownedTypes = (EMoflonEdge) result3_green[8];
		// EMoflonEdge tType__tPackage____package = (EMoflonEdge) result3_green[9];
		// EMoflonEdge mBodyToTAnnotation__tType____target = (EMoflonEdge) result3_green[10];
		...
		// perform postprocessing story node is empty
		// register objects
		InterfaceImpl.pattern_Interface_11_5_registerobjects_expressionBBBBBBBBBB(this, ruleresult, mPackageToTPackage,
				tType, tPackage, mTypeToTType, mPackage, pg, mBodyToTAnnotation, mType);
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : InterfaceImpl.pattern_Interface_12_2_corematch_blackFBBFBB(tType, tPackage, pg,
				match)) {
			PackageToTPackage mPackageToTPackage = (PackageToTPackage) result2_black[0];
			...
			for (Object[] result3_black : InterfaceImpl
					.pattern_Interface_12_3_findcontext_blackBBBBB(mPackageToTPackage, tType, tPackage, mPackage, pg)) {
				...
				// EMoflonEdge pg__tType____interfaces = (EMoflonEdge) result3_green[8];
				...
				// EMoflonEdge tPackage__tType____interfaces = (EMoflonEdge) result3_green[11];
	 ...
	 * @generated
	 */
	public void registerObjectsToMatch_BWD(Match match, TInterface tType, TPackage tPackage, TypeGraph pg) {
	 ...
	 * @generated
	 */
	public CSP isAppropriate_solveCsp_BWD(Match match, TInterface tType, TPackage tPackage, TypeGraph pg) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	...
	public CSP isApplicable_solveCsp_BWD(IsApplicableMatch isApplicableMatch, PackageToTPackage mPackageToTPackage,
			TInterface tType, TPackage tPackage, org.eclipse.gmt.modisco.java.Package mPackage, TypeGraph pg) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
		isApplicableMatch.getAttributeInfo().add(csp);
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_7(EMoflonEdge _edge_ownedElements) {
		// prepare return value
		Object[] result1_bindingAndBlack = InterfaceImpl
		...
		for (Object[] result2_black : InterfaceImpl
				.pattern_Interface_20_2_testcorematchandDECs_blackFFB(_edge_ownedElements)) {
			...
			if (InterfaceImpl.pattern_Interface_20_3_bookkeepingwithgenericisAppropriatemethod_expressionFBBBB(this,
					match, mPackage, mType)) {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_5(EMoflonEdge _edge_ownedTypes) {
		// prepare return value
		Object[] result1_bindingAndBlack = InterfaceImpl
		...
		// ForEach test core match and DECs
		for (Object[] result2_black : InterfaceImpl
				.pattern_Interface_21_2_testcorematchandDECs_blackFFFB(_edge_ownedTypes)) {
			...
			// bookkeeping with generic isAppropriate method
			if (InterfaceImpl.pattern_Interface_21_3_bookkeepingwithgenericisAppropriatemethod_expressionFBBBBB(this,
					match, tType, tPackage, pg)) {
				// Ensure that the correct types of elements are matched
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result2_binding = InterfaceImpl.pattern_Interface_24_2_matchcontext_bindingFFFFFBB(targetMatch,
				sourceMatch);
		if (result2_binding == null) {
		...
		InterfaceDeclaration mType = (InterfaceDeclaration) result2_binding[4];
		for (Object[] result2_black : InterfaceImpl.pattern_Interface_24_2_matchcontext_blackFBBBBBBB(tType, tPackage,
				mPackage, pg, mType, sourceMatch, targetMatch)) {
			PackageToTPackage mPackageToTPackage = (PackageToTPackage) result2_black[0];
			Object[] result2_green = InterfaceImpl.pattern_Interface_24_2_matchcontext_greenBBBBBBBFB(
					mPackageToTPackage, tType, tPackage, mPackage, pg, mType, sourceMatch, targetMatch);
			CCMatch isApplicableMatch = (CCMatch) result2_green[7];

			// check csp
			Object[] result3_bindingAndBlack = InterfaceImpl.pattern_Interface_24_3_checkcsp_bindingAndBlackFBBBBBBBBBB(
					this, isApplicableMatch, mPackageToTPackage, tType, tPackage, mPackage, pg, mType, sourceMatch,
					targetMatch);
			if (result3_bindingAndBlack != null) {
				// CSP csp = (CSP) result3_bindingAndBlack[0];

				// create correspondence
				Object[] result4_black = InterfaceImpl.pattern_Interface_24_4_createcorrespondence_blackBBBBBB(tType,
						tPackage, mPackage, pg, mType, isApplicableMatch);
				if (result4_black == null) {
				...
				InterfaceImpl.pattern_Interface_24_4_createcorrespondence_greenBFFBB(tType, mType, isApplicableMatch);
				...
				Object[] result5_black = InterfaceImpl.pattern_Interface_24_5_addtoreturnedresult_blackBB(result,
						isApplicableMatch);
				if (result5_black == null) {
					throw new RuntimeException(
				...
				InterfaceImpl.pattern_Interface_24_5_addtoreturnedresult_greenBB(result, isApplicableMatch);

			} else {
			}

		}
		return InterfaceImpl.pattern_Interface_24_6_expressionFB(result);
	}
	...
	public CSP isApplicable_solveCsp_CC(CCMatch isApplicableMatch, PackageToTPackage mPackageToTPackage,
			TInterface tType, TPackage tPackage, org.eclipse.gmt.modisco.java.Package mPackage, TypeGraph pg,
	 ...
	 * @generated
	 */
	public boolean checkDEC_FWD(org.eclipse.gmt.modisco.java.Package mPackage, InterfaceDeclaration mType) {// match tgg pattern
	 ...
	 * @generated
	 */
	public boolean checkDEC_BWD(TInterface tType, TPackage tPackage, TypeGraph pg) {// match tgg pattern
		Object[] result1_black = InterfaceImpl.pattern_Interface_28_1_matchtggpattern_blackBBB(tType, tPackage, pg);
		if (result1_black != null) {
		...
		for (Object[] result2_black : InterfaceImpl
			...
			if (InterfaceImpl.pattern_Interface_29_4_checkCSP_expressionFBB(this, csp)) {
				...
				if (result5_black != null) {
					...
					InterfaceImpl.pattern_Interface_29_6_perform_greenFBFBBFFBB(tPackage, mPackage, pg, ruleResult,
							csp);
					// TInterface tType = (TInterface) result6_green[0];
					...
					// InterfaceDeclaration mType = (InterfaceDeclaration) result6_green[6];
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.INTERFACE___REGISTER_OBJECTS_TO_MATCH_FWD__MATCH_PACKAGE_INTERFACEDECLARATION:
			registerObjectsToMatch_FWD((Match) arguments.get(0),
					(org.eclipse.gmt.modisco.java.Package) arguments.get(1), (InterfaceDeclaration) arguments.get(2));
			return null;
		...
		case RulesPackage.INTERFACE___REGISTER_OBJECTS_FWD__PERFORMRULERESULT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT:
		...
		case RulesPackage.INTERFACE___IS_APPROPRIATE_BWD__MATCH_TINTERFACE_TPACKAGE_TYPEGRAPH:
		...
		case RulesPackage.INTERFACE___REGISTER_OBJECTS_TO_MATCH_BWD__MATCH_TINTERFACE_TPACKAGE_TYPEGRAPH:
			registerObjectsToMatch_BWD((Match) arguments.get(0), (TInterface) arguments.get(1),
					(TPackage) arguments.get(2), (TypeGraph) arguments.get(3));
			return null;
		case RulesPackage.INTERFACE___IS_APPROPRIATE_SOLVE_CSP_BWD__MATCH_TINTERFACE_TPACKAGE_TYPEGRAPH:
		...
		case RulesPackage.INTERFACE___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_PACKAGETOTPACKAGE_TINTERFACE_TPACKAGE_PACKAGE_TYPEGRAPH:
			return isApplicable_solveCsp_BWD((IsApplicableMatch) arguments.get(0), (PackageToTPackage) arguments.get(1),
					(TInterface) arguments.get(2), (TPackage) arguments.get(3),
		...
		case RulesPackage.INTERFACE___REGISTER_OBJECTS_BWD__PERFORMRULERESULT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT:
		...
		case RulesPackage.INTERFACE___IS_APPROPRIATE_FWD_EMOFLON_EDGE_7__EMOFLONEDGE:
			return isAppropriate_FWD_EMoflonEdge_7((EMoflonEdge) arguments.get(0));
		case RulesPackage.INTERFACE___IS_APPROPRIATE_BWD_EMOFLON_EDGE_5__EMOFLONEDGE:
		...
		case RulesPackage.INTERFACE___IS_APPLICABLE_SOLVE_CSP_CC__CCMATCH_PACKAGETOTPACKAGE_TINTERFACE_TPACKAGE_PACKAGE_TYPEGRAPH_INTERFACEDECLARATION_MATCH_MATCH:
			return isApplicable_solveCsp_CC((CCMatch) arguments.get(0), (PackageToTPackage) arguments.get(1),
					(TInterface) arguments.get(2), (TPackage) arguments.get(3),
					(org.eclipse.gmt.modisco.java.Package) arguments.get(4), (TypeGraph) arguments.get(5),
					(InterfaceDeclaration) arguments.get(6), (Match) arguments.get(7), (Match) arguments.get(8));
		...
		case RulesPackage.INTERFACE___CHECK_DEC_BWD__TINTERFACE_TPACKAGE_TYPEGRAPH:
			return checkDEC_BWD((TInterface) arguments.get(0), (TPackage) arguments.get(1),
	...
	public static final Object[] pattern_Interface_0_1_initialbindings_blackBBBB(Interface _this, Match match,
			org.eclipse.gmt.modisco.java.Package mPackage, InterfaceDeclaration mType) {
	...
	public static final Object[] pattern_Interface_1_1_performtransformation_bindingAndBlackFFFFFFBB(Interface _this,
		...
		if (result_pattern_Interface_1_1_performtransformation_binding != null) {
			...
			org.eclipse.gmt.modisco.java.Package mPackage = (org.eclipse.gmt.modisco.java.Package) result_pattern_Interface_1_1_performtransformation_binding[2];
	...
	public static final Object[] pattern_Interface_1_1_performtransformation_greenFBFBFBB(TPackage tPackage,
	...
	public static final Object[] pattern_Interface_1_2_collecttranslatedelements_blackBBBB(TInterface tType,
	...
	public static final Object[] pattern_Interface_1_2_collecttranslatedelements_greenFBBBB(TInterface tType,
			TypeToTAbstractType mTypeToTType, BodyDeclarationToTAnnotatable mBodyToTAnnotation,
			InterfaceDeclaration mType) {
	...
	public static final Object[] pattern_Interface_1_3_bookkeepingforedges_blackBBBBBBBBB(PerformRuleResult ruleresult,
	...
	public static final Object[] pattern_Interface_1_3_bookkeepingforedges_greenBBBBBBBBFFFFFFFFFFFF(
		...
		return new Object[] { ruleresult, tType, tPackage, mTypeToTType, mPackage, pg, mBodyToTAnnotation, mType,
				...
				pg__tType____interfaces, mBodyToTAnnotation__mType____source, mTypeToTType__tType____target,
				tPackage__tType____interfaces, mTypeToTType__mType____source, pg__tType____ownedTypes, tType__pg____pg,
				mPackage__mType____ownedElements, mType__mPackage____package };
	}

	public static final void pattern_Interface_1_5_registerobjects_expressionBBBBBBBBBB(Interface _this,
			PerformRuleResult ruleresult, EObject mPackageToTPackage, EObject tType, EObject tPackage,
			EObject mTypeToTType, EObject mPackage, EObject pg, EObject mBodyToTAnnotation, EObject mType) {
	...
	public static final Iterable<Object[]> pattern_Interface_2_2_corematch_blackFFBBB(
			org.eclipse.gmt.modisco.java.Package mPackage, InterfaceDeclaration mType, Match match) {
	...
	public static final Object[] pattern_Interface_2_4_solveCSP_bindingFBBBBBBB(Interface _this,
			...
			org.eclipse.gmt.modisco.java.Package mPackage, TypeGraph pg, InterfaceDeclaration mType) {
	...
	public static final Object[] pattern_Interface_10_1_initialbindings_blackBBBBB(Interface _this, Match match,
			TInterface tType, TPackage tPackage, TypeGraph pg) {
	...
	public static final Object[] pattern_Interface_10_5_collectcontextelements_blackBBBB(Match match, TInterface tType,
	...
	public static final Object[] pattern_Interface_11_1_performtransformation_blackBBBBBFBB(
			PackageToTPackage mPackageToTPackage, TInterface tType, TPackage tPackage,
			org.eclipse.gmt.modisco.java.Package mPackage, TypeGraph pg, Interface _this,
			IsApplicableMatch isApplicableMatch) {
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
	...
	public static final Object[] pattern_Interface_11_1_performtransformation_bindingAndBlackFFFFFFBB(Interface _this,
		...
		if (result_pattern_Interface_11_1_performtransformation_binding != null) {
			...
			TInterface tType = (TInterface) result_pattern_Interface_11_1_performtransformation_binding[1];
			TPackage tPackage = (TPackage) result_pattern_Interface_11_1_performtransformation_binding[2];
			org.eclipse.gmt.modisco.java.Package mPackage = (org.eclipse.gmt.modisco.java.Package) result_pattern_Interface_11_1_performtransformation_binding[3];
	...
	public static final Object[] pattern_Interface_11_1_performtransformation_greenBFBFFB(TInterface tType,
	...
	public static final Object[] pattern_Interface_11_2_collecttranslatedelements_blackBBBB(TInterface tType,
			TypeToTAbstractType mTypeToTType, BodyDeclarationToTAnnotatable mBodyToTAnnotation,
			InterfaceDeclaration mType) {
		return new Object[] { tType, mTypeToTType, mBodyToTAnnotation, mType };
	}

	public static final Object[] pattern_Interface_11_2_collecttranslatedelements_greenFBBBB(TInterface tType,
			TypeToTAbstractType mTypeToTType, BodyDeclarationToTAnnotatable mBodyToTAnnotation,
			InterfaceDeclaration mType) {
		PerformRuleResult ruleresult = RuntimeFactory.eINSTANCE.createPerformRuleResult();
	...
	public static final Object[] pattern_Interface_11_3_bookkeepingforedges_blackBBBBBBBBB(PerformRuleResult ruleresult,
			EObject mPackageToTPackage, EObject tType, EObject tPackage, EObject mTypeToTType, EObject mPackage,
			EObject pg, EObject mBodyToTAnnotation, EObject mType) {
		if (!mPackageToTPackage.equals(tType)) {
			if (!mPackageToTPackage.equals(tPackage)) {
	...
	public static final Object[] pattern_Interface_11_3_bookkeepingforedges_greenBBBBBBBBFFFFFFFFFFFF(
			PerformRuleResult ruleresult, EObject tType, EObject tPackage, EObject mTypeToTType, EObject mPackage,
			EObject pg, EObject mBodyToTAnnotation, EObject mType) {
		EMoflonEdge tPackage__tType____ownedTypes = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		EMoflonEdge tType__tPackage____package = RuntimeFactory.eINSTANCE.createEMoflonEdge();
	...
	public static final void pattern_Interface_11_5_registerobjects_expressionBBBBBBBBBB(Interface _this,
			PerformRuleResult ruleresult, EObject mPackageToTPackage, EObject tType, EObject tPackage,
			EObject mTypeToTType, EObject mPackage, EObject pg, EObject mBodyToTAnnotation, EObject mType) {
	...
	public static final Iterable<Object[]> pattern_Interface_12_2_corematch_blackFBBFBB(TInterface tType,
	...
	public static final Object[] pattern_Interface_12_3_findcontext_greenBBBBBFFFFFFFFFF(
		...
		return new Object[] { mPackageToTPackage, tType, tPackage, mPackage, pg, isApplicableMatch,
				tPackage__tType____ownedTypes, tType__tPackage____package, pg__tType____interfaces,
				tPackage__pg____typeGraph, mPackageToTPackage__mPackage____source, tPackage__tType____interfaces,
	...
	public static final Object[] pattern_Interface_12_4_solveCSP_bindingFBBBBBBB(Interface _this,
			IsApplicableMatch isApplicableMatch, PackageToTPackage mPackageToTPackage, TInterface tType,
			TPackage tPackage, org.eclipse.gmt.modisco.java.Package mPackage, TypeGraph pg) {
	...
	public static final Iterable<Object[]> pattern_Interface_20_2_testcorematchandDECs_blackFFB(
	...
	public static final boolean pattern_Interface_20_3_bookkeepingwithgenericisAppropriatemethod_expressionFBBBB(
			Interface _this, Match match, org.eclipse.gmt.modisco.java.Package mPackage, InterfaceDeclaration mType) {
	...
	public static final Object[] pattern_Interface_21_2_testcorematchandDECs_black_nac_0BB(TInterface tType,
			TPackage tPackage) {
		for (TPackage __DEC_tType_interfaces_644108 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tType, TPackage.class, "interfaces")) {
			if (!tPackage.equals(__DEC_tType_interfaces_644108)) {
	...
	public static final Object[] pattern_Interface_21_2_testcorematchandDECs_black_nac_1BB(TInterface tType,
			TypeGraph pg) {
		for (TypeGraph __DEC_tType_interfaces_100444 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tType, TypeGraph.class, "interfaces")) {
			if (!pg.equals(__DEC_tType_interfaces_100444)) {
	...
	public static final Object[] pattern_Interface_21_2_testcorematchandDECs_black_nac_2BB(TInterface tType,
			TPackage tPackage) {
		TPackage __DEC_tType_ownedTypes_634437 = tType.getPackage();
		if (__DEC_tType_ownedTypes_634437 != null) {
			if (!tPackage.equals(__DEC_tType_ownedTypes_634437)) {
				return new Object[] { tType, tPackage };
			}
		}
	...
	public static final Iterable<Object[]> pattern_Interface_21_2_testcorematchandDECs_blackFFFB(
				...
				if (tPackage.getOwnedTypes().contains(tType)) {
					if (tPackage.getInterfaces().contains(tType)) {
						...
						if (pg != null) {
							if (pg.getInterfaces().contains(tType)) {
								if (pg.getOwnedTypes().contains(tType)) {
									if (pattern_Interface_21_2_testcorematchandDECs_black_nac_0BB(tType,
											tPackage) == null) {
										if (pattern_Interface_21_2_testcorematchandDECs_black_nac_2BB(tType,
												tPackage) == null) {
											if (pattern_Interface_21_2_testcorematchandDECs_black_nac_1BB(tType,
													pg) == null) {
	...
	public static final boolean pattern_Interface_21_3_bookkeepingwithgenericisAppropriatemethod_expressionFBBBBB(
			Interface _this, Match match, TInterface tType, TPackage tPackage, TypeGraph pg) {
	...
	public static final Object[] pattern_Interface_24_2_matchcontext_bindingFFFFFBB(Match targetMatch,
			Match sourceMatch) {
	...
	public static final Iterable<Object[]> pattern_Interface_24_2_matchcontext_blackFBBBBBBB(TInterface tType,
			TPackage tPackage, org.eclipse.gmt.modisco.java.Package mPackage, TypeGraph pg, InterfaceDeclaration mType,
	...
	public static final Object[] pattern_Interface_24_2_matchcontext_greenBBBBBBBFB(
			PackageToTPackage mPackageToTPackage, TInterface tType, TPackage tPackage,
			org.eclipse.gmt.modisco.java.Package mPackage, TypeGraph pg, InterfaceDeclaration mType, Match sourceMatch,
			Match targetMatch) {
	...
	public static final Object[] pattern_Interface_24_3_checkcsp_bindingFBBBBBBBBBB(Interface _this,
			CCMatch isApplicableMatch, PackageToTPackage mPackageToTPackage, TInterface tType, TPackage tPackage,
			org.eclipse.gmt.modisco.java.Package mPackage, TypeGraph pg, InterfaceDeclaration mType, Match sourceMatch,
			Match targetMatch) {
	...
	public static final Object[] pattern_Interface_24_3_checkcsp_blackB(CSP csp) {
		return new Object[] { csp };
	}

	public static final Object[] pattern_Interface_24_3_checkcsp_bindingAndBlackFBBBBBBBBBB(Interface _this,
			CCMatch isApplicableMatch, PackageToTPackage mPackageToTPackage, TInterface tType, TPackage tPackage,
			org.eclipse.gmt.modisco.java.Package mPackage, TypeGraph pg, InterfaceDeclaration mType, Match sourceMatch,
			Match targetMatch) {
		Object[] result_pattern_Interface_24_3_checkcsp_binding = pattern_Interface_24_3_checkcsp_bindingFBBBBBBBBBB(
				_this, isApplicableMatch, mPackageToTPackage, tType, tPackage, mPackage, pg, mType, sourceMatch,
				targetMatch);
		if (result_pattern_Interface_24_3_checkcsp_binding != null) {
			CSP csp = (CSP) result_pattern_Interface_24_3_checkcsp_binding[0];

			Object[] result_pattern_Interface_24_3_checkcsp_black = pattern_Interface_24_3_checkcsp_blackB(csp);
			if (result_pattern_Interface_24_3_checkcsp_black != null) {
	...
	public static final Object[] pattern_Interface_24_4_createcorrespondence_blackBBBBBB(TInterface tType,
			TPackage tPackage, org.eclipse.gmt.modisco.java.Package mPackage, TypeGraph pg, InterfaceDeclaration mType,
			CCMatch isApplicableMatch) {
		return new Object[] { tType, tPackage, mPackage, pg, mType, isApplicableMatch };
	}

	public static final Object[] pattern_Interface_24_4_createcorrespondence_greenBFFBB(TInterface tType,
			InterfaceDeclaration mType, CCMatch isApplicableMatch) {
		TypeToTAbstractType mTypeToTType = ModiscoFactory.eINSTANCE.createTypeToTAbstractType();
		BodyDeclarationToTAnnotatable mBodyToTAnnotation = ModiscoFactory.eINSTANCE
				.createBodyDeclarationToTAnnotatable();
		mTypeToTType.setTarget(tType);
	...
	public static final Object[] pattern_Interface_24_5_addtoreturnedresult_blackBB(IsApplicableRuleResult result,
			CCMatch isApplicableMatch) {
		return new Object[] { result, isApplicableMatch };
	}

	public static final Object[] pattern_Interface_24_5_addtoreturnedresult_greenBB(IsApplicableRuleResult result,
			CCMatch isApplicableMatch) {
	...
	public static final IsApplicableRuleResult pattern_Interface_24_6_expressionFB(IsApplicableRuleResult result) {
	...
	public static final Object[] pattern_Interface_28_1_matchtggpattern_black_nac_0BB(TInterface tType,
			TPackage tPackage) {
		for (TPackage __DEC_tType_interfaces_429271 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tType, TPackage.class, "interfaces")) {
			if (!tPackage.equals(__DEC_tType_interfaces_429271)) {
				return new Object[] { tType, tPackage };
			}
		}
		return null;
	...
	public static final Object[] pattern_Interface_28_1_matchtggpattern_black_nac_1BB(TInterface tType, TypeGraph pg) {
		for (TypeGraph __DEC_tType_interfaces_632582 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tType, TypeGraph.class, "interfaces")) {
			if (!pg.equals(__DEC_tType_interfaces_632582)) {
				return new Object[] { tType, pg };
			}
		}
		return null;
	...
	public static final Object[] pattern_Interface_28_1_matchtggpattern_black_nac_2BB(TInterface tType,
			TPackage tPackage) {
		TPackage __DEC_tType_ownedTypes_900858 = tType.getPackage();
		if (__DEC_tType_ownedTypes_900858 != null) {
			if (!tPackage.equals(__DEC_tType_ownedTypes_900858)) {
				return new Object[] { tType, tPackage };
			}
		}
	...
	public static final Object[] pattern_Interface_28_1_matchtggpattern_blackBBB(TInterface tType, TPackage tPackage,
			TypeGraph pg) {
		if (tPackage.getOwnedTypes().contains(tType)) {
			if (pg.getInterfaces().contains(tType)) {
				if (pg.equals(tPackage.getTypeGraph())) {
	...
	public static final Object[] pattern_Interface_29_6_perform_greenFBFBBFFBB(TPackage tPackage,
