...
public class PrimitiveTypeIsByteImpl extends AbstractRuleImpl implements PrimitiveTypeIsByte {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result1_green = PrimitiveTypeIsByteImpl
				.pattern_PrimitiveTypeIsByte_1_1_performtransformation_greenBBFFF(ePrimitiveType, typeGraph);
		...
		Object[] result2_black = PrimitiveTypeIsByteImpl
				.pattern_PrimitiveTypeIsByte_1_2_collecttranslatedelements_blackBBBB(ePrimitiveType,
		...
		Object[] result2_green = PrimitiveTypeIsByteImpl
				.pattern_PrimitiveTypeIsByte_1_2_collecttranslatedelements_greenFBBBB(ePrimitiveType,
						ePrimitiveTypeToTPrimitiveClass, typeToTAbstractType, tPrimitiveClass);
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		// CSP csp = (CSP) result1_bindingAndBlack[4];
		Object[] result1_green = PrimitiveTypeIsByteImpl
				.pattern_PrimitiveTypeIsByte_11_1_performtransformation_greenFFFBB(tPrimitiveClass, eModel);
		...
		// collect translated elements
		Object[] result2_black = PrimitiveTypeIsByteImpl
				.pattern_PrimitiveTypeIsByte_11_2_collecttranslatedelements_blackBBBB(ePrimitiveType,
						ePrimitiveTypeToTPrimitiveClass, typeToTAbstractType, tPrimitiveClass);
		if (result2_black == null) {
			throw new RuntimeException("Pattern matching in node [collect translated elements] failed." + " Variables: "
					+ "[ePrimitiveType] = " + ePrimitiveType + ", " + "[ePrimitiveTypeToTPrimitiveClass] = "
		...
		Object[] result2_green = PrimitiveTypeIsByteImpl
				.pattern_PrimitiveTypeIsByte_11_2_collecttranslatedelements_greenFBBBB(ePrimitiveType,
						ePrimitiveTypeToTPrimitiveClass, typeToTAbstractType, tPrimitiveClass);
		PerformRuleResult ruleresult = (PerformRuleResult) result2_green[0];
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_32(EMoflonEdge _edge_orphanTypes) {
		// prepare return value
		Object[] result1_bindingAndBlack = PrimitiveTypeIsByteImpl
		...
		for (Object[] result2_black : PrimitiveTypeIsByteImpl
				.pattern_PrimitiveTypeIsByte_20_2_testcorematchandDECs_blackFFB(_edge_orphanTypes)) {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_29(EMoflonEdge _edge_classes) {
		// prepare return value
		Object[] result1_bindingAndBlack = PrimitiveTypeIsByteImpl
		...
		// ForEach test core match and DECs
		for (Object[] result2_black : PrimitiveTypeIsByteImpl
				.pattern_PrimitiveTypeIsByte_21_2_testcorematchandDECs_blackFFB(_edge_classes)) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result2_binding = PrimitiveTypeIsByteImpl
				.pattern_PrimitiveTypeIsByte_24_2_matchcontext_bindingFFFFBB(sourceMatch, targetMatch);
		if (result2_binding == null) {
		...
		for (Object[] result2_black : PrimitiveTypeIsByteImpl
				.pattern_PrimitiveTypeIsByte_24_2_matchcontext_blackBFBBBBB(ePrimitiveType, typeGraph, tPrimitiveClass,
						eModel, sourceMatch, targetMatch)) {
			ModelToTypeGraph eModelToTypeGraph = (ModelToTypeGraph) result2_black[1];
			Object[] result2_green = PrimitiveTypeIsByteImpl
					.pattern_PrimitiveTypeIsByte_24_2_matchcontext_greenBBBBBBFB(ePrimitiveType, eModelToTypeGraph,
			...
			Object[] result3_bindingAndBlack = PrimitiveTypeIsByteImpl
					.pattern_PrimitiveTypeIsByte_24_3_checkcsp_bindingAndBlackFBBBBBBBBB(this, isApplicableMatch,
			...
			if (result3_bindingAndBlack != null) {
				...
				Object[] result4_black = PrimitiveTypeIsByteImpl
						.pattern_PrimitiveTypeIsByte_24_4_createcorrespondence_blackBBBBB(ePrimitiveType, typeGraph,
				...
				PrimitiveTypeIsByteImpl.pattern_PrimitiveTypeIsByte_24_4_createcorrespondence_greenBFFBB(ePrimitiveType,
				...
				Object[] result5_black = PrimitiveTypeIsByteImpl
						.pattern_PrimitiveTypeIsByte_24_5_addtoreturnedresult_blackBB(result, isApplicableMatch);
				if (result5_black == null) {
					throw new RuntimeException(
							"Pattern matching in node [add to returned result] failed." + " Variables: " + "[result] = "
									+ result + ", " + "[isApplicableMatch] = " + isApplicableMatch + ".");
				}
				PrimitiveTypeIsByteImpl.pattern_PrimitiveTypeIsByte_24_5_addtoreturnedresult_greenBB(result,
						isApplicableMatch);
		...
		return PrimitiveTypeIsByteImpl.pattern_PrimitiveTypeIsByte_24_6_expressionFB(result);
	}
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(CCMatch isApplicableMatch, PrimitiveTypeByte ePrimitiveType,
	 ...
	 * @generated
	 */
	public boolean checkDEC_FWD(PrimitiveTypeByte ePrimitiveType, Model eModel) {// match tgg pattern
		Object[] result1_black = PrimitiveTypeIsByteImpl
		...
		for (Object[] result2_black : PrimitiveTypeIsByteImpl
			...
			if (PrimitiveTypeIsByteImpl.pattern_PrimitiveTypeIsByte_29_4_checkCSP_expressionFBB(this, csp)) {
				...
				if (result5_black != null) {
					...
					PrimitiveTypeIsByteImpl.pattern_PrimitiveTypeIsByte_29_6_perform_greenFBFFFBB(typeGraph, eModel,
							ruleResult);
					// PrimitiveTypeByte ePrimitiveType = (PrimitiveTypeByte) result6_green[0];
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.PRIMITIVE_TYPE_IS_BYTE___IS_APPROPRIATE_FWD_EMOFLON_EDGE_32__EMOFLONEDGE:
			return isAppropriate_FWD_EMoflonEdge_32((EMoflonEdge) arguments.get(0));
		case RulesPackage.PRIMITIVE_TYPE_IS_BYTE___IS_APPROPRIATE_BWD_EMOFLON_EDGE_29__EMOFLONEDGE:
		...
		case RulesPackage.PRIMITIVE_TYPE_IS_BYTE___IS_APPLICABLE_SOLVE_CSP_CC__CCMATCH_PRIMITIVETYPEBYTE_MODELTOTYPEGRAPH_TYPEGRAPH_TCLASS_MODEL_MATCH_MATCH:
			return isApplicable_solveCsp_CC((CCMatch) arguments.get(0), (PrimitiveTypeByte) arguments.get(1),
	...
	public static final Object[] pattern_PrimitiveTypeIsByte_1_1_performtransformation_greenBBFFF(
	...
	public static final Object[] pattern_PrimitiveTypeIsByte_1_2_collecttranslatedelements_blackBBBB(
			PrimitiveTypeByte ePrimitiveType, PrimitiveTypeToTClass ePrimitiveTypeToTPrimitiveClass,
	...
	public static final Object[] pattern_PrimitiveTypeIsByte_1_2_collecttranslatedelements_greenFBBBB(
			PrimitiveTypeByte ePrimitiveType, PrimitiveTypeToTClass ePrimitiveTypeToTPrimitiveClass,
			TypeToTAbstractType typeToTAbstractType, TClass tPrimitiveClass) {
	...
	public static final Object[] pattern_PrimitiveTypeIsByte_11_1_performtransformation_greenFFFBB(
	...
	public static final Object[] pattern_PrimitiveTypeIsByte_11_2_collecttranslatedelements_blackBBBB(
			PrimitiveTypeByte ePrimitiveType, PrimitiveTypeToTClass ePrimitiveTypeToTPrimitiveClass,
			TypeToTAbstractType typeToTAbstractType, TClass tPrimitiveClass) {
		return new Object[] { ePrimitiveType, ePrimitiveTypeToTPrimitiveClass, typeToTAbstractType, tPrimitiveClass };
	}

	public static final Object[] pattern_PrimitiveTypeIsByte_11_2_collecttranslatedelements_greenFBBBB(
			PrimitiveTypeByte ePrimitiveType, PrimitiveTypeToTClass ePrimitiveTypeToTPrimitiveClass,
			TypeToTAbstractType typeToTAbstractType, TClass tPrimitiveClass) {
		PerformRuleResult ruleresult = RuntimeFactory.eINSTANCE.createPerformRuleResult();
	...
	public static final Object[] pattern_PrimitiveTypeIsByte_21_2_testcorematchandDECs_black_nac_0B(
			TClass tPrimitiveClass) {
		for (TPackage __DEC_tPrimitiveClass_classes_424750 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_PrimitiveTypeIsByte_21_2_testcorematchandDECs_black_nac_1BB(
			TClass tPrimitiveClass, TypeGraph typeGraph) {
		for (TypeGraph __DEC_tPrimitiveClass_classes_593830 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tPrimitiveClass, TypeGraph.class, "classes")) {
			if (!typeGraph.equals(__DEC_tPrimitiveClass_classes_593830)) {
	...
	public static final Object[] pattern_PrimitiveTypeIsByte_21_2_testcorematchandDECs_black_nac_2B(
			TClass tPrimitiveClass) {
		TPackage __DEC_tPrimitiveClass_ownedTypes_851605 = tPrimitiveClass.getPackage();
		if (__DEC_tPrimitiveClass_ownedTypes_851605 != null) {
			return new Object[] { tPrimitiveClass };
		}
				...
				if (typeGraph.getClasses().contains(tPrimitiveClass)) {
					if (typeGraph.getOwnedTypes().contains(tPrimitiveClass)) {
						...
						if (tPrimitiveClass_tName.equals("byte")) {
							boolean tPrimitiveClass_tLib = tPrimitiveClass.isTLib();
							if (Boolean.valueOf(tPrimitiveClass_tLib).equals(Boolean.valueOf(true))) {
								if (pattern_PrimitiveTypeIsByte_21_2_testcorematchandDECs_black_nac_0B(
										tPrimitiveClass) == null) {
									if (pattern_PrimitiveTypeIsByte_21_2_testcorematchandDECs_black_nac_1BB(
											tPrimitiveClass, typeGraph) == null) {
										if (pattern_PrimitiveTypeIsByte_21_2_testcorematchandDECs_black_nac_2B(
												tPrimitiveClass) == null) {
	...
	public static final Object[] pattern_PrimitiveTypeIsByte_24_2_matchcontext_bindingFFFFBB(Match sourceMatch,
			Match targetMatch) {
	...
	public static final Iterable<Object[]> pattern_PrimitiveTypeIsByte_24_2_matchcontext_blackBFBBBBB(
	...
	public static final Object[] pattern_PrimitiveTypeIsByte_24_2_matchcontext_greenBBBBBBFB(
			PrimitiveTypeByte ePrimitiveType, ModelToTypeGraph eModelToTypeGraph, TypeGraph typeGraph,
	...
	public static final Object[] pattern_PrimitiveTypeIsByte_24_3_checkcsp_bindingFBBBBBBBBB(PrimitiveTypeIsByte _this,
			CCMatch isApplicableMatch, PrimitiveTypeByte ePrimitiveType, ModelToTypeGraph eModelToTypeGraph,
	...
	public static final Object[] pattern_PrimitiveTypeIsByte_24_3_checkcsp_blackB(CSP csp) {
		return new Object[] { csp };
	}

	public static final Object[] pattern_PrimitiveTypeIsByte_24_3_checkcsp_bindingAndBlackFBBBBBBBBB(
			PrimitiveTypeIsByte _this, CCMatch isApplicableMatch, PrimitiveTypeByte ePrimitiveType,
			ModelToTypeGraph eModelToTypeGraph, TypeGraph typeGraph, TClass tPrimitiveClass, Model eModel,
			Match sourceMatch, Match targetMatch) {
		Object[] result_pattern_PrimitiveTypeIsByte_24_3_checkcsp_binding = pattern_PrimitiveTypeIsByte_24_3_checkcsp_bindingFBBBBBBBBB(
				_this, isApplicableMatch, ePrimitiveType, eModelToTypeGraph, typeGraph, tPrimitiveClass, eModel,
				sourceMatch, targetMatch);
		if (result_pattern_PrimitiveTypeIsByte_24_3_checkcsp_binding != null) {
			CSP csp = (CSP) result_pattern_PrimitiveTypeIsByte_24_3_checkcsp_binding[0];

			Object[] result_pattern_PrimitiveTypeIsByte_24_3_checkcsp_black = pattern_PrimitiveTypeIsByte_24_3_checkcsp_blackB(
					csp);
			if (result_pattern_PrimitiveTypeIsByte_24_3_checkcsp_black != null) {
	...
	public static final Object[] pattern_PrimitiveTypeIsByte_24_4_createcorrespondence_blackBBBBB(
			PrimitiveTypeByte ePrimitiveType, TypeGraph typeGraph, TClass tPrimitiveClass, Model eModel,
			CCMatch isApplicableMatch) {
		return new Object[] { ePrimitiveType, typeGraph, tPrimitiveClass, eModel, isApplicableMatch };
	}

	public static final Object[] pattern_PrimitiveTypeIsByte_24_4_createcorrespondence_greenBFFBB(
			PrimitiveTypeByte ePrimitiveType, TClass tPrimitiveClass, CCMatch isApplicableMatch) {
		PrimitiveTypeToTClass ePrimitiveTypeToTPrimitiveClass = ModiscoFactory.eINSTANCE.createPrimitiveTypeToTClass();
		TypeToTAbstractType typeToTAbstractType = ModiscoFactory.eINSTANCE.createTypeToTAbstractType();
		ePrimitiveTypeToTPrimitiveClass.setSource(ePrimitiveType);
		ePrimitiveTypeToTPrimitiveClass.setTarget(tPrimitiveClass);
	...
	public static final Object[] pattern_PrimitiveTypeIsByte_24_5_addtoreturnedresult_blackBB(
			IsApplicableRuleResult result, CCMatch isApplicableMatch) {
		return new Object[] { result, isApplicableMatch };
	}

	public static final Object[] pattern_PrimitiveTypeIsByte_24_5_addtoreturnedresult_greenBB(
			IsApplicableRuleResult result, CCMatch isApplicableMatch) {
	...
	public static final IsApplicableRuleResult pattern_PrimitiveTypeIsByte_24_6_expressionFB(
	...
	public static final Object[] pattern_PrimitiveTypeIsByte_28_1_matchtggpattern_black_nac_0B(TClass tPrimitiveClass) {
		for (TPackage __DEC_tPrimitiveClass_classes_943282 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tPrimitiveClass, TPackage.class, "classes")) {
			return new Object[] { tPrimitiveClass };
		}
		return null;
	...
	public static final Object[] pattern_PrimitiveTypeIsByte_28_1_matchtggpattern_black_nac_1BB(TClass tPrimitiveClass,
			TypeGraph typeGraph) {
		for (TypeGraph __DEC_tPrimitiveClass_classes_550399 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tPrimitiveClass, TypeGraph.class, "classes")) {
			if (!typeGraph.equals(__DEC_tPrimitiveClass_classes_550399)) {
				return new Object[] { tPrimitiveClass, typeGraph };
			}
		}
		return null;
	...
	public static final Object[] pattern_PrimitiveTypeIsByte_28_1_matchtggpattern_black_nac_2B(TClass tPrimitiveClass) {
		TPackage __DEC_tPrimitiveClass_ownedTypes_774220 = tPrimitiveClass.getPackage();
		if (__DEC_tPrimitiveClass_ownedTypes_774220 != null) {
			return new Object[] { tPrimitiveClass };
		}
	...
	public static final Object[] pattern_PrimitiveTypeIsByte_29_6_perform_greenFBFFFBB(TypeGraph typeGraph,
