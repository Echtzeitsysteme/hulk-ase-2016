...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Nested Annotation Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * </p>
 *
 * @generated
 */
public class NestedAnnotationTypeImpl extends AbstractRuleImpl implements NestedAnnotationType {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected NestedAnnotationTypeImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return RulesPackage.eINSTANCE.getNestedAnnotationType();
	}
	...
	public boolean isAppropriate_FWD(Match match, AnnotationTypeDeclaration eNestedType,
		...
		// initial bindings
		Object[] result1_black = NestedAnnotationTypeImpl
				.pattern_NestedAnnotationType_0_1_initialbindings_blackBBBB(this, match, eNestedType, eOuterType);
		...
		// Solve CSP
		Object[] result2_bindingAndBlack = NestedAnnotationTypeImpl
				.pattern_NestedAnnotationType_0_2_SolveCSP_bindingAndBlackFBBBB(this, match, eNestedType, eOuterType);
		...
		// Check CSP
		if (NestedAnnotationTypeImpl.pattern_NestedAnnotationType_0_3_CheckCSP_expressionFBB(this, csp)) {

			// collect elements to be translated
			Object[] result4_black = NestedAnnotationTypeImpl
					.pattern_NestedAnnotationType_0_4_collectelementstobetranslated_blackBBB(match, eNestedType,
							eOuterType);
			...
			NestedAnnotationTypeImpl.pattern_NestedAnnotationType_0_4_collectelementstobetranslated_greenBBBFF(match,
			...
			Object[] result5_black = NestedAnnotationTypeImpl
					.pattern_NestedAnnotationType_0_5_collectcontextelements_blackBBB(match, eNestedType, eOuterType);
			if (result5_black == null) {
				throw new RuntimeException("Pattern matching in node [collect context elements] failed."
						+ " Variables: " + "[match] = " + match + ", " + "[eNestedType] = " + eNestedType + ", "
						+ "[eOuterType] = " + eOuterType + ".");
			}
			NestedAnnotationTypeImpl.pattern_NestedAnnotationType_0_5_collectcontextelements_greenBB(match, eOuterType);

			// register objects to match
			NestedAnnotationTypeImpl.pattern_NestedAnnotationType_0_6_registerobjectstomatch_expressionBBBB(this, match,
					eNestedType, eOuterType);
			return NestedAnnotationTypeImpl.pattern_NestedAnnotationType_0_7_expressionF();
		} else {
			return NestedAnnotationTypeImpl.pattern_NestedAnnotationType_0_8_expressionF();
		}
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result1_bindingAndBlack = NestedAnnotationTypeImpl
				.pattern_NestedAnnotationType_1_1_performtransformation_bindingAndBlackFFFFFFFBB(this,
						isApplicableMatch);
		...
		Object[] result1_green = NestedAnnotationTypeImpl
				.pattern_NestedAnnotationType_1_1_performtransformation_greenBFFBFFBB(eNestedType, typeGraph,
						tOuterPackage, csp);
		...
		Object[] result2_black = NestedAnnotationTypeImpl
				.pattern_NestedAnnotationType_1_2_collecttranslatedelements_blackBBBBB(eNestedType,
		...
		Object[] result2_green = NestedAnnotationTypeImpl
				.pattern_NestedAnnotationType_1_2_collecttranslatedelements_greenFBBBBB(eNestedType,
						eNestedTypeToTNestedType, tNestedPackage, tNestedType, mBodyToTAnnotation);
		PerformRuleResult ruleresult = (PerformRuleResult) result2_green[0];

		// bookkeeping for edges
		Object[] result3_black = NestedAnnotationTypeImpl
				.pattern_NestedAnnotationType_1_3_bookkeepingforedges_blackBBBBBBBBBBB(ruleresult, eNestedType,
		...
		NestedAnnotationTypeImpl.pattern_NestedAnnotationType_1_3_bookkeepingforedges_greenBBBBBBBBBFFFFFFFFFFFFFF(
				ruleresult, eNestedType, eNestedTypeToTNestedType, tNestedPackage, typeGraph, tNestedType,
				mBodyToTAnnotation, eOuterType, tOuterPackage);
		// EMoflonEdge mBodyToTAnnotation__eNestedType____source = (EMoflonEdge) result3_green[9];
		// EMoflonEdge tOuterPackage__tNestedPackage____subpackage = (EMoflonEdge) result3_green[10];
		// EMoflonEdge tNestedPackage__tOuterPackage____parent = (EMoflonEdge) result3_green[11];
		// EMoflonEdge tNestedPackage__tNestedType____ownedTypes = (EMoflonEdge) result3_green[12];
		// EMoflonEdge tNestedType__tNestedPackage____package = (EMoflonEdge) result3_green[13];
		// EMoflonEdge typeGraph__tNestedType____ownedTypes = (EMoflonEdge) result3_green[14];
		// EMoflonEdge tNestedType__typeGraph____pg = (EMoflonEdge) result3_green[15];
		// EMoflonEdge tNestedPackage__typeGraph____typeGraph = (EMoflonEdge) result3_green[16];
		// EMoflonEdge mBodyToTAnnotation__tNestedType____target = (EMoflonEdge) result3_green[17];
		// EMoflonEdge eNestedTypeToTNestedType__eNestedType____source = (EMoflonEdge) result3_green[18];
		// EMoflonEdge eNestedType__eOuterType____abstractTypeDeclaration = (EMoflonEdge) result3_green[19];
		// EMoflonEdge eOuterType__eNestedType____bodyDeclarations = (EMoflonEdge) result3_green[20];
		// EMoflonEdge typeGraph__tNestedType____tAnnotationTypes = (EMoflonEdge) result3_green[21];
		// EMoflonEdge eNestedTypeToTNestedType__tNestedType____target = (EMoflonEdge) result3_green[22];

		// perform postprocessing story node is empty
		// register objects
		NestedAnnotationTypeImpl.pattern_NestedAnnotationType_1_5_registerobjects_expressionBBBBBBBBBBBB(this,
				ruleresult, eNestedType, eNestedTypeToTNestedType, tNestedPackage, typeGraph, tNestedType, tOuterType,
				eOuterTypeToTOuterInterface, mBodyToTAnnotation, eOuterType, tOuterPackage);
		return NestedAnnotationTypeImpl.pattern_NestedAnnotationType_1_6_expressionFB(ruleresult);
	}
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		Object[] result1_bindingAndBlack = NestedAnnotationTypeImpl
				.pattern_NestedAnnotationType_2_1_preparereturnvalue_bindingAndBlackFFB(this);
		if (result1_bindingAndBlack == null) {
		...
		Object[] result1_green = NestedAnnotationTypeImpl
				.pattern_NestedAnnotationType_2_1_preparereturnvalue_greenBF(performOperation);
		IsApplicableRuleResult ruleresult = (IsApplicableRuleResult) result1_green[1];

		// ForEach core match
		Object[] result2_binding = NestedAnnotationTypeImpl
				.pattern_NestedAnnotationType_2_2_corematch_bindingFFB(match);
		...
		for (Object[] result2_black : NestedAnnotationTypeImpl
				.pattern_NestedAnnotationType_2_2_corematch_blackBFFBB(eNestedType, eOuterType, match)) {
			...
			for (Object[] result3_black : NestedAnnotationTypeImpl
					.pattern_NestedAnnotationType_2_3_findcontext_blackBFBBBF(eNestedType, tOuterType,
				...
				Object[] result3_green = NestedAnnotationTypeImpl
						.pattern_NestedAnnotationType_2_3_findcontext_greenBBBBBBFFFFFFFFFF(eNestedType, typeGraph,
				...
				// solve CSP
				Object[] result4_bindingAndBlack = NestedAnnotationTypeImpl
						.pattern_NestedAnnotationType_2_4_solveCSP_bindingAndBlackFBBBBBBBB(this, isApplicableMatch,
				...
				// check CSP
				if (NestedAnnotationTypeImpl.pattern_NestedAnnotationType_2_5_checkCSP_expressionFBB(this, csp)) {

					// add match to rule result
					Object[] result6_black = NestedAnnotationTypeImpl
							.pattern_NestedAnnotationType_2_6_addmatchtoruleresult_blackBB(ruleresult,
									isApplicableMatch);
					...
					NestedAnnotationTypeImpl.pattern_NestedAnnotationType_2_6_addmatchtoruleresult_greenBB(ruleresult,
							isApplicableMatch);
		...
		return NestedAnnotationTypeImpl.pattern_NestedAnnotationType_2_7_expressionFB(ruleresult);
	}
	...
	public boolean isAppropriate_BWD(Match match, TPackage tNestedPackage, TypeGraph typeGraph,
		...
		// initial bindings
		Object[] result1_black = NestedAnnotationTypeImpl
				.pattern_NestedAnnotationType_10_1_initialbindings_blackBBBBBBB(this, match, tNestedPackage, typeGraph,
		...
		// Solve CSP
		Object[] result2_bindingAndBlack = NestedAnnotationTypeImpl
				.pattern_NestedAnnotationType_10_2_SolveCSP_bindingAndBlackFBBBBBBB(this, match, tNestedPackage,
		...
		CSP csp = (CSP) result2_bindingAndBlack[0];
		// Check CSP
		if (NestedAnnotationTypeImpl.pattern_NestedAnnotationType_10_3_CheckCSP_expressionFBB(this, csp)) {

			// collect elements to be translated
			Object[] result4_black = NestedAnnotationTypeImpl
					.pattern_NestedAnnotationType_10_4_collectelementstobetranslated_blackBBBBBB(match, tNestedPackage,
							typeGraph, tNestedType, tOuterType, tOuterPackage);
			if (result4_black == null) {
				throw new RuntimeException("Pattern matching in node [collect elements to be translated] failed."
			...
			NestedAnnotationTypeImpl.pattern_NestedAnnotationType_10_4_collectelementstobetranslated_greenBBBBBFFFFFFFF(
					match, tNestedPackage, typeGraph, tNestedType, tOuterPackage);
			// EMoflonEdge tOuterPackage__tNestedPackage____subpackage = (EMoflonEdge) result4_green[5];
			// EMoflonEdge tNestedPackage__tOuterPackage____parent = (EMoflonEdge) result4_green[6];
			// EMoflonEdge tNestedPackage__tNestedType____ownedTypes = (EMoflonEdge) result4_green[7];
			// EMoflonEdge tNestedType__tNestedPackage____package = (EMoflonEdge) result4_green[8];
			// EMoflonEdge typeGraph__tNestedType____ownedTypes = (EMoflonEdge) result4_green[9];
			// EMoflonEdge tNestedType__typeGraph____pg = (EMoflonEdge) result4_green[10];
			// EMoflonEdge tNestedPackage__typeGraph____typeGraph = (EMoflonEdge) result4_green[11];
			// EMoflonEdge typeGraph__tNestedType____tAnnotationTypes = (EMoflonEdge) result4_green[12];

			// collect context elements
			Object[] result5_black = NestedAnnotationTypeImpl
					.pattern_NestedAnnotationType_10_5_collectcontextelements_blackBBBBBB(match, tNestedPackage,
							typeGraph, tNestedType, tOuterType, tOuterPackage);
			if (result5_black == null) {
				throw new RuntimeException("Pattern matching in node [collect context elements] failed."
						+ " Variables: " + "[match] = " + match + ", " + "[tNestedPackage] = " + tNestedPackage + ", "
			...
			NestedAnnotationTypeImpl.pattern_NestedAnnotationType_10_5_collectcontextelements_greenBBBBFFFFF(match,
			...
			// register objects to match
			NestedAnnotationTypeImpl.pattern_NestedAnnotationType_10_6_registerobjectstomatch_expressionBBBBBBB(this,
					match, tNestedPackage, typeGraph, tNestedType, tOuterType, tOuterPackage);
			return NestedAnnotationTypeImpl.pattern_NestedAnnotationType_10_7_expressionF();
		} else {
			return NestedAnnotationTypeImpl.pattern_NestedAnnotationType_10_8_expressionF();
		}
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		// perform transformation
		Object[] result1_bindingAndBlack = NestedAnnotationTypeImpl
				.pattern_NestedAnnotationType_11_1_performtransformation_bindingAndBlackFFFFFFFFBB(this,
						isApplicableMatch);
		if (result1_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching in node [perform transformation] failed." + " Variables: "
					+ "[this] = " + this + ", " + "[isApplicableMatch] = " + isApplicableMatch + ".");
		...
		Object[] result1_green = NestedAnnotationTypeImpl
				.pattern_NestedAnnotationType_11_1_performtransformation_greenFFBFBB(tNestedType, eOuterType, csp);
		...
		// collect translated elements
		Object[] result2_black = NestedAnnotationTypeImpl
				.pattern_NestedAnnotationType_11_2_collecttranslatedelements_blackBBBBB(eNestedType,
						eNestedTypeToTNestedType, tNestedPackage, tNestedType, mBodyToTAnnotation);
		if (result2_black == null) {
			throw new RuntimeException("Pattern matching in node [collect translated elements] failed." + " Variables: "
					+ "[eNestedType] = " + eNestedType + ", " + "[eNestedTypeToTNestedType] = "
		...
		Object[] result2_green = NestedAnnotationTypeImpl
				.pattern_NestedAnnotationType_11_2_collecttranslatedelements_greenFBBBBB(eNestedType,
						eNestedTypeToTNestedType, tNestedPackage, tNestedType, mBodyToTAnnotation);
		PerformRuleResult ruleresult = (PerformRuleResult) result2_green[0];

		// bookkeeping for edges
		Object[] result3_black = NestedAnnotationTypeImpl
				.pattern_NestedAnnotationType_11_3_bookkeepingforedges_blackBBBBBBBBBBB(ruleresult, eNestedType,
						eNestedTypeToTNestedType, tNestedPackage, typeGraph, tNestedType, tOuterType,
						eOuterTypeToTOuterInterface, mBodyToTAnnotation, eOuterType, tOuterPackage);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching in node [bookkeeping for edges] failed." + " Variables: "
		...
		NestedAnnotationTypeImpl.pattern_NestedAnnotationType_11_3_bookkeepingforedges_greenBBBBBBBBBFFFFFFFFFFFFFF(
				ruleresult, eNestedType, eNestedTypeToTNestedType, tNestedPackage, typeGraph, tNestedType,
				mBodyToTAnnotation, eOuterType, tOuterPackage);
		// EMoflonEdge mBodyToTAnnotation__eNestedType____source = (EMoflonEdge) result3_green[9];
		// EMoflonEdge tOuterPackage__tNestedPackage____subpackage = (EMoflonEdge) result3_green[10];
		...
		// perform postprocessing story node is empty
		// register objects
		NestedAnnotationTypeImpl.pattern_NestedAnnotationType_11_5_registerobjects_expressionBBBBBBBBBBBB(this,
				ruleresult, eNestedType, eNestedTypeToTNestedType, tNestedPackage, typeGraph, tNestedType, tOuterType,
				eOuterTypeToTOuterInterface, mBodyToTAnnotation, eOuterType, tOuterPackage);
		return NestedAnnotationTypeImpl.pattern_NestedAnnotationType_11_6_expressionFB(ruleresult);
	}
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		// prepare return value
		Object[] result1_bindingAndBlack = NestedAnnotationTypeImpl
				.pattern_NestedAnnotationType_12_1_preparereturnvalue_bindingAndBlackFFB(this);
		if (result1_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching in node [prepare return value] failed." + " Variables: "
					+ "[this] = " + this + ".");
		}
		...
		// EClass eClass = (EClass) result1_bindingAndBlack[1];
		Object[] result1_green = NestedAnnotationTypeImpl
				.pattern_NestedAnnotationType_12_1_preparereturnvalue_greenBF(performOperation);
		IsApplicableRuleResult ruleresult = (IsApplicableRuleResult) result1_green[1];

		// ForEach core match
		Object[] result2_binding = NestedAnnotationTypeImpl
				.pattern_NestedAnnotationType_12_2_corematch_bindingFFFFFB(match);
		if (result2_binding == null) {
			throw new RuntimeException(
					"Binding in node core match failed." + " Variables: " + "[match] = " + match + ".");
		}
		...
		for (Object[] result2_black : NestedAnnotationTypeImpl
				.pattern_NestedAnnotationType_12_2_corematch_blackBBBBFFBB(tNestedPackage, typeGraph, tNestedType,
			...
			// ForEach find context
			for (Object[] result3_black : NestedAnnotationTypeImpl
					.pattern_NestedAnnotationType_12_3_findcontext_blackBBBBBBB(tNestedPackage, typeGraph, tNestedType,
							tOuterType, eOuterTypeToTOuterInterface, eOuterType, tOuterPackage)) {
				Object[] result3_green = NestedAnnotationTypeImpl
						.pattern_NestedAnnotationType_12_3_findcontext_greenBBBBBBBFFFFFFFFFFFFFFFF(tNestedPackage,
								typeGraph, tNestedType, tOuterType, eOuterTypeToTOuterInterface, eOuterType,
								tOuterPackage);
				IsApplicableMatch isApplicableMatch = (IsApplicableMatch) result3_green[7];
				// EMoflonEdge tOuterPackage__tNestedPackage____subpackage = (EMoflonEdge) result3_green[8];
				// EMoflonEdge tNestedPackage__tOuterPackage____parent = (EMoflonEdge) result3_green[9];
				// EMoflonEdge tNestedPackage__tNestedType____ownedTypes = (EMoflonEdge) result3_green[10];
				// EMoflonEdge tNestedType__tNestedPackage____package = (EMoflonEdge) result3_green[11];
				// EMoflonEdge eOuterTypeToTOuterInterface__eOuterType____source = (EMoflonEdge) result3_green[12];
				// EMoflonEdge typeGraph__tOuterType____ownedTypes = (EMoflonEdge) result3_green[13];
				// EMoflonEdge tOuterType__typeGraph____pg = (EMoflonEdge) result3_green[14];
				...
				// EMoflonEdge tOuterPackage__tOuterType____ownedTypes = (EMoflonEdge) result3_green[17];
				// EMoflonEdge tOuterType__tOuterPackage____package = (EMoflonEdge) result3_green[18];
				// EMoflonEdge tNestedPackage__typeGraph____typeGraph = (EMoflonEdge) result3_green[19];
				// EMoflonEdge typeGraph__tNestedType____tAnnotationTypes = (EMoflonEdge) result3_green[20];
				// EMoflonEdge tOuterPackage__typeGraph____typeGraph = (EMoflonEdge) result3_green[21];
				// EMoflonEdge eOuterTypeToTOuterInterface__tOuterType____target = (EMoflonEdge) result3_green[22];

				// solve CSP
				Object[] result4_bindingAndBlack = NestedAnnotationTypeImpl
						.pattern_NestedAnnotationType_12_4_solveCSP_bindingAndBlackFBBBBBBBBB(this, isApplicableMatch,
				...
				CSP csp = (CSP) result4_bindingAndBlack[0];
				// check CSP
				if (NestedAnnotationTypeImpl.pattern_NestedAnnotationType_12_5_checkCSP_expressionFBB(this, csp)) {

					// add match to rule result
					Object[] result6_black = NestedAnnotationTypeImpl
							.pattern_NestedAnnotationType_12_6_addmatchtoruleresult_blackBB(ruleresult,
									isApplicableMatch);
					if (result6_black == null) {
						throw new RuntimeException("Pattern matching in node [add match to rule result] failed."
								+ " Variables: " + "[ruleresult] = " + ruleresult + ", " + "[isApplicableMatch] = "
					...
					NestedAnnotationTypeImpl.pattern_NestedAnnotationType_12_6_addmatchtoruleresult_greenBB(ruleresult,
							isApplicableMatch);
		...
		return NestedAnnotationTypeImpl.pattern_NestedAnnotationType_12_7_expressionFB(ruleresult);
	}
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_23(EMoflonEdge _edge_abstractTypeDeclaration) {
		// prepare return value
		Object[] result1_bindingAndBlack = NestedAnnotationTypeImpl
				.pattern_NestedAnnotationType_20_1_preparereturnvalue_bindingAndBlackFFBF(this);
		if (result1_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching in node [prepare return value] failed." + " Variables: "
					+ "[this] = " + this + ".");
		}
		...
		Object[] result1_green = NestedAnnotationTypeImpl.pattern_NestedAnnotationType_20_1_preparereturnvalue_greenF();
		EObjectContainer __result = (EObjectContainer) result1_green[0];

		// ForEach test core match and DECs
		for (Object[] result2_black : NestedAnnotationTypeImpl
				.pattern_NestedAnnotationType_20_2_testcorematchandDECs_blackFFB(_edge_abstractTypeDeclaration)) {
			...
			Object[] result2_green = NestedAnnotationTypeImpl
					.pattern_NestedAnnotationType_20_2_testcorematchandDECs_greenFB(__eClass);
			Match match = (Match) result2_green[0];

			// bookkeeping with generic isAppropriate method
			if (NestedAnnotationTypeImpl
					.pattern_NestedAnnotationType_20_3_bookkeepingwithgenericisAppropriatemethod_expressionFBBBB(this,
							match, eNestedType, eOuterType)) {
				// Ensure that the correct types of elements are matched
				if (NestedAnnotationTypeImpl
						.pattern_NestedAnnotationType_20_4_Ensurethatthecorrecttypesofelementsarematched_expressionFBB(
								this, match)) {

					// Add match to rule result
					Object[] result5_black = NestedAnnotationTypeImpl
							.pattern_NestedAnnotationType_20_5_Addmatchtoruleresult_blackBBBB(match, __performOperation,
					...
					NestedAnnotationTypeImpl.pattern_NestedAnnotationType_20_5_Addmatchtoruleresult_greenBBBB(match,
		...
		return NestedAnnotationTypeImpl.pattern_NestedAnnotationType_20_6_expressionFB(__result);
	}
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_21(EMoflonEdge _edge_subpackage) {
		// prepare return value
		Object[] result1_bindingAndBlack = NestedAnnotationTypeImpl
				.pattern_NestedAnnotationType_21_1_preparereturnvalue_bindingAndBlackFFBF(this);
		if (result1_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching in node [prepare return value] failed." + " Variables: "
					+ "[this] = " + this + ".");
		}
		...
		EClass __eClass = (EClass) result1_bindingAndBlack[1];
		EOperation isApplicableCC = (EOperation) result1_bindingAndBlack[3];
		Object[] result1_green = NestedAnnotationTypeImpl.pattern_NestedAnnotationType_21_1_preparereturnvalue_greenF();
		EObjectContainer __result = (EObjectContainer) result1_green[0];

		// ForEach test core match and DECs
		for (Object[] result2_black : NestedAnnotationTypeImpl
				.pattern_NestedAnnotationType_21_2_testcorematchandDECs_blackFFFFFB(_edge_subpackage)) {
			...
			Object[] result2_green = NestedAnnotationTypeImpl
					.pattern_NestedAnnotationType_21_2_testcorematchandDECs_greenFB(__eClass);
			Match match = (Match) result2_green[0];

			// bookkeeping with generic isAppropriate method
			if (NestedAnnotationTypeImpl
					.pattern_NestedAnnotationType_21_3_bookkeepingwithgenericisAppropriatemethod_expressionFBBBBBBB(
							this, match, tNestedPackage, typeGraph, tNestedType, tOuterType, tOuterPackage)) {
				// Ensure that the correct types of elements are matched
				if (NestedAnnotationTypeImpl
						.pattern_NestedAnnotationType_21_4_Ensurethatthecorrecttypesofelementsarematched_expressionFBB(
								this, match)) {

					// Add match to rule result
					Object[] result5_black = NestedAnnotationTypeImpl
							.pattern_NestedAnnotationType_21_5_Addmatchtoruleresult_blackBBBB(match, __performOperation,
									__result, isApplicableCC);
					if (result5_black == null) {
						throw new RuntimeException("Pattern matching in node [Add match to rule result] failed."
								+ " Variables: " + "[match] = " + match + ", " + "[__performOperation] = "
					...
					NestedAnnotationTypeImpl.pattern_NestedAnnotationType_21_5_Addmatchtoruleresult_greenBBBB(match,
							__performOperation, __result, isApplicableCC);
		...
		return NestedAnnotationTypeImpl.pattern_NestedAnnotationType_21_6_expressionFB(__result);
	}
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		// prepare
		Object[] result1_black = NestedAnnotationTypeImpl.pattern_NestedAnnotationType_24_1_prepare_blackB(this);
		if (result1_black == null) {
			throw new RuntimeException(
					"Pattern matching in node [prepare] failed." + " Variables: " + "[this] = " + this + ".");
		}
		Object[] result1_green = NestedAnnotationTypeImpl.pattern_NestedAnnotationType_24_1_prepare_greenF();
		IsApplicableRuleResult result = (IsApplicableRuleResult) result1_green[0];

		// ForEach match context
		Object[] result2_binding = NestedAnnotationTypeImpl
				.pattern_NestedAnnotationType_24_2_matchcontext_bindingFFFFFFFBB(sourceMatch, targetMatch);
		if (result2_binding == null) {
		...
		TAnnotationType tNestedType = (TAnnotationType) result2_binding[3];
		...
		for (Object[] result2_black : NestedAnnotationTypeImpl
				.pattern_NestedAnnotationType_24_2_matchcontext_blackBBBBBFBBBB(eNestedType, tNestedPackage, typeGraph,
			...
			Object[] result2_green = NestedAnnotationTypeImpl
					.pattern_NestedAnnotationType_24_2_matchcontext_greenBBBBBBBBBFB(eNestedType, tNestedPackage,
			...
			// check csp
			Object[] result3_bindingAndBlack = NestedAnnotationTypeImpl
					.pattern_NestedAnnotationType_24_3_checkcsp_bindingAndBlackFBBBBBBBBBBBB(this, isApplicableMatch,
			...
			if (result3_bindingAndBlack != null) {
				...
				Object[] result4_black = NestedAnnotationTypeImpl
						.pattern_NestedAnnotationType_24_4_createcorrespondence_blackBBBBBBBB(eNestedType,
								tNestedPackage, typeGraph, tNestedType, tOuterType, eOuterType, tOuterPackage,
								isApplicableMatch);
				if (result4_black == null) {
				...
				NestedAnnotationTypeImpl.pattern_NestedAnnotationType_24_4_createcorrespondence_greenBFBFB(eNestedType,
				...
				Object[] result5_black = NestedAnnotationTypeImpl
						.pattern_NestedAnnotationType_24_5_addtoreturnedresult_blackBB(result, isApplicableMatch);
				if (result5_black == null) {
					throw new RuntimeException(
							"Pattern matching in node [add to returned result] failed." + " Variables: " + "[result] = "
									+ result + ", " + "[isApplicableMatch] = " + isApplicableMatch + ".");
				}
				NestedAnnotationTypeImpl.pattern_NestedAnnotationType_24_5_addtoreturnedresult_greenBB(result,
						isApplicableMatch);
		...
		return NestedAnnotationTypeImpl.pattern_NestedAnnotationType_24_6_expressionFB(result);
	}
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(CCMatch isApplicableMatch, AnnotationTypeDeclaration eNestedType,
	 ...
	 * @generated
	 */
	public boolean checkDEC_FWD(AnnotationTypeDeclaration eNestedType, AbstractTypeDeclaration eOuterType) {// match tgg pattern
		Object[] result1_black = NestedAnnotationTypeImpl
				.pattern_NestedAnnotationType_27_1_matchtggpattern_blackBB(eNestedType, eOuterType);
		if (result1_black != null) {
			return NestedAnnotationTypeImpl.pattern_NestedAnnotationType_27_2_expressionF();
		} else {
			return NestedAnnotationTypeImpl.pattern_NestedAnnotationType_27_3_expressionF();
		}
	...
	public boolean checkDEC_BWD(TPackage tNestedPackage, TypeGraph typeGraph, TAnnotationType tNestedType,
		...
		Object[] result1_black = NestedAnnotationTypeImpl.pattern_NestedAnnotationType_28_1_matchtggpattern_blackBBBBB(
				tNestedPackage, typeGraph, tNestedType, tOuterType, tOuterPackage);
		if (result1_black != null) {
			return NestedAnnotationTypeImpl.pattern_NestedAnnotationType_28_2_expressionF();
		} else {
			return NestedAnnotationTypeImpl.pattern_NestedAnnotationType_28_3_expressionF();
		}
	...
	public ModelgeneratorRuleResult generateModel(RuleEntryContainer ruleEntryContainer,
		...
		// create result
		Object[] result1_black = NestedAnnotationTypeImpl.pattern_NestedAnnotationType_29_1_createresult_blackB(this);
		if (result1_black == null) {
			throw new RuntimeException(
					"Pattern matching in node [create result] failed." + " Variables: " + "[this] = " + this + ".");
		}
		Object[] result1_green = NestedAnnotationTypeImpl.pattern_NestedAnnotationType_29_1_createresult_greenFF();
		IsApplicableMatch isApplicableMatch = (IsApplicableMatch) result1_green[0];
		ModelgeneratorRuleResult ruleResult = (ModelgeneratorRuleResult) result1_green[1];

		// ForEach is applicable core
		for (Object[] result2_black : NestedAnnotationTypeImpl
				.pattern_NestedAnnotationType_29_2_isapplicablecore_blackFFFFFFBB(ruleEntryContainer, ruleResult)) {
			...
			// solve CSP
			Object[] result3_bindingAndBlack = NestedAnnotationTypeImpl
					.pattern_NestedAnnotationType_29_3_solveCSP_bindingAndBlackFBBBBBBBB(this, isApplicableMatch,
			...
			CSP csp = (CSP) result3_bindingAndBlack[0];
			// check CSP
			if (NestedAnnotationTypeImpl.pattern_NestedAnnotationType_29_4_checkCSP_expressionFBB(this, csp)) {
				// check nacs
				Object[] result5_black = NestedAnnotationTypeImpl
						.pattern_NestedAnnotationType_29_5_checknacs_blackBBBBB(typeGraph, tOuterType,
								eOuterTypeToTOuterInterface, eOuterType, tOuterPackage);
				if (result5_black != null) {

					// perform
					Object[] result6_black = NestedAnnotationTypeImpl
							.pattern_NestedAnnotationType_29_6_perform_blackBBBBBB(typeGraph, tOuterType,
					...
					NestedAnnotationTypeImpl.pattern_NestedAnnotationType_29_6_perform_greenFFFBFFBBBB(typeGraph,
							eOuterType, tOuterPackage, ruleResult, csp);
					// AnnotationTypeDeclaration eNestedType = (AnnotationTypeDeclaration) result6_green[0];
					// TypeToTAbstractType eNestedTypeToTNestedType = (TypeToTAbstractType) result6_green[1];
					// TPackage tNestedPackage = (TPackage) result6_green[2];
					// TAnnotationType tNestedType = (TAnnotationType) result6_green[4];
		...
		return NestedAnnotationTypeImpl.pattern_NestedAnnotationType_29_7_expressionFB(ruleResult);
	}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
		case RulesPackage.NESTED_ANNOTATION_TYPE___IS_APPROPRIATE_FWD__MATCH_ANNOTATIONTYPEDECLARATION_ABSTRACTTYPEDECLARATION:
		...
		case RulesPackage.NESTED_ANNOTATION_TYPE___PERFORM_FWD__ISAPPLICABLEMATCH:
			return perform_FWD((IsApplicableMatch) arguments.get(0));
		case RulesPackage.NESTED_ANNOTATION_TYPE___IS_APPLICABLE_FWD__MATCH:
			return isApplicable_FWD((Match) arguments.get(0));
		case RulesPackage.NESTED_ANNOTATION_TYPE___REGISTER_OBJECTS_TO_MATCH_FWD__MATCH_ANNOTATIONTYPEDECLARATION_ABSTRACTTYPEDECLARATION:
			registerObjectsToMatch_FWD((Match) arguments.get(0), (AnnotationTypeDeclaration) arguments.get(1),
					(AbstractTypeDeclaration) arguments.get(2));
			return null;
		case RulesPackage.NESTED_ANNOTATION_TYPE___IS_APPROPRIATE_SOLVE_CSP_FWD__MATCH_ANNOTATIONTYPEDECLARATION_ABSTRACTTYPEDECLARATION:
			return isAppropriate_solveCsp_FWD((Match) arguments.get(0), (AnnotationTypeDeclaration) arguments.get(1),
					(AbstractTypeDeclaration) arguments.get(2));
		case RulesPackage.NESTED_ANNOTATION_TYPE___IS_APPROPRIATE_CHECK_CSP_FWD__CSP:
			return isAppropriate_checkCsp_FWD((CSP) arguments.get(0));
		case RulesPackage.NESTED_ANNOTATION_TYPE___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_ANNOTATIONTYPEDECLARATION_TYPEGRAPH_TABSTRACTTYPE_TYPETOTABSTRACTTYPE_ABSTRACTTYPEDECLARATION_TPACKAGE:
		...
		case RulesPackage.NESTED_ANNOTATION_TYPE___IS_APPLICABLE_CHECK_CSP_FWD__CSP:
			return isApplicable_checkCsp_FWD((CSP) arguments.get(0));
		case RulesPackage.NESTED_ANNOTATION_TYPE___REGISTER_OBJECTS_FWD__PERFORMRULERESULT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT:
			registerObjects_FWD((PerformRuleResult) arguments.get(0), (EObject) arguments.get(1),
					(EObject) arguments.get(2), (EObject) arguments.get(3), (EObject) arguments.get(4),
					(EObject) arguments.get(5), (EObject) arguments.get(6), (EObject) arguments.get(7),
					(EObject) arguments.get(8), (EObject) arguments.get(9), (EObject) arguments.get(10));
			return null;
		case RulesPackage.NESTED_ANNOTATION_TYPE___CHECK_TYPES_FWD__MATCH:
			return checkTypes_FWD((Match) arguments.get(0));
		case RulesPackage.NESTED_ANNOTATION_TYPE___IS_APPROPRIATE_BWD__MATCH_TPACKAGE_TYPEGRAPH_TANNOTATIONTYPE_TABSTRACTTYPE_TPACKAGE:
		...
		case RulesPackage.NESTED_ANNOTATION_TYPE___PERFORM_BWD__ISAPPLICABLEMATCH:
			return perform_BWD((IsApplicableMatch) arguments.get(0));
		case RulesPackage.NESTED_ANNOTATION_TYPE___IS_APPLICABLE_BWD__MATCH:
			return isApplicable_BWD((Match) arguments.get(0));
		case RulesPackage.NESTED_ANNOTATION_TYPE___REGISTER_OBJECTS_TO_MATCH_BWD__MATCH_TPACKAGE_TYPEGRAPH_TANNOTATIONTYPE_TABSTRACTTYPE_TPACKAGE:
			registerObjectsToMatch_BWD((Match) arguments.get(0), (TPackage) arguments.get(1),
					(TypeGraph) arguments.get(2), (TAnnotationType) arguments.get(3), (TAbstractType) arguments.get(4),
					(TPackage) arguments.get(5));
			return null;
		case RulesPackage.NESTED_ANNOTATION_TYPE___IS_APPROPRIATE_SOLVE_CSP_BWD__MATCH_TPACKAGE_TYPEGRAPH_TANNOTATIONTYPE_TABSTRACTTYPE_TPACKAGE:
			return isAppropriate_solveCsp_BWD((Match) arguments.get(0), (TPackage) arguments.get(1),
					(TypeGraph) arguments.get(2), (TAnnotationType) arguments.get(3), (TAbstractType) arguments.get(4),
					(TPackage) arguments.get(5));
		case RulesPackage.NESTED_ANNOTATION_TYPE___IS_APPROPRIATE_CHECK_CSP_BWD__CSP:
			return isAppropriate_checkCsp_BWD((CSP) arguments.get(0));
		case RulesPackage.NESTED_ANNOTATION_TYPE___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_TPACKAGE_TYPEGRAPH_TANNOTATIONTYPE_TABSTRACTTYPE_TYPETOTABSTRACTTYPE_ABSTRACTTYPEDECLARATION_TPACKAGE:
		...
		case RulesPackage.NESTED_ANNOTATION_TYPE___IS_APPLICABLE_CHECK_CSP_BWD__CSP:
			return isApplicable_checkCsp_BWD((CSP) arguments.get(0));
		case RulesPackage.NESTED_ANNOTATION_TYPE___REGISTER_OBJECTS_BWD__PERFORMRULERESULT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT:
			registerObjects_BWD((PerformRuleResult) arguments.get(0), (EObject) arguments.get(1),
					(EObject) arguments.get(2), (EObject) arguments.get(3), (EObject) arguments.get(4),
					(EObject) arguments.get(5), (EObject) arguments.get(6), (EObject) arguments.get(7),
					(EObject) arguments.get(8), (EObject) arguments.get(9), (EObject) arguments.get(10));
			return null;
		case RulesPackage.NESTED_ANNOTATION_TYPE___CHECK_TYPES_BWD__MATCH:
			return checkTypes_BWD((Match) arguments.get(0));
		case RulesPackage.NESTED_ANNOTATION_TYPE___IS_APPROPRIATE_FWD_EMOFLON_EDGE_23__EMOFLONEDGE:
			return isAppropriate_FWD_EMoflonEdge_23((EMoflonEdge) arguments.get(0));
		case RulesPackage.NESTED_ANNOTATION_TYPE___IS_APPROPRIATE_BWD_EMOFLON_EDGE_21__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_21((EMoflonEdge) arguments.get(0));
		case RulesPackage.NESTED_ANNOTATION_TYPE___CHECK_ATTRIBUTES_FWD__TRIPLEMATCH:
			return checkAttributes_FWD((TripleMatch) arguments.get(0));
		case RulesPackage.NESTED_ANNOTATION_TYPE___CHECK_ATTRIBUTES_BWD__TRIPLEMATCH:
			return checkAttributes_BWD((TripleMatch) arguments.get(0));
		case RulesPackage.NESTED_ANNOTATION_TYPE___IS_APPLICABLE_CC__MATCH_MATCH:
			return isApplicable_CC((Match) arguments.get(0), (Match) arguments.get(1));
		case RulesPackage.NESTED_ANNOTATION_TYPE___IS_APPLICABLE_SOLVE_CSP_CC__CCMATCH_ANNOTATIONTYPEDECLARATION_TPACKAGE_TYPEGRAPH_TANNOTATIONTYPE_TABSTRACTTYPE_TYPETOTABSTRACTTYPE_ABSTRACTTYPEDECLARATION_TPACKAGE_MATCH_MATCH:
			return isApplicable_solveCsp_CC((CCMatch) arguments.get(0), (AnnotationTypeDeclaration) arguments.get(1),
					(TPackage) arguments.get(2), (TypeGraph) arguments.get(3), (TAnnotationType) arguments.get(4),
		...
		case RulesPackage.NESTED_ANNOTATION_TYPE___IS_APPLICABLE_CHECK_CSP_CC__CSP:
			return isApplicable_checkCsp_CC((CSP) arguments.get(0));
		case RulesPackage.NESTED_ANNOTATION_TYPE___CHECK_DEC_FWD__ANNOTATIONTYPEDECLARATION_ABSTRACTTYPEDECLARATION:
			return checkDEC_FWD((AnnotationTypeDeclaration) arguments.get(0),
					(AbstractTypeDeclaration) arguments.get(1));
		case RulesPackage.NESTED_ANNOTATION_TYPE___CHECK_DEC_BWD__TPACKAGE_TYPEGRAPH_TANNOTATIONTYPE_TABSTRACTTYPE_TPACKAGE:
		...
		case RulesPackage.NESTED_ANNOTATION_TYPE___GENERATE_MODEL__RULEENTRYCONTAINER_TYPETOTABSTRACTTYPE:
			return generateModel((RuleEntryContainer) arguments.get(0), (TypeToTAbstractType) arguments.get(1));
		case RulesPackage.NESTED_ANNOTATION_TYPE___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_TYPEGRAPH_TABSTRACTTYPE_TYPETOTABSTRACTTYPE_ABSTRACTTYPEDECLARATION_TPACKAGE_MODELGENERATORRULERESULT:
		...
		case RulesPackage.NESTED_ANNOTATION_TYPE___GENERATE_MODEL_CHECK_CSP_BWD__CSP:
			return generateModel_checkCsp_BWD((CSP) arguments.get(0));
		}
		return super.eInvoke(operationID, arguments);
	}

	public static final Object[] pattern_NestedAnnotationType_0_1_initialbindings_blackBBBB(NestedAnnotationType _this,
	...
	public static final Object[] pattern_NestedAnnotationType_0_2_SolveCSP_bindingFBBBB(NestedAnnotationType _this,
			Match match, AnnotationTypeDeclaration eNestedType, AbstractTypeDeclaration eOuterType) {
	...
	public static final Object[] pattern_NestedAnnotationType_0_2_SolveCSP_blackB(CSP csp) {
		return new Object[] { csp };
	}

	public static final Object[] pattern_NestedAnnotationType_0_2_SolveCSP_bindingAndBlackFBBBB(
			NestedAnnotationType _this, Match match, AnnotationTypeDeclaration eNestedType,
			AbstractTypeDeclaration eOuterType) {
		Object[] result_pattern_NestedAnnotationType_0_2_SolveCSP_binding = pattern_NestedAnnotationType_0_2_SolveCSP_bindingFBBBB(
				_this, match, eNestedType, eOuterType);
		if (result_pattern_NestedAnnotationType_0_2_SolveCSP_binding != null) {
			CSP csp = (CSP) result_pattern_NestedAnnotationType_0_2_SolveCSP_binding[0];

			Object[] result_pattern_NestedAnnotationType_0_2_SolveCSP_black = pattern_NestedAnnotationType_0_2_SolveCSP_blackB(
					csp);
			if (result_pattern_NestedAnnotationType_0_2_SolveCSP_black != null) {
	...
	public static final boolean pattern_NestedAnnotationType_0_3_CheckCSP_expressionFBB(NestedAnnotationType _this,
			CSP csp) {
	...
	public static final Object[] pattern_NestedAnnotationType_0_4_collectelementstobetranslated_blackBBB(Match match,
	...
	public static final Object[] pattern_NestedAnnotationType_0_4_collectelementstobetranslated_greenBBBFF(Match match,
			AnnotationTypeDeclaration eNestedType, AbstractTypeDeclaration eOuterType) {
	...
	public static final Object[] pattern_NestedAnnotationType_0_5_collectcontextelements_blackBBB(Match match,
			AnnotationTypeDeclaration eNestedType, AbstractTypeDeclaration eOuterType) {
		if (!eNestedType.equals(eOuterType)) {
			return new Object[] { match, eNestedType, eOuterType };
		}
	...
	public static final Object[] pattern_NestedAnnotationType_0_5_collectcontextelements_greenBB(Match match,
			AbstractTypeDeclaration eOuterType) {
		match.getContextNodes().add(eOuterType);
		return new Object[] { match, eOuterType };
	}

	public static final void pattern_NestedAnnotationType_0_6_registerobjectstomatch_expressionBBBB(
			NestedAnnotationType _this, Match match, AnnotationTypeDeclaration eNestedType,
			AbstractTypeDeclaration eOuterType) {
	...
	public static final boolean pattern_NestedAnnotationType_0_7_expressionF() {
		boolean _result = Boolean.valueOf(true);
		return _result;
	}

	public static final boolean pattern_NestedAnnotationType_0_8_expressionF() {
		boolean _result = false;
		return _result;
	}

	public static final Object[] pattern_NestedAnnotationType_1_1_performtransformation_bindingFFFFFFB(
	...
	public static final Object[] pattern_NestedAnnotationType_1_1_performtransformation_blackBBBBBBFBB(
			AnnotationTypeDeclaration eNestedType, TypeGraph typeGraph, TAbstractType tOuterType,
			TypeToTAbstractType eOuterTypeToTOuterInterface, AbstractTypeDeclaration eOuterType, TPackage tOuterPackage,
			NestedAnnotationType _this, IsApplicableMatch isApplicableMatch) {
		if (!eNestedType.equals(eOuterType)) {
	...
	public static final Object[] pattern_NestedAnnotationType_1_1_performtransformation_bindingAndBlackFFFFFFFBB(
			NestedAnnotationType _this, IsApplicableMatch isApplicableMatch) {
		Object[] result_pattern_NestedAnnotationType_1_1_performtransformation_binding = pattern_NestedAnnotationType_1_1_performtransformation_bindingFFFFFFB(
				isApplicableMatch);
		if (result_pattern_NestedAnnotationType_1_1_performtransformation_binding != null) {
			AnnotationTypeDeclaration eNestedType = (AnnotationTypeDeclaration) result_pattern_NestedAnnotationType_1_1_performtransformation_binding[0];
			TypeGraph typeGraph = (TypeGraph) result_pattern_NestedAnnotationType_1_1_performtransformation_binding[1];
			TAbstractType tOuterType = (TAbstractType) result_pattern_NestedAnnotationType_1_1_performtransformation_binding[2];
			TypeToTAbstractType eOuterTypeToTOuterInterface = (TypeToTAbstractType) result_pattern_NestedAnnotationType_1_1_performtransformation_binding[3];
			AbstractTypeDeclaration eOuterType = (AbstractTypeDeclaration) result_pattern_NestedAnnotationType_1_1_performtransformation_binding[4];
			TPackage tOuterPackage = (TPackage) result_pattern_NestedAnnotationType_1_1_performtransformation_binding[5];

			Object[] result_pattern_NestedAnnotationType_1_1_performtransformation_black = pattern_NestedAnnotationType_1_1_performtransformation_blackBBBBBBFBB(
					eNestedType, typeGraph, tOuterType, eOuterTypeToTOuterInterface, eOuterType, tOuterPackage, _this,
					isApplicableMatch);
			if (result_pattern_NestedAnnotationType_1_1_performtransformation_black != null) {
				CSP csp = (CSP) result_pattern_NestedAnnotationType_1_1_performtransformation_black[6];
	...
	public static final Object[] pattern_NestedAnnotationType_1_1_performtransformation_greenBFFBFFBB(
			AnnotationTypeDeclaration eNestedType, TypeGraph typeGraph, TPackage tOuterPackage, CSP csp) {
		...
		TAnnotationType tNestedType = BasicFactory.eINSTANCE.createTAnnotationType();
		...
		return new Object[] { eNestedType, eNestedTypeToTNestedType, tNestedPackage, typeGraph, tNestedType,
				mBodyToTAnnotation, tOuterPackage, csp };
	}

	public static final Object[] pattern_NestedAnnotationType_1_2_collecttranslatedelements_blackBBBBB(
			AnnotationTypeDeclaration eNestedType, TypeToTAbstractType eNestedTypeToTNestedType,
			TPackage tNestedPackage, TAnnotationType tNestedType, BodyDeclarationToTAnnotatable mBodyToTAnnotation) {
		return new Object[] { eNestedType, eNestedTypeToTNestedType, tNestedPackage, tNestedType, mBodyToTAnnotation };
	}

	public static final Object[] pattern_NestedAnnotationType_1_2_collecttranslatedelements_greenFBBBBB(
			AnnotationTypeDeclaration eNestedType, TypeToTAbstractType eNestedTypeToTNestedType,
			TPackage tNestedPackage, TAnnotationType tNestedType, BodyDeclarationToTAnnotatable mBodyToTAnnotation) {
	...
	public static final Object[] pattern_NestedAnnotationType_1_3_bookkeepingforedges_blackBBBBBBBBBBB(
	...
	public static final Object[] pattern_NestedAnnotationType_1_3_bookkeepingforedges_greenBBBBBBBBBFFFFFFFFFFFFFF(
			PerformRuleResult ruleresult, EObject eNestedType, EObject eNestedTypeToTNestedType, EObject tNestedPackage,
		...
		String ruleresult_ruleName_prime = "NestedAnnotationType";
		...
		return new Object[] { ruleresult, eNestedType, eNestedTypeToTNestedType, tNestedPackage, typeGraph, tNestedType,
				mBodyToTAnnotation, eOuterType, tOuterPackage, mBodyToTAnnotation__eNestedType____source,
	...
	public static final void pattern_NestedAnnotationType_1_5_registerobjects_expressionBBBBBBBBBBBB(
			NestedAnnotationType _this, PerformRuleResult ruleresult, EObject eNestedType,
	...
	public static final PerformRuleResult pattern_NestedAnnotationType_1_6_expressionFB(PerformRuleResult ruleresult) {
		PerformRuleResult _result = ruleresult;
		return _result;
	}

	public static final Object[] pattern_NestedAnnotationType_2_1_preparereturnvalue_bindingFB(
			NestedAnnotationType _this) {
	...
	public static final Object[] pattern_NestedAnnotationType_2_1_preparereturnvalue_blackFBB(EClass eClass,
			NestedAnnotationType _this) {
	...
	public static final Object[] pattern_NestedAnnotationType_2_1_preparereturnvalue_bindingAndBlackFFB(
			NestedAnnotationType _this) {
		Object[] result_pattern_NestedAnnotationType_2_1_preparereturnvalue_binding = pattern_NestedAnnotationType_2_1_preparereturnvalue_bindingFB(
				_this);
		if (result_pattern_NestedAnnotationType_2_1_preparereturnvalue_binding != null) {
			EClass eClass = (EClass) result_pattern_NestedAnnotationType_2_1_preparereturnvalue_binding[0];

			Object[] result_pattern_NestedAnnotationType_2_1_preparereturnvalue_black = pattern_NestedAnnotationType_2_1_preparereturnvalue_blackFBB(
					eClass, _this);
			if (result_pattern_NestedAnnotationType_2_1_preparereturnvalue_black != null) {
				EOperation performOperation = (EOperation) result_pattern_NestedAnnotationType_2_1_preparereturnvalue_black[0];
	...
	public static final Object[] pattern_NestedAnnotationType_2_1_preparereturnvalue_greenBF(
			EOperation performOperation) {
		IsApplicableRuleResult ruleresult = RuntimeFactory.eINSTANCE.createIsApplicableRuleResult();
		boolean ruleresult_success_prime = false;
		String ruleresult_rule_prime = "NestedAnnotationType";
	...
	public static final Object[] pattern_NestedAnnotationType_2_2_corematch_bindingFFB(Match match) {
	...
	public static final Iterable<Object[]> pattern_NestedAnnotationType_2_2_corematch_blackBFFBB(
	...
	public static final Iterable<Object[]> pattern_NestedAnnotationType_2_3_findcontext_blackBFBBBF(
	...
	public static final Object[] pattern_NestedAnnotationType_2_3_findcontext_greenBBBBBBFFFFFFFFFF(
			AnnotationTypeDeclaration eNestedType, TypeGraph typeGraph, TAbstractType tOuterType,
			TypeToTAbstractType eOuterTypeToTOuterInterface, AbstractTypeDeclaration eOuterType,
	...
	public static final Object[] pattern_NestedAnnotationType_2_4_solveCSP_bindingFBBBBBBBB(NestedAnnotationType _this,
	...
	public static final Object[] pattern_NestedAnnotationType_2_4_solveCSP_blackB(CSP csp) {
		return new Object[] { csp };
	}

	public static final Object[] pattern_NestedAnnotationType_2_4_solveCSP_bindingAndBlackFBBBBBBBB(
			NestedAnnotationType _this, IsApplicableMatch isApplicableMatch, AnnotationTypeDeclaration eNestedType,
			TypeGraph typeGraph, TAbstractType tOuterType, TypeToTAbstractType eOuterTypeToTOuterInterface,
			AbstractTypeDeclaration eOuterType, TPackage tOuterPackage) {
		Object[] result_pattern_NestedAnnotationType_2_4_solveCSP_binding = pattern_NestedAnnotationType_2_4_solveCSP_bindingFBBBBBBBB(
				_this, isApplicableMatch, eNestedType, typeGraph, tOuterType, eOuterTypeToTOuterInterface, eOuterType,
				tOuterPackage);
		if (result_pattern_NestedAnnotationType_2_4_solveCSP_binding != null) {
			CSP csp = (CSP) result_pattern_NestedAnnotationType_2_4_solveCSP_binding[0];

			Object[] result_pattern_NestedAnnotationType_2_4_solveCSP_black = pattern_NestedAnnotationType_2_4_solveCSP_blackB(
					csp);
			if (result_pattern_NestedAnnotationType_2_4_solveCSP_black != null) {
	...
	public static final boolean pattern_NestedAnnotationType_2_5_checkCSP_expressionFBB(NestedAnnotationType _this,
			CSP csp) {
	...
	public static final Object[] pattern_NestedAnnotationType_2_6_addmatchtoruleresult_blackBB(
			IsApplicableRuleResult ruleresult, IsApplicableMatch isApplicableMatch) {
		return new Object[] { ruleresult, isApplicableMatch };
	}

	public static final Object[] pattern_NestedAnnotationType_2_6_addmatchtoruleresult_greenBB(
			IsApplicableRuleResult ruleresult, IsApplicableMatch isApplicableMatch) {
		ruleresult.getIsApplicableMatch().add(isApplicableMatch);
		boolean ruleresult_success_prime = Boolean.valueOf(true);
		String isApplicableMatch_ruleName_prime = "NestedAnnotationType";
		ruleresult.setSuccess(Boolean.valueOf(ruleresult_success_prime));
		isApplicableMatch.setRuleName(isApplicableMatch_ruleName_prime);
		return new Object[] { ruleresult, isApplicableMatch };
	}

	public static final IsApplicableRuleResult pattern_NestedAnnotationType_2_7_expressionFB(
			IsApplicableRuleResult ruleresult) {
		IsApplicableRuleResult _result = ruleresult;
		return _result;
	}

	public static final Object[] pattern_NestedAnnotationType_10_1_initialbindings_blackBBBBBBB(
			NestedAnnotationType _this, Match match, TPackage tNestedPackage, TypeGraph typeGraph,
			TAnnotationType tNestedType, TAbstractType tOuterType, TPackage tOuterPackage) {
	...
	public static final Object[] pattern_NestedAnnotationType_10_2_SolveCSP_bindingFBBBBBBB(NestedAnnotationType _this,
	...
	public static final Object[] pattern_NestedAnnotationType_10_2_SolveCSP_blackB(CSP csp) {
		return new Object[] { csp };
	}

	public static final Object[] pattern_NestedAnnotationType_10_2_SolveCSP_bindingAndBlackFBBBBBBB(
			NestedAnnotationType _this, Match match, TPackage tNestedPackage, TypeGraph typeGraph,
			TAnnotationType tNestedType, TAbstractType tOuterType, TPackage tOuterPackage) {
		Object[] result_pattern_NestedAnnotationType_10_2_SolveCSP_binding = pattern_NestedAnnotationType_10_2_SolveCSP_bindingFBBBBBBB(
				_this, match, tNestedPackage, typeGraph, tNestedType, tOuterType, tOuterPackage);
		if (result_pattern_NestedAnnotationType_10_2_SolveCSP_binding != null) {
			CSP csp = (CSP) result_pattern_NestedAnnotationType_10_2_SolveCSP_binding[0];

			Object[] result_pattern_NestedAnnotationType_10_2_SolveCSP_black = pattern_NestedAnnotationType_10_2_SolveCSP_blackB(
					csp);
			if (result_pattern_NestedAnnotationType_10_2_SolveCSP_black != null) {
	...
	public static final boolean pattern_NestedAnnotationType_10_3_CheckCSP_expressionFBB(NestedAnnotationType _this,
			CSP csp) {
	...
	public static final Object[] pattern_NestedAnnotationType_10_4_collectelementstobetranslated_blackBBBBBB(
			Match match, TPackage tNestedPackage, TypeGraph typeGraph, TAnnotationType tNestedType,
			TAbstractType tOuterType, TPackage tOuterPackage) {
		if (!tNestedPackage.equals(tOuterPackage)) {
			if (!tNestedType.equals(tOuterType)) {
	...
	public static final Object[] pattern_NestedAnnotationType_10_4_collectelementstobetranslated_greenBBBBBFFFFFFFF(
			Match match, TPackage tNestedPackage, TypeGraph typeGraph, TAnnotationType tNestedType,
			TPackage tOuterPackage) {
		EMoflonEdge tOuterPackage__tNestedPackage____subpackage = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		EMoflonEdge tNestedPackage__tOuterPackage____parent = RuntimeFactory.eINSTANCE.createEMoflonEdge();
	...
	public static final Object[] pattern_NestedAnnotationType_10_5_collectcontextelements_blackBBBBBB(Match match,
			TPackage tNestedPackage, TypeGraph typeGraph, TAnnotationType tNestedType, TAbstractType tOuterType,
			TPackage tOuterPackage) {
		if (!tNestedPackage.equals(tOuterPackage)) {
			if (!tNestedType.equals(tOuterType)) {
	...
	public static final Object[] pattern_NestedAnnotationType_10_5_collectcontextelements_greenBBBBFFFFF(Match match,
	...
	public static final void pattern_NestedAnnotationType_10_6_registerobjectstomatch_expressionBBBBBBB(
			NestedAnnotationType _this, Match match, TPackage tNestedPackage, TypeGraph typeGraph,
			TAnnotationType tNestedType, TAbstractType tOuterType, TPackage tOuterPackage) {
	...
	public static final boolean pattern_NestedAnnotationType_10_7_expressionF() {
		boolean _result = Boolean.valueOf(true);
		return _result;
	}

	public static final boolean pattern_NestedAnnotationType_10_8_expressionF() {
		boolean _result = false;
		return _result;
	}

	public static final Object[] pattern_NestedAnnotationType_11_1_performtransformation_bindingFFFFFFFB(
			IsApplicableMatch isApplicableMatch) {
	...
	public static final Object[] pattern_NestedAnnotationType_11_1_performtransformation_blackBBBBBBBFBB(
			TPackage tNestedPackage, TypeGraph typeGraph, TAnnotationType tNestedType, TAbstractType tOuterType,
			TypeToTAbstractType eOuterTypeToTOuterInterface, AbstractTypeDeclaration eOuterType, TPackage tOuterPackage,
			NestedAnnotationType _this, IsApplicableMatch isApplicableMatch) {
		if (!tNestedPackage.equals(tOuterPackage)) {
	...
	public static final Object[] pattern_NestedAnnotationType_11_1_performtransformation_bindingAndBlackFFFFFFFFBB(
			NestedAnnotationType _this, IsApplicableMatch isApplicableMatch) {
		Object[] result_pattern_NestedAnnotationType_11_1_performtransformation_binding = pattern_NestedAnnotationType_11_1_performtransformation_bindingFFFFFFFB(
				isApplicableMatch);
		if (result_pattern_NestedAnnotationType_11_1_performtransformation_binding != null) {
			TPackage tNestedPackage = (TPackage) result_pattern_NestedAnnotationType_11_1_performtransformation_binding[0];
			TypeGraph typeGraph = (TypeGraph) result_pattern_NestedAnnotationType_11_1_performtransformation_binding[1];
			TAnnotationType tNestedType = (TAnnotationType) result_pattern_NestedAnnotationType_11_1_performtransformation_binding[2];
			TAbstractType tOuterType = (TAbstractType) result_pattern_NestedAnnotationType_11_1_performtransformation_binding[3];
			TypeToTAbstractType eOuterTypeToTOuterInterface = (TypeToTAbstractType) result_pattern_NestedAnnotationType_11_1_performtransformation_binding[4];
			AbstractTypeDeclaration eOuterType = (AbstractTypeDeclaration) result_pattern_NestedAnnotationType_11_1_performtransformation_binding[5];
			TPackage tOuterPackage = (TPackage) result_pattern_NestedAnnotationType_11_1_performtransformation_binding[6];

			Object[] result_pattern_NestedAnnotationType_11_1_performtransformation_black = pattern_NestedAnnotationType_11_1_performtransformation_blackBBBBBBBFBB(
			...
			if (result_pattern_NestedAnnotationType_11_1_performtransformation_black != null) {
				CSP csp = (CSP) result_pattern_NestedAnnotationType_11_1_performtransformation_black[7];
	...
	public static final Object[] pattern_NestedAnnotationType_11_1_performtransformation_greenFFBFBB(
	...
	public static final Object[] pattern_NestedAnnotationType_11_2_collecttranslatedelements_blackBBBBB(
			AnnotationTypeDeclaration eNestedType, TypeToTAbstractType eNestedTypeToTNestedType,
			TPackage tNestedPackage, TAnnotationType tNestedType, BodyDeclarationToTAnnotatable mBodyToTAnnotation) {
		return new Object[] { eNestedType, eNestedTypeToTNestedType, tNestedPackage, tNestedType, mBodyToTAnnotation };
	}

	public static final Object[] pattern_NestedAnnotationType_11_2_collecttranslatedelements_greenFBBBBB(
			AnnotationTypeDeclaration eNestedType, TypeToTAbstractType eNestedTypeToTNestedType,
			TPackage tNestedPackage, TAnnotationType tNestedType, BodyDeclarationToTAnnotatable mBodyToTAnnotation) {
		PerformRuleResult ruleresult = RuntimeFactory.eINSTANCE.createPerformRuleResult();
	...
	public static final Object[] pattern_NestedAnnotationType_11_3_bookkeepingforedges_blackBBBBBBBBBBB(
			PerformRuleResult ruleresult, EObject eNestedType, EObject eNestedTypeToTNestedType, EObject tNestedPackage,
			EObject typeGraph, EObject tNestedType, EObject tOuterType, EObject eOuterTypeToTOuterInterface,
			EObject mBodyToTAnnotation, EObject eOuterType, EObject tOuterPackage) {
		if (!eNestedType.equals(eNestedTypeToTNestedType)) {
	...
	public static final Object[] pattern_NestedAnnotationType_11_3_bookkeepingforedges_greenBBBBBBBBBFFFFFFFFFFFFFF(
			PerformRuleResult ruleresult, EObject eNestedType, EObject eNestedTypeToTNestedType, EObject tNestedPackage,
			EObject typeGraph, EObject tNestedType, EObject mBodyToTAnnotation, EObject eOuterType,
			EObject tOuterPackage) {
		EMoflonEdge mBodyToTAnnotation__eNestedType____source = RuntimeFactory.eINSTANCE.createEMoflonEdge();
	...
	public static final void pattern_NestedAnnotationType_11_5_registerobjects_expressionBBBBBBBBBBBB(
			NestedAnnotationType _this, PerformRuleResult ruleresult, EObject eNestedType,
			EObject eNestedTypeToTNestedType, EObject tNestedPackage, EObject typeGraph, EObject tNestedType,
			EObject tOuterType, EObject eOuterTypeToTOuterInterface, EObject mBodyToTAnnotation, EObject eOuterType,
			EObject tOuterPackage) {
	...
	public static final PerformRuleResult pattern_NestedAnnotationType_11_6_expressionFB(PerformRuleResult ruleresult) {
		PerformRuleResult _result = ruleresult;
		return _result;
	}

	public static final Object[] pattern_NestedAnnotationType_12_1_preparereturnvalue_bindingFB(
			NestedAnnotationType _this) {
		EClass _localVariable_0 = _this.eClass();
		EClass eClass = _localVariable_0;
		if (eClass != null) {
	...
	public static final Object[] pattern_NestedAnnotationType_12_1_preparereturnvalue_blackFBB(EClass eClass,
			NestedAnnotationType _this) {
		for (EOperation performOperation : eClass.getEOperations()) {
			String performOperation_name = performOperation.getName();
	...
	public static final Object[] pattern_NestedAnnotationType_12_1_preparereturnvalue_bindingAndBlackFFB(
			NestedAnnotationType _this) {
		Object[] result_pattern_NestedAnnotationType_12_1_preparereturnvalue_binding = pattern_NestedAnnotationType_12_1_preparereturnvalue_bindingFB(
				_this);
		if (result_pattern_NestedAnnotationType_12_1_preparereturnvalue_binding != null) {
			EClass eClass = (EClass) result_pattern_NestedAnnotationType_12_1_preparereturnvalue_binding[0];

			Object[] result_pattern_NestedAnnotationType_12_1_preparereturnvalue_black = pattern_NestedAnnotationType_12_1_preparereturnvalue_blackFBB(
					eClass, _this);
			if (result_pattern_NestedAnnotationType_12_1_preparereturnvalue_black != null) {
				EOperation performOperation = (EOperation) result_pattern_NestedAnnotationType_12_1_preparereturnvalue_black[0];
	...
	public static final Object[] pattern_NestedAnnotationType_12_1_preparereturnvalue_greenBF(
			EOperation performOperation) {
		IsApplicableRuleResult ruleresult = RuntimeFactory.eINSTANCE.createIsApplicableRuleResult();
		boolean ruleresult_success_prime = false;
		String ruleresult_rule_prime = "NestedAnnotationType";
	...
	public static final Object[] pattern_NestedAnnotationType_12_2_corematch_bindingFFFFFB(Match match) {
	...
	public static final Iterable<Object[]> pattern_NestedAnnotationType_12_2_corematch_blackBBBBFFBB(
			TPackage tNestedPackage, TypeGraph typeGraph, TAnnotationType tNestedType, TAbstractType tOuterType,
	...
	public static final Iterable<Object[]> pattern_NestedAnnotationType_12_3_findcontext_blackBBBBBBB(
			TPackage tNestedPackage, TypeGraph typeGraph, TAnnotationType tNestedType, TAbstractType tOuterType,
			TypeToTAbstractType eOuterTypeToTOuterInterface, AbstractTypeDeclaration eOuterType,
			TPackage tOuterPackage) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
												...
												if (typeGraph.equals(tOuterPackage.getTypeGraph())) {
													if (tOuterType.equals(eOuterTypeToTOuterInterface.getTarget())) {
														_result.add(new Object[] { tNestedPackage, typeGraph,
																tNestedType, tOuterType, eOuterTypeToTOuterInterface,
																eOuterType, tOuterPackage });
													}
												}
											}
	...
	public static final Object[] pattern_NestedAnnotationType_12_3_findcontext_greenBBBBBBBFFFFFFFFFFFFFFFF(
			TPackage tNestedPackage, TypeGraph typeGraph, TAnnotationType tNestedType, TAbstractType tOuterType,
			TypeToTAbstractType eOuterTypeToTOuterInterface, AbstractTypeDeclaration eOuterType,
			TPackage tOuterPackage) {
		IsApplicableMatch isApplicableMatch = RuntimeFactory.eINSTANCE.createIsApplicableMatch();
		...
		eOuterTypeToTOuterInterface__tOuterType____target
				.setName(eOuterTypeToTOuterInterface__tOuterType____target_name_prime);
		return new Object[] { tNestedPackage, typeGraph, tNestedType, tOuterType, eOuterTypeToTOuterInterface,
				eOuterType, tOuterPackage, isApplicableMatch, tOuterPackage__tNestedPackage____subpackage,
				tNestedPackage__tOuterPackage____parent, tNestedPackage__tNestedType____ownedTypes,
				tNestedType__tNestedPackage____package, eOuterTypeToTOuterInterface__eOuterType____source,
				...
				tOuterType__tOuterPackage____package, tNestedPackage__typeGraph____typeGraph,
				typeGraph__tNestedType____tAnnotationTypes, tOuterPackage__typeGraph____typeGraph,
				eOuterTypeToTOuterInterface__tOuterType____target };
	}

	public static final Object[] pattern_NestedAnnotationType_12_4_solveCSP_bindingFBBBBBBBBB(
			NestedAnnotationType _this, IsApplicableMatch isApplicableMatch, TPackage tNestedPackage,
			TypeGraph typeGraph, TAnnotationType tNestedType, TAbstractType tOuterType,
			TypeToTAbstractType eOuterTypeToTOuterInterface, AbstractTypeDeclaration eOuterType,
			TPackage tOuterPackage) {
	...
	public static final Object[] pattern_NestedAnnotationType_12_4_solveCSP_blackB(CSP csp) {
		return new Object[] { csp };
	}

	public static final Object[] pattern_NestedAnnotationType_12_4_solveCSP_bindingAndBlackFBBBBBBBBB(
			NestedAnnotationType _this, IsApplicableMatch isApplicableMatch, TPackage tNestedPackage,
			TypeGraph typeGraph, TAnnotationType tNestedType, TAbstractType tOuterType,
			TypeToTAbstractType eOuterTypeToTOuterInterface, AbstractTypeDeclaration eOuterType,
			TPackage tOuterPackage) {
		Object[] result_pattern_NestedAnnotationType_12_4_solveCSP_binding = pattern_NestedAnnotationType_12_4_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, tNestedPackage, typeGraph, tNestedType, tOuterType,
				eOuterTypeToTOuterInterface, eOuterType, tOuterPackage);
		if (result_pattern_NestedAnnotationType_12_4_solveCSP_binding != null) {
			CSP csp = (CSP) result_pattern_NestedAnnotationType_12_4_solveCSP_binding[0];

			Object[] result_pattern_NestedAnnotationType_12_4_solveCSP_black = pattern_NestedAnnotationType_12_4_solveCSP_blackB(
					csp);
			if (result_pattern_NestedAnnotationType_12_4_solveCSP_black != null) {
	...
	public static final boolean pattern_NestedAnnotationType_12_5_checkCSP_expressionFBB(NestedAnnotationType _this,
			CSP csp) {
	...
	public static final Object[] pattern_NestedAnnotationType_12_6_addmatchtoruleresult_blackBB(
			IsApplicableRuleResult ruleresult, IsApplicableMatch isApplicableMatch) {
		return new Object[] { ruleresult, isApplicableMatch };
	}

	public static final Object[] pattern_NestedAnnotationType_12_6_addmatchtoruleresult_greenBB(
			IsApplicableRuleResult ruleresult, IsApplicableMatch isApplicableMatch) {
		ruleresult.getIsApplicableMatch().add(isApplicableMatch);
		boolean ruleresult_success_prime = Boolean.valueOf(true);
		String isApplicableMatch_ruleName_prime = "NestedAnnotationType";
	...
	public static final IsApplicableRuleResult pattern_NestedAnnotationType_12_7_expressionFB(
			IsApplicableRuleResult ruleresult) {
		IsApplicableRuleResult _result = ruleresult;
		return _result;
	}

	public static final Object[] pattern_NestedAnnotationType_20_1_preparereturnvalue_bindingFB(
			NestedAnnotationType _this) {
		EClass _localVariable_0 = _this.eClass();
	...
	public static final Object[] pattern_NestedAnnotationType_20_1_preparereturnvalue_blackFBBF(EClass __eClass,
			NestedAnnotationType _this) {
	...
	public static final Object[] pattern_NestedAnnotationType_20_1_preparereturnvalue_bindingAndBlackFFBF(
			NestedAnnotationType _this) {
		Object[] result_pattern_NestedAnnotationType_20_1_preparereturnvalue_binding = pattern_NestedAnnotationType_20_1_preparereturnvalue_bindingFB(
				_this);
		if (result_pattern_NestedAnnotationType_20_1_preparereturnvalue_binding != null) {
			EClass __eClass = (EClass) result_pattern_NestedAnnotationType_20_1_preparereturnvalue_binding[0];

			Object[] result_pattern_NestedAnnotationType_20_1_preparereturnvalue_black = pattern_NestedAnnotationType_20_1_preparereturnvalue_blackFBBF(
					__eClass, _this);
			if (result_pattern_NestedAnnotationType_20_1_preparereturnvalue_black != null) {
				EOperation __performOperation = (EOperation) result_pattern_NestedAnnotationType_20_1_preparereturnvalue_black[0];
				EOperation isApplicableCC = (EOperation) result_pattern_NestedAnnotationType_20_1_preparereturnvalue_black[3];
	...
	public static final Object[] pattern_NestedAnnotationType_20_1_preparereturnvalue_greenF() {
		EObjectContainer __result = RuntimeFactory.eINSTANCE.createEObjectContainer();
		return new Object[] { __result };
	}

	public static final Iterable<Object[]> pattern_NestedAnnotationType_20_2_testcorematchandDECs_blackFFB(
	...
	public static final Object[] pattern_NestedAnnotationType_20_2_testcorematchandDECs_greenFB(EClass __eClass) {
	...
	public static final boolean pattern_NestedAnnotationType_20_3_bookkeepingwithgenericisAppropriatemethod_expressionFBBBB(
			NestedAnnotationType _this, Match match, AnnotationTypeDeclaration eNestedType,
			AbstractTypeDeclaration eOuterType) {
	...
	public static final boolean pattern_NestedAnnotationType_20_4_Ensurethatthecorrecttypesofelementsarematched_expressionFBB(
			NestedAnnotationType _this, Match match) {
		boolean _localVariable_0 = _this.checkTypes_FWD(match);
		boolean _result = Boolean.valueOf(_localVariable_0);
		return _result;
	}

	public static final Object[] pattern_NestedAnnotationType_20_5_Addmatchtoruleresult_blackBBBB(Match match,
	...
	public static final Object[] pattern_NestedAnnotationType_20_5_Addmatchtoruleresult_greenBBBB(Match match,
			EOperation __performOperation, EObjectContainer __result, EOperation isApplicableCC) {
	...
	public static final EObjectContainer pattern_NestedAnnotationType_20_6_expressionFB(EObjectContainer __result) {
		EObjectContainer _result = __result;
		return _result;
	}

	public static final Object[] pattern_NestedAnnotationType_21_1_preparereturnvalue_bindingFB(
			NestedAnnotationType _this) {
		EClass _localVariable_0 = _this.eClass();
		EClass __eClass = _localVariable_0;
		if (__eClass != null) {
	...
	public static final Object[] pattern_NestedAnnotationType_21_1_preparereturnvalue_blackFBBF(EClass __eClass,
			NestedAnnotationType _this) {
		for (EOperation __performOperation : __eClass.getEOperations()) {
			String __performOperation_name = __performOperation.getName();
	...
	public static final Object[] pattern_NestedAnnotationType_21_1_preparereturnvalue_bindingAndBlackFFBF(
			NestedAnnotationType _this) {
		Object[] result_pattern_NestedAnnotationType_21_1_preparereturnvalue_binding = pattern_NestedAnnotationType_21_1_preparereturnvalue_bindingFB(
				_this);
		if (result_pattern_NestedAnnotationType_21_1_preparereturnvalue_binding != null) {
			EClass __eClass = (EClass) result_pattern_NestedAnnotationType_21_1_preparereturnvalue_binding[0];

			Object[] result_pattern_NestedAnnotationType_21_1_preparereturnvalue_black = pattern_NestedAnnotationType_21_1_preparereturnvalue_blackFBBF(
					__eClass, _this);
			if (result_pattern_NestedAnnotationType_21_1_preparereturnvalue_black != null) {
				EOperation __performOperation = (EOperation) result_pattern_NestedAnnotationType_21_1_preparereturnvalue_black[0];
				EOperation isApplicableCC = (EOperation) result_pattern_NestedAnnotationType_21_1_preparereturnvalue_black[3];
	...
	public static final Object[] pattern_NestedAnnotationType_21_1_preparereturnvalue_greenF() {
		EObjectContainer __result = RuntimeFactory.eINSTANCE.createEObjectContainer();
		return new Object[] { __result };
	}

	public static final Object[] pattern_NestedAnnotationType_21_2_testcorematchandDECs_black_nac_0BB(
			TPackage tNestedPackage, TPackage tOuterPackage) {
		if (!tNestedPackage.equals(tOuterPackage)) {
			TPackage __DEC_tNestedPackage_parent_114832 = tNestedPackage.getParent();
			if (__DEC_tNestedPackage_parent_114832 != null) {
				if (!tNestedPackage.equals(__DEC_tNestedPackage_parent_114832)) {
					if (!tOuterPackage.equals(__DEC_tNestedPackage_parent_114832)) {
	...
	public static final Object[] pattern_NestedAnnotationType_21_2_testcorematchandDECs_black_nac_1BB(
			TPackage tNestedPackage, TypeGraph typeGraph) {
		TypeGraph __DEC_tNestedPackage_packages_398361 = tNestedPackage.getPg();
		if (__DEC_tNestedPackage_packages_398361 != null) {
			if (!typeGraph.equals(__DEC_tNestedPackage_packages_398361)) {
	...
	public static final Object[] pattern_NestedAnnotationType_21_2_testcorematchandDECs_black_nac_2BB(
			TAnnotationType tNestedType, TypeGraph typeGraph) {
		for (TypeGraph __DEC_tNestedType_tAnnotationTypes_899432 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tNestedType, TypeGraph.class, "tAnnotationTypes")) {
			if (!typeGraph.equals(__DEC_tNestedType_tAnnotationTypes_899432)) {
	...
	public static final Object[] pattern_NestedAnnotationType_21_2_testcorematchandDECs_black_nac_3BBB(
			TAnnotationType tNestedType, TPackage tNestedPackage, TPackage tOuterPackage) {
		if (!tNestedPackage.equals(tOuterPackage)) {
			TPackage __DEC_tNestedType_ownedTypes_659406 = tNestedType.getPackage();
			if (__DEC_tNestedType_ownedTypes_659406 != null) {
				if (!tNestedPackage.equals(__DEC_tNestedType_ownedTypes_659406)) {
					if (!tOuterPackage.equals(__DEC_tNestedType_ownedTypes_659406)) {
	...
	public static final Object[] pattern_NestedAnnotationType_21_2_testcorematchandDECs_black_nac_4BB(
	...
	public static final Object[] pattern_NestedAnnotationType_21_2_testcorematchandDECs_black_nac_5BB(
	...
	public static final Iterable<Object[]> pattern_NestedAnnotationType_21_2_testcorematchandDECs_blackFFFFFB(
			EMoflonEdge _edge_subpackage) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		EObject tmpTOuterPackage = _edge_subpackage.getSrc();
		if (tmpTOuterPackage instanceof TPackage) {
			TPackage tOuterPackage = (TPackage) tmpTOuterPackage;
			EObject tmpTNestedPackage = _edge_subpackage.getTrg();
			if (tmpTNestedPackage instanceof TPackage) {
				TPackage tNestedPackage = (TPackage) tmpTNestedPackage;
				if (!tNestedPackage.equals(tOuterPackage)) {
					if (tOuterPackage.getSubpackage().contains(tNestedPackage)) {
						TypeGraph typeGraph = tOuterPackage.getTypeGraph();
						if (typeGraph != null) {
							if (typeGraph.equals(tNestedPackage.getTypeGraph())) {
								if (pattern_NestedAnnotationType_21_2_testcorematchandDECs_black_nac_0BB(tNestedPackage,
										tOuterPackage) == null) {
									if (pattern_NestedAnnotationType_21_2_testcorematchandDECs_black_nac_1BB(
											tNestedPackage, typeGraph) == null) {
										if (pattern_NestedAnnotationType_21_2_testcorematchandDECs_black_nac_4BB(
												typeGraph, tNestedPackage) == null) {
											for (TAbstractType tOuterType : tOuterPackage.getOwnedTypes()) {
												if (typeGraph.getOwnedTypes().contains(tOuterType)) {
													for (TAbstractType tmpTNestedType : tNestedPackage
															.getOwnedTypes()) {
														if (tmpTNestedType instanceof TAnnotationType) {
															TAnnotationType tNestedType = (TAnnotationType) tmpTNestedType;
															if (!tNestedType.equals(tOuterType)) {
																if (typeGraph.getOwnedTypes().contains(tNestedType)) {
																	if (typeGraph.getTAnnotationTypes()
																			.contains(tNestedType)) {
																		if (pattern_NestedAnnotationType_21_2_testcorematchandDECs_black_nac_2BB(
																				tNestedType, typeGraph) == null) {
																			if (pattern_NestedAnnotationType_21_2_testcorematchandDECs_black_nac_3BBB(
																					tNestedType, tNestedPackage,
																					tOuterPackage) == null) {
																				if (pattern_NestedAnnotationType_21_2_testcorematchandDECs_black_nac_5BB(
																						tOuterPackage,
																						tNestedType) == null) {
	...
	public static final Object[] pattern_NestedAnnotationType_21_2_testcorematchandDECs_greenFB(EClass __eClass) {
		Match match = RuntimeFactory.eINSTANCE.createMatch();
		String __eClass_name = __eClass.getName();
		String match_ruleName_prime = __eClass_name;
		match.setRuleName(match_ruleName_prime);
	...
	public static final boolean pattern_NestedAnnotationType_21_3_bookkeepingwithgenericisAppropriatemethod_expressionFBBBBBBB(
			NestedAnnotationType _this, Match match, TPackage tNestedPackage, TypeGraph typeGraph,
			TAnnotationType tNestedType, TAbstractType tOuterType, TPackage tOuterPackage) {
	...
	public static final boolean pattern_NestedAnnotationType_21_4_Ensurethatthecorrecttypesofelementsarematched_expressionFBB(
			NestedAnnotationType _this, Match match) {
	...
	public static final Object[] pattern_NestedAnnotationType_21_5_Addmatchtoruleresult_blackBBBB(Match match,
			EOperation __performOperation, EObjectContainer __result, EOperation isApplicableCC) {
		if (!__performOperation.equals(isApplicableCC)) {
			return new Object[] { match, __performOperation, __result, isApplicableCC };
		}
	...
	public static final Object[] pattern_NestedAnnotationType_21_5_Addmatchtoruleresult_greenBBBB(Match match,
			EOperation __performOperation, EObjectContainer __result, EOperation isApplicableCC) {
		__result.getContents().add(match);
		match.setIsApplicableOperation(__performOperation);
		match.setIsApplicableCCOperation(isApplicableCC);
	...
	public static final EObjectContainer pattern_NestedAnnotationType_21_6_expressionFB(EObjectContainer __result) {
		EObjectContainer _result = __result;
		return _result;
	}

	public static final Object[] pattern_NestedAnnotationType_24_1_prepare_blackB(NestedAnnotationType _this) {
		return new Object[] { _this };
	}

	public static final Object[] pattern_NestedAnnotationType_24_1_prepare_greenF() {
		IsApplicableRuleResult result = RuntimeFactory.eINSTANCE.createIsApplicableRuleResult();
		return new Object[] { result };
	}

	public static final Object[] pattern_NestedAnnotationType_24_2_matchcontext_bindingFFFFFFFBB(Match sourceMatch,
			Match targetMatch) {
	...
	public static final Iterable<Object[]> pattern_NestedAnnotationType_24_2_matchcontext_blackBBBBBFBBBB(
	...
	public static final Object[] pattern_NestedAnnotationType_24_2_matchcontext_greenBBBBBBBBBFB(
			AnnotationTypeDeclaration eNestedType, TPackage tNestedPackage, TypeGraph typeGraph,
	...
	public static final Object[] pattern_NestedAnnotationType_24_3_checkcsp_bindingFBBBBBBBBBBBB(
			NestedAnnotationType _this, CCMatch isApplicableMatch, AnnotationTypeDeclaration eNestedType,
			TPackage tNestedPackage, TypeGraph typeGraph, TAnnotationType tNestedType, TAbstractType tOuterType,
			TypeToTAbstractType eOuterTypeToTOuterInterface, AbstractTypeDeclaration eOuterType, TPackage tOuterPackage,
	...
	public static final Object[] pattern_NestedAnnotationType_24_3_checkcsp_blackB(CSP csp) {
		return new Object[] { csp };
	}

	public static final Object[] pattern_NestedAnnotationType_24_3_checkcsp_bindingAndBlackFBBBBBBBBBBBB(
			NestedAnnotationType _this, CCMatch isApplicableMatch, AnnotationTypeDeclaration eNestedType,
			TPackage tNestedPackage, TypeGraph typeGraph, TAnnotationType tNestedType, TAbstractType tOuterType,
			TypeToTAbstractType eOuterTypeToTOuterInterface, AbstractTypeDeclaration eOuterType, TPackage tOuterPackage,
			Match sourceMatch, Match targetMatch) {
		Object[] result_pattern_NestedAnnotationType_24_3_checkcsp_binding = pattern_NestedAnnotationType_24_3_checkcsp_bindingFBBBBBBBBBBBB(
				_this, isApplicableMatch, eNestedType, tNestedPackage, typeGraph, tNestedType, tOuterType,
				eOuterTypeToTOuterInterface, eOuterType, tOuterPackage, sourceMatch, targetMatch);
		if (result_pattern_NestedAnnotationType_24_3_checkcsp_binding != null) {
			CSP csp = (CSP) result_pattern_NestedAnnotationType_24_3_checkcsp_binding[0];

			Object[] result_pattern_NestedAnnotationType_24_3_checkcsp_black = pattern_NestedAnnotationType_24_3_checkcsp_blackB(
					csp);
			if (result_pattern_NestedAnnotationType_24_3_checkcsp_black != null) {
	...
	public static final Object[] pattern_NestedAnnotationType_24_4_createcorrespondence_blackBBBBBBBB(
			AnnotationTypeDeclaration eNestedType, TPackage tNestedPackage, TypeGraph typeGraph,
			TAnnotationType tNestedType, TAbstractType tOuterType, AbstractTypeDeclaration eOuterType,
			TPackage tOuterPackage, CCMatch isApplicableMatch) {
		if (!eNestedType.equals(eOuterType)) {
			if (!tNestedPackage.equals(tOuterPackage)) {
				if (!tNestedType.equals(tOuterType)) {
	...
	public static final Object[] pattern_NestedAnnotationType_24_4_createcorrespondence_greenBFBFB(
			AnnotationTypeDeclaration eNestedType, TAnnotationType tNestedType, CCMatch isApplicableMatch) {
		TypeToTAbstractType eNestedTypeToTNestedType = ModiscoFactory.eINSTANCE.createTypeToTAbstractType();
		BodyDeclarationToTAnnotatable mBodyToTAnnotation = ModiscoFactory.eINSTANCE
				.createBodyDeclarationToTAnnotatable();
		eNestedTypeToTNestedType.setSource(eNestedType);
	...
	public static final Object[] pattern_NestedAnnotationType_24_5_addtoreturnedresult_blackBB(
			IsApplicableRuleResult result, CCMatch isApplicableMatch) {
		return new Object[] { result, isApplicableMatch };
	}

	public static final Object[] pattern_NestedAnnotationType_24_5_addtoreturnedresult_greenBB(
			IsApplicableRuleResult result, CCMatch isApplicableMatch) {
	...
	public static final IsApplicableRuleResult pattern_NestedAnnotationType_24_6_expressionFB(
			IsApplicableRuleResult result) {
		IsApplicableRuleResult _result = result;
		return _result;
	}

	public static final Object[] pattern_NestedAnnotationType_27_1_matchtggpattern_blackBB(
			AnnotationTypeDeclaration eNestedType, AbstractTypeDeclaration eOuterType) {
		if (!eNestedType.equals(eOuterType)) {
			if (eOuterType.equals(eNestedType.getAbstractTypeDeclaration())) {
	...
	public static final boolean pattern_NestedAnnotationType_27_2_expressionF() {
		boolean _result = Boolean.valueOf(true);
		return _result;
	}

	public static final boolean pattern_NestedAnnotationType_27_3_expressionF() {
		boolean _result = false;
		return _result;
	}

	public static final Object[] pattern_NestedAnnotationType_28_1_matchtggpattern_black_nac_0BB(
			TPackage tNestedPackage, TPackage tOuterPackage) {
		if (!tNestedPackage.equals(tOuterPackage)) {
			TPackage __DEC_tNestedPackage_parent_151140 = tNestedPackage.getParent();
			if (__DEC_tNestedPackage_parent_151140 != null) {
				if (!tNestedPackage.equals(__DEC_tNestedPackage_parent_151140)) {
					if (!tOuterPackage.equals(__DEC_tNestedPackage_parent_151140)) {
						return new Object[] { tNestedPackage, tOuterPackage };
					}
				}
			}
	...
	public static final Object[] pattern_NestedAnnotationType_28_1_matchtggpattern_black_nac_1BB(
			TPackage tNestedPackage, TypeGraph typeGraph) {
		TypeGraph __DEC_tNestedPackage_packages_38905 = tNestedPackage.getPg();
		if (__DEC_tNestedPackage_packages_38905 != null) {
			if (!typeGraph.equals(__DEC_tNestedPackage_packages_38905)) {
				return new Object[] { tNestedPackage, typeGraph };
			}
		}
	...
	public static final Object[] pattern_NestedAnnotationType_28_1_matchtggpattern_black_nac_2BB(
			TAnnotationType tNestedType, TypeGraph typeGraph) {
		for (TypeGraph __DEC_tNestedType_tAnnotationTypes_766493 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tNestedType, TypeGraph.class, "tAnnotationTypes")) {
			if (!typeGraph.equals(__DEC_tNestedType_tAnnotationTypes_766493)) {
				return new Object[] { tNestedType, typeGraph };
			}
		}
		return null;
	...
	public static final Object[] pattern_NestedAnnotationType_28_1_matchtggpattern_black_nac_3BBB(
			TAnnotationType tNestedType, TPackage tNestedPackage, TPackage tOuterPackage) {
		if (!tNestedPackage.equals(tOuterPackage)) {
			TPackage __DEC_tNestedType_ownedTypes_414783 = tNestedType.getPackage();
			if (__DEC_tNestedType_ownedTypes_414783 != null) {
				if (!tNestedPackage.equals(__DEC_tNestedType_ownedTypes_414783)) {
					if (!tOuterPackage.equals(__DEC_tNestedType_ownedTypes_414783)) {
						return new Object[] { tNestedType, tNestedPackage, tOuterPackage };
					}
				}
			}
	...
	public static final Object[] pattern_NestedAnnotationType_28_1_matchtggpattern_black_nac_4BB(TypeGraph typeGraph,
	...
	public static final Object[] pattern_NestedAnnotationType_28_1_matchtggpattern_black_nac_5BB(TPackage tOuterPackage,
	...
	public static final Object[] pattern_NestedAnnotationType_28_1_matchtggpattern_blackBBBBB(TPackage tNestedPackage,
							...
							if (typeGraph.getOwnedTypes().contains(tNestedType)) {
								if (tOuterPackage.getOwnedTypes().contains(tOuterType)) {
									if (typeGraph.equals(tNestedPackage.getTypeGraph())) {
										if (typeGraph.getTAnnotationTypes().contains(tNestedType)) {
											if (typeGraph.equals(tOuterPackage.getTypeGraph())) {
												if (pattern_NestedAnnotationType_28_1_matchtggpattern_black_nac_0BB(
														tNestedPackage, tOuterPackage) == null) {
													if (pattern_NestedAnnotationType_28_1_matchtggpattern_black_nac_1BB(
															tNestedPackage, typeGraph) == null) {
														if (pattern_NestedAnnotationType_28_1_matchtggpattern_black_nac_2BB(
																tNestedType, typeGraph) == null) {
															if (pattern_NestedAnnotationType_28_1_matchtggpattern_black_nac_3BBB(
																	tNestedType, tNestedPackage,
																	tOuterPackage) == null) {
																if (pattern_NestedAnnotationType_28_1_matchtggpattern_black_nac_4BB(
																		typeGraph, tNestedPackage) == null) {
																	if (pattern_NestedAnnotationType_28_1_matchtggpattern_black_nac_5BB(
	...
	public static final boolean pattern_NestedAnnotationType_28_2_expressionF() {
		boolean _result = Boolean.valueOf(true);
		return _result;
	}

	public static final boolean pattern_NestedAnnotationType_28_3_expressionF() {
		boolean _result = false;
		return _result;
	}

	public static final Object[] pattern_NestedAnnotationType_29_1_createresult_blackB(NestedAnnotationType _this) {
		return new Object[] { _this };
	}

	public static final Object[] pattern_NestedAnnotationType_29_1_createresult_greenFF() {
		IsApplicableMatch isApplicableMatch = RuntimeFactory.eINSTANCE.createIsApplicableMatch();
	...
	public static final Object[] pattern_NestedAnnotationType_29_2_isapplicablecore_black_nac_0BB(
	...
	public static final Object[] pattern_NestedAnnotationType_29_2_isapplicablecore_black_nac_1BB(
	...
	public static final Object[] pattern_NestedAnnotationType_29_2_isapplicablecore_black_nac_2BB(
	...
	public static final Object[] pattern_NestedAnnotationType_29_2_isapplicablecore_black_nac_3BB(
	...
	public static final Object[] pattern_NestedAnnotationType_29_2_isapplicablecore_black_nac_4BB(
	...
	public static final Iterable<Object[]> pattern_NestedAnnotationType_29_2_isapplicablecore_blackFFFFFFBB(
					...
					if (tOuterType != null) {
						...
						if (tmpEOuterType instanceof AbstractTypeDeclaration) {
							...
							if (typeGraph != null) {
								...
								if (tOuterPackage != null) {
									if (typeGraph.equals(tOuterPackage.getTypeGraph())) {
										if (pattern_NestedAnnotationType_29_2_isapplicablecore_black_nac_2BB(ruleResult,
												eOuterTypeToTOuterInterface) == null) {
											if (pattern_NestedAnnotationType_29_2_isapplicablecore_black_nac_1BB(
													ruleResult, tOuterType) == null) {
												if (pattern_NestedAnnotationType_29_2_isapplicablecore_black_nac_3BB(
														ruleResult, eOuterType) == null) {
													if (pattern_NestedAnnotationType_29_2_isapplicablecore_black_nac_0BB(
															ruleResult, typeGraph) == null) {
														if (pattern_NestedAnnotationType_29_2_isapplicablecore_black_nac_4BB(
	...
	public static final Object[] pattern_NestedAnnotationType_29_3_solveCSP_bindingFBBBBBBBB(NestedAnnotationType _this,
	...
	public static final Object[] pattern_NestedAnnotationType_29_3_solveCSP_blackB(CSP csp) {
		return new Object[] { csp };
	}

	public static final Object[] pattern_NestedAnnotationType_29_3_solveCSP_bindingAndBlackFBBBBBBBB(
			NestedAnnotationType _this, IsApplicableMatch isApplicableMatch, TypeGraph typeGraph,
			TAbstractType tOuterType, TypeToTAbstractType eOuterTypeToTOuterInterface,
			AbstractTypeDeclaration eOuterType, TPackage tOuterPackage, ModelgeneratorRuleResult ruleResult) {
		Object[] result_pattern_NestedAnnotationType_29_3_solveCSP_binding = pattern_NestedAnnotationType_29_3_solveCSP_bindingFBBBBBBBB(
				_this, isApplicableMatch, typeGraph, tOuterType, eOuterTypeToTOuterInterface, eOuterType, tOuterPackage,
				ruleResult);
		if (result_pattern_NestedAnnotationType_29_3_solveCSP_binding != null) {
			CSP csp = (CSP) result_pattern_NestedAnnotationType_29_3_solveCSP_binding[0];

			Object[] result_pattern_NestedAnnotationType_29_3_solveCSP_black = pattern_NestedAnnotationType_29_3_solveCSP_blackB(
					csp);
			if (result_pattern_NestedAnnotationType_29_3_solveCSP_black != null) {
	...
	public static final boolean pattern_NestedAnnotationType_29_4_checkCSP_expressionFBB(NestedAnnotationType _this,
			CSP csp) {
	...
	public static final Object[] pattern_NestedAnnotationType_29_5_checknacs_blackBBBBB(TypeGraph typeGraph,
			TAbstractType tOuterType, TypeToTAbstractType eOuterTypeToTOuterInterface,
			AbstractTypeDeclaration eOuterType, TPackage tOuterPackage) {
		return new Object[] { typeGraph, tOuterType, eOuterTypeToTOuterInterface, eOuterType, tOuterPackage };
	}

	public static final Object[] pattern_NestedAnnotationType_29_6_perform_blackBBBBBB(TypeGraph typeGraph,
			TAbstractType tOuterType, TypeToTAbstractType eOuterTypeToTOuterInterface,
			AbstractTypeDeclaration eOuterType, TPackage tOuterPackage, ModelgeneratorRuleResult ruleResult) {
		return new Object[] { typeGraph, tOuterType, eOuterTypeToTOuterInterface, eOuterType, tOuterPackage,
				ruleResult };
	...
	public static final Object[] pattern_NestedAnnotationType_29_6_perform_greenFFFBFFBBBB(TypeGraph typeGraph,
	...
	public static final ModelgeneratorRuleResult pattern_NestedAnnotationType_29_7_expressionFB(
			ModelgeneratorRuleResult ruleResult) {
