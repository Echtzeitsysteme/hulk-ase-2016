...
public class TypeParameterImpl extends AbstractRuleImpl implements TypeParameter {
	...
	public boolean isAppropriate_FWD(Match match, MGravityModel eModel,
			org.eclipse.gmt.modisco.java.TypeParameter eAnonymousClassDeclaration) {
		// initial bindings
		...
		// Solve CSP
		Object[] result2_bindingAndBlack = TypeParameterImpl.pattern_TypeParameter_0_2_SolveCSP_bindingAndBlackFBBBB(
		...
		if (TypeParameterImpl.pattern_TypeParameter_0_3_CheckCSP_expressionFBB(this, csp)) {
			...
			Object[] result4_black = TypeParameterImpl.pattern_TypeParameter_0_4_collectelementstobetranslated_blackBBB(
			...
			// EMoflonEdge eModel__eAnonymousClassDeclaration____typeParameters = (EMoflonEdge) result4_green[3];
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		org.eclipse.gmt.modisco.java.TypeParameter eAnonymousClassDeclaration = (org.eclipse.gmt.modisco.java.TypeParameter) result1_bindingAndBlack[2];
		ModelToTypeGraph eModelToPg = (ModelToTypeGraph) result1_bindingAndBlack[3];
		CSP csp = (CSP) result1_bindingAndBlack[4];
		Object[] result1_green = TypeParameterImpl.pattern_TypeParameter_1_1_performtransformation_greenBFBFB(pg,
		...
		TypeParameterImpl.pattern_TypeParameter_1_3_bookkeepingforedges_greenBBBBBBFFFFFF(ruleresult, eModel, pg,
				tClass, eAnonymousClassDeclaration, eAnonymousClassDeclarationToTClass);
		// EMoflonEdge eModel__eAnonymousClassDeclaration____typeParameters = (EMoflonEdge) result3_green[6];
		...
		TypeParameterImpl.pattern_TypeParameter_1_5_registerobjects_expressionBBBBBBBB(this, ruleresult, eModel, pg,
				tClass, eAnonymousClassDeclaration, eModelToPg, eAnonymousClassDeclarationToTClass);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		org.eclipse.gmt.modisco.java.TypeParameter eAnonymousClassDeclaration = (org.eclipse.gmt.modisco.java.TypeParameter) result2_binding[1];
		for (Object[] result2_black : TypeParameterImpl.pattern_TypeParameter_2_2_corematch_blackBFBFB(eModel,
			...
			for (Object[] result3_black : TypeParameterImpl.pattern_TypeParameter_2_3_findcontext_blackBBBB(eModel, pg,
				...
				Object[] result3_green = TypeParameterImpl.pattern_TypeParameter_2_3_findcontext_greenBBBBFFFF(eModel,
						pg, eAnonymousClassDeclaration, eModelToPg);
				IsApplicableMatch isApplicableMatch = (IsApplicableMatch) result3_green[4];
				// EMoflonEdge eModel__eAnonymousClassDeclaration____typeParameters = (EMoflonEdge) result3_green[5];
	...
	public CSP isAppropriate_solveCsp_FWD(Match match, MGravityModel eModel,
			org.eclipse.gmt.modisco.java.TypeParameter eAnonymousClassDeclaration) {// Create CSP
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, MGravityModel eModel, TypeGraph pg,
			org.eclipse.gmt.modisco.java.TypeParameter eAnonymousClassDeclaration, ModelToTypeGraph eModelToPg) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result1_green = TypeParameterImpl.pattern_TypeParameter_11_1_performtransformation_greenBBFF(eModel,
				tClass);
		org.eclipse.gmt.modisco.java.TypeParameter eAnonymousClassDeclaration = (org.eclipse.gmt.modisco.java.TypeParameter) result1_green[2];
		TypeToTAbstractType eAnonymousClassDeclarationToTClass = (TypeToTAbstractType) result1_green[3];
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_52(EMoflonEdge _edge_typeParameters) {
		// prepare return value
		Object[] result1_bindingAndBlack = TypeParameterImpl
		...
		for (Object[] result2_black : TypeParameterImpl
				.pattern_TypeParameter_20_2_testcorematchandDECs_blackFFB(_edge_typeParameters)) {
			MGravityModel eModel = (MGravityModel) result2_black[0];
			org.eclipse.gmt.modisco.java.TypeParameter eAnonymousClassDeclaration = (org.eclipse.gmt.modisco.java.TypeParameter) result2_black[1];
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_49(EMoflonEdge _edge_classes) {
		// prepare return value
		Object[] result1_bindingAndBlack = TypeParameterImpl
		...
		// ForEach test core match and DECs
		for (Object[] result2_black : TypeParameterImpl
				.pattern_TypeParameter_21_2_testcorematchandDECs_blackFFB(_edge_classes)) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result2_binding = TypeParameterImpl.pattern_TypeParameter_24_2_matchcontext_bindingFFFFBB(sourceMatch,
				targetMatch);
		if (result2_binding == null) {
		...
		org.eclipse.gmt.modisco.java.TypeParameter eAnonymousClassDeclaration = (org.eclipse.gmt.modisco.java.TypeParameter) result2_binding[3];
		for (Object[] result2_black : TypeParameterImpl.pattern_TypeParameter_24_2_matchcontext_blackBBBBFBB(eModel, pg,
				tClass, eAnonymousClassDeclaration, sourceMatch, targetMatch)) {
			ModelToTypeGraph eModelToPg = (ModelToTypeGraph) result2_black[4];
			Object[] result2_green = TypeParameterImpl.pattern_TypeParameter_24_2_matchcontext_greenBBBBBBFB(eModel, pg,
					tClass, eAnonymousClassDeclaration, eModelToPg, sourceMatch, targetMatch);
			CCMatch isApplicableMatch = (CCMatch) result2_green[6];

			// check csp
			Object[] result3_bindingAndBlack = TypeParameterImpl
					.pattern_TypeParameter_24_3_checkcsp_bindingAndBlackFBBBBBBBBB(this, isApplicableMatch, eModel, pg,
							tClass, eAnonymousClassDeclaration, eModelToPg, sourceMatch, targetMatch);
			if (result3_bindingAndBlack != null) {
				// CSP csp = (CSP) result3_bindingAndBlack[0];

				// create correspondence
				Object[] result4_black = TypeParameterImpl.pattern_TypeParameter_24_4_createcorrespondence_blackBBBBB(
						eModel, pg, tClass, eAnonymousClassDeclaration, isApplicableMatch);
				if (result4_black == null) {
				...
				TypeParameterImpl.pattern_TypeParameter_24_4_createcorrespondence_greenBBFB(tClass,
				...
				Object[] result5_black = TypeParameterImpl
						.pattern_TypeParameter_24_5_addtoreturnedresult_blackBB(result, isApplicableMatch);
				if (result5_black == null) {
					throw new RuntimeException(
							"Pattern matching in node [add to returned result] failed." + " Variables: " + "[result] = "
									+ result + ", " + "[isApplicableMatch] = " + isApplicableMatch + ".");
				}
				TypeParameterImpl.pattern_TypeParameter_24_5_addtoreturnedresult_greenBB(result, isApplicableMatch);

			} else {
			}

		}
		return TypeParameterImpl.pattern_TypeParameter_24_6_expressionFB(result);
	}
	...
	public CSP isApplicable_solveCsp_CC(CCMatch isApplicableMatch, MGravityModel eModel, TypeGraph pg, TClass tClass,
			org.eclipse.gmt.modisco.java.TypeParameter eAnonymousClassDeclaration, ModelToTypeGraph eModelToPg,
	...
	public boolean checkDEC_FWD(MGravityModel eModel,
			org.eclipse.gmt.modisco.java.TypeParameter eAnonymousClassDeclaration) {// match tgg pattern
		...
		for (Object[] result2_black : TypeParameterImpl
			...
			if (TypeParameterImpl.pattern_TypeParameter_29_4_checkCSP_expressionFBB(this, csp)) {
				...
				if (result5_black != null) {
					...
					TypeParameterImpl.pattern_TypeParameter_29_6_perform_greenBBFFFBB(eModel, pg, ruleResult, csp);
					// TClass tClass = (TClass) result6_green[2];
					// org.eclipse.gmt.modisco.java.TypeParameter eAnonymousClassDeclaration = (org.eclipse.gmt.modisco.java.TypeParameter) result6_green[3];
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.TYPE_PARAMETER___IS_APPROPRIATE_FWD__MATCH_MGRAVITYMODEL_TYPEPARAMETER:
			return isAppropriate_FWD((Match) arguments.get(0), (MGravityModel) arguments.get(1),
					(org.eclipse.gmt.modisco.java.TypeParameter) arguments.get(2));
		...
		case RulesPackage.TYPE_PARAMETER___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_MGRAVITYMODEL_TYPEGRAPH_TYPEPARAMETER_MODELTOTYPEGRAPH:
			return isApplicable_solveCsp_FWD((IsApplicableMatch) arguments.get(0), (MGravityModel) arguments.get(1),
					(TypeGraph) arguments.get(2), (org.eclipse.gmt.modisco.java.TypeParameter) arguments.get(3),
		...
		case RulesPackage.TYPE_PARAMETER___IS_APPROPRIATE_FWD_EMOFLON_EDGE_52__EMOFLONEDGE:
			return isAppropriate_FWD_EMoflonEdge_52((EMoflonEdge) arguments.get(0));
		case RulesPackage.TYPE_PARAMETER___IS_APPROPRIATE_BWD_EMOFLON_EDGE_49__EMOFLONEDGE:
		...
		case RulesPackage.TYPE_PARAMETER___IS_APPLICABLE_SOLVE_CSP_CC__CCMATCH_MGRAVITYMODEL_TYPEGRAPH_TCLASS_TYPEPARAMETER_MODELTOTYPEGRAPH_MATCH_MATCH:
			return isApplicable_solveCsp_CC((CCMatch) arguments.get(0), (MGravityModel) arguments.get(1),
					...
					(org.eclipse.gmt.modisco.java.TypeParameter) arguments.get(4), (ModelToTypeGraph) arguments.get(5),
		...
		case RulesPackage.TYPE_PARAMETER___CHECK_DEC_FWD__MGRAVITYMODEL_TYPEPARAMETER:
			return checkDEC_FWD((MGravityModel) arguments.get(0),
					(org.eclipse.gmt.modisco.java.TypeParameter) arguments.get(1));
	...
	public static final Object[] pattern_TypeParameter_0_1_initialbindings_blackBBBB(TypeParameter _this, Match match,
			MGravityModel eModel, org.eclipse.gmt.modisco.java.TypeParameter eAnonymousClassDeclaration) {
	...
	public static final Object[] pattern_TypeParameter_0_2_SolveCSP_bindingAndBlackFBBBB(TypeParameter _this,
			Match match, MGravityModel eModel, org.eclipse.gmt.modisco.java.TypeParameter eAnonymousClassDeclaration) {
	...
	public static final Object[] pattern_TypeParameter_0_4_collectelementstobetranslated_greenBBBF(Match match,
			MGravityModel eModel, org.eclipse.gmt.modisco.java.TypeParameter eAnonymousClassDeclaration) {
		EMoflonEdge eModel__eAnonymousClassDeclaration____typeParameters = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		match.getToBeTranslatedNodes().add(eAnonymousClassDeclaration);
		String eModel__eAnonymousClassDeclaration____typeParameters_name_prime = "typeParameters";
		eModel__eAnonymousClassDeclaration____typeParameters.setSrc(eModel);
		eModel__eAnonymousClassDeclaration____typeParameters.setTrg(eAnonymousClassDeclaration);
		match.getToBeTranslatedEdges().add(eModel__eAnonymousClassDeclaration____typeParameters);
		eModel__eAnonymousClassDeclaration____typeParameters
				.setName(eModel__eAnonymousClassDeclaration____typeParameters_name_prime);
		return new Object[] { match, eModel, eAnonymousClassDeclaration,
				eModel__eAnonymousClassDeclaration____typeParameters };
	}
	...
	public static final Object[] pattern_TypeParameter_1_1_performtransformation_bindingFFFFB(
		...
		if (tmpEModel instanceof MGravityModel) {
			...
			if (tmpPg instanceof TypeGraph) {
				...
				if (tmpEAnonymousClassDeclaration instanceof org.eclipse.gmt.modisco.java.TypeParameter) {
					org.eclipse.gmt.modisco.java.TypeParameter eAnonymousClassDeclaration = (org.eclipse.gmt.modisco.java.TypeParameter) tmpEAnonymousClassDeclaration;
	...
	public static final Object[] pattern_TypeParameter_1_1_performtransformation_blackBBBBFBB(MGravityModel eModel,
			TypeGraph pg, org.eclipse.gmt.modisco.java.TypeParameter eAnonymousClassDeclaration,
	...
	public static final Object[] pattern_TypeParameter_1_1_performtransformation_bindingAndBlackFFFFFBB(
		...
		if (result_pattern_TypeParameter_1_1_performtransformation_binding != null) {
			...
			org.eclipse.gmt.modisco.java.TypeParameter eAnonymousClassDeclaration = (org.eclipse.gmt.modisco.java.TypeParameter) result_pattern_TypeParameter_1_1_performtransformation_binding[2];
	...
	public static final Object[] pattern_TypeParameter_1_1_performtransformation_greenBFBFB(TypeGraph pg,
			org.eclipse.gmt.modisco.java.TypeParameter eAnonymousClassDeclaration, CSP csp) {
	...
	public static final Object[] pattern_TypeParameter_1_3_bookkeepingforedges_greenBBBBBBFFFFFF(
		...
		eModel__eAnonymousClassDeclaration____typeParameters.setSrc(eModel);
		eModel__eAnonymousClassDeclaration____typeParameters.setTrg(eAnonymousClassDeclaration);
		ruleresult.getTranslatedEdges().add(eModel__eAnonymousClassDeclaration____typeParameters);
		...
		return new Object[] { ruleresult, eModel, pg, tClass, eAnonymousClassDeclaration,
				eAnonymousClassDeclarationToTClass, eModel__eAnonymousClassDeclaration____typeParameters,
	...
	public static final Iterable<Object[]> pattern_TypeParameter_2_2_corematch_blackBFBFB(MGravityModel eModel,
			org.eclipse.gmt.modisco.java.TypeParameter eAnonymousClassDeclaration, Match match) {
	...
	public static final Iterable<Object[]> pattern_TypeParameter_2_3_findcontext_blackBBBB(MGravityModel eModel,
		...
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (eModel.getTypeParameters().contains(eAnonymousClassDeclaration)) {
	...
	public static final Object[] pattern_TypeParameter_2_3_findcontext_greenBBBBFFFF(MGravityModel eModel, TypeGraph pg,
		...
		eModel__eAnonymousClassDeclaration____typeParameters.setSrc(eModel);
		eModel__eAnonymousClassDeclaration____typeParameters.setTrg(eAnonymousClassDeclaration);
		isApplicableMatch.getAllContextElements().add(eModel__eAnonymousClassDeclaration____typeParameters);
		...
		return new Object[] { eModel, pg, eAnonymousClassDeclaration, eModelToPg, isApplicableMatch,
				eModel__eAnonymousClassDeclaration____typeParameters, eModelToPg__eModel____source,
	...
	public static final Object[] pattern_TypeParameter_11_1_performtransformation_greenBBFF(MGravityModel eModel,
			TClass tClass) {
		org.eclipse.gmt.modisco.java.TypeParameter eAnonymousClassDeclaration = JavaFactory.eINSTANCE
				.createTypeParameter();
		TypeToTAbstractType eAnonymousClassDeclarationToTClass = ModiscoFactory.eINSTANCE.createTypeToTAbstractType();
		eModel.getTypeParameters().add(eAnonymousClassDeclaration);
		eAnonymousClassDeclarationToTClass.setSource(eAnonymousClassDeclaration);
		eAnonymousClassDeclarationToTClass.setTarget(tClass);
		return new Object[] { eModel, tClass, eAnonymousClassDeclaration, eAnonymousClassDeclarationToTClass };
	}
	...
	public static final Object[] pattern_TypeParameter_11_3_bookkeepingforedges_greenBBBBBBFFFFFF(
		...
		eModel__eAnonymousClassDeclaration____typeParameters.setSrc(eModel);
		eModel__eAnonymousClassDeclaration____typeParameters.setTrg(eAnonymousClassDeclaration);
		ruleresult.getCreatedEdges().add(eModel__eAnonymousClassDeclaration____typeParameters);
		pg__tClass____classes.setSrc(pg);
		pg__tClass____classes.setTrg(tClass);
	...
	public static final Object[] pattern_TypeParameter_20_2_testcorematchandDECs_black_nac_0BB(
			org.eclipse.gmt.modisco.java.TypeParameter eAnonymousClassDeclaration, MGravityModel eModel) {
		for (MGravityModel __DEC_eAnonymousClassDeclaration_typeParameters_52854 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(eAnonymousClassDeclaration, MGravityModel.class, "typeParameters")) {
			if (!eModel.equals(__DEC_eAnonymousClassDeclaration_typeParameters_52854)) {
	...
	public static final Object[] pattern_TypeParameter_20_2_testcorematchandDECs_black_nac_1BB(
			org.eclipse.gmt.modisco.java.TypeParameter eAnonymousClassDeclaration, MGravityModel eModel) {
		for (MGravityModel __DEC_eAnonymousClassDeclaration_typeParameters_641237 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(eAnonymousClassDeclaration, MGravityModel.class, "typeParameters")) {
			if (!eModel.equals(__DEC_eAnonymousClassDeclaration_typeParameters_641237)) {
				return new Object[] { eAnonymousClassDeclaration, eModel };
			}
		}
		return null;
	...
	public static final Iterable<Object[]> pattern_TypeParameter_20_2_testcorematchandDECs_blackFFB(
		...
		if (tmpEModel instanceof MGravityModel) {
			MGravityModel eModel = (MGravityModel) tmpEModel;
			EObject tmpEAnonymousClassDeclaration = _edge_typeParameters.getTrg();
			if (tmpEAnonymousClassDeclaration instanceof org.eclipse.gmt.modisco.java.TypeParameter) {
				org.eclipse.gmt.modisco.java.TypeParameter eAnonymousClassDeclaration = (org.eclipse.gmt.modisco.java.TypeParameter) tmpEAnonymousClassDeclaration;
				if (eModel.getTypeParameters().contains(eAnonymousClassDeclaration)) {
					if (pattern_TypeParameter_20_2_testcorematchandDECs_black_nac_0BB(eAnonymousClassDeclaration,
							eModel) == null) {
						if (pattern_TypeParameter_20_2_testcorematchandDECs_black_nac_1BB(eAnonymousClassDeclaration,
								eModel) == null) {
							_result.add(new Object[] { eModel, eAnonymousClassDeclaration, _edge_typeParameters });
						}
					}
				}
			}
	...
	public static final Object[] pattern_TypeParameter_21_2_testcorematchandDECs_black_nac_0B(TClass tClass) {
		for (TPackage __DEC_tClass_classes_180789 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_TypeParameter_21_2_testcorematchandDECs_black_nac_1BB(TClass tClass,
			TypeGraph pg) {
		for (TypeGraph __DEC_tClass_classes_124356 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tClass, TypeGraph.class, "classes")) {
			if (!pg.equals(__DEC_tClass_classes_124356)) {
	...
	public static final Object[] pattern_TypeParameter_21_2_testcorematchandDECs_black_nac_2B(TClass tClass) {
		TPackage __DEC_tClass_ownedTypes_884020 = tClass.getPackage();
		if (__DEC_tClass_ownedTypes_884020 != null) {
			return new Object[] { tClass };
		}
				...
				if (pg.getClasses().contains(tClass)) {
					if (pg.getOwnedTypes().contains(tClass)) {
						...
						if (Boolean.valueOf(tClass_tLib).equals(false)) {
							String tClass_tName = tClass.getTName();
							if (tClass_tName.equals("T")) {
								if (pattern_TypeParameter_21_2_testcorematchandDECs_black_nac_0B(tClass) == null) {
									if (pattern_TypeParameter_21_2_testcorematchandDECs_black_nac_1BB(tClass,
											pg) == null) {
										if (pattern_TypeParameter_21_2_testcorematchandDECs_black_nac_2B(
												tClass) == null) {
	...
	public static final Object[] pattern_TypeParameter_24_2_matchcontext_bindingFFFFBB(Match sourceMatch,
			Match targetMatch) {
	...
	public static final Iterable<Object[]> pattern_TypeParameter_24_2_matchcontext_blackBBBBFBB(MGravityModel eModel,
			TypeGraph pg, TClass tClass, org.eclipse.gmt.modisco.java.TypeParameter eAnonymousClassDeclaration,
						...
						if (Boolean.valueOf(tClass_tLib).equals(false)) {
							...
							if (tClass_tName.equals("T")) {
								for (ModelToTypeGraph eModelToPg : org.moflon.core.utilities.eMoflonEMFUtil
									...
									if (pg.equals(eModelToPg.getTarget())) {
										_result.add(new Object[] { eModel, pg, tClass, eAnonymousClassDeclaration,
	...
	public static final Object[] pattern_TypeParameter_24_2_matchcontext_greenBBBBBBFB(MGravityModel eModel,
			TypeGraph pg, TClass tClass, org.eclipse.gmt.modisco.java.TypeParameter eAnonymousClassDeclaration,
	...
	public static final Object[] pattern_TypeParameter_24_3_checkcsp_bindingFBBBBBBBBB(TypeParameter _this,
			CCMatch isApplicableMatch, MGravityModel eModel, TypeGraph pg, TClass tClass,
			org.eclipse.gmt.modisco.java.TypeParameter eAnonymousClassDeclaration, ModelToTypeGraph eModelToPg,
			Match sourceMatch, Match targetMatch) {
	...
	public static final Object[] pattern_TypeParameter_24_3_checkcsp_blackB(CSP csp) {
		return new Object[] { csp };
	}

	public static final Object[] pattern_TypeParameter_24_3_checkcsp_bindingAndBlackFBBBBBBBBB(TypeParameter _this,
			CCMatch isApplicableMatch, MGravityModel eModel, TypeGraph pg, TClass tClass,
			org.eclipse.gmt.modisco.java.TypeParameter eAnonymousClassDeclaration, ModelToTypeGraph eModelToPg,
			Match sourceMatch, Match targetMatch) {
		Object[] result_pattern_TypeParameter_24_3_checkcsp_binding = pattern_TypeParameter_24_3_checkcsp_bindingFBBBBBBBBB(
				_this, isApplicableMatch, eModel, pg, tClass, eAnonymousClassDeclaration, eModelToPg, sourceMatch,
				targetMatch);
		if (result_pattern_TypeParameter_24_3_checkcsp_binding != null) {
			CSP csp = (CSP) result_pattern_TypeParameter_24_3_checkcsp_binding[0];

			Object[] result_pattern_TypeParameter_24_3_checkcsp_black = pattern_TypeParameter_24_3_checkcsp_blackB(csp);
			if (result_pattern_TypeParameter_24_3_checkcsp_black != null) {
	...
	public static final Object[] pattern_TypeParameter_24_4_createcorrespondence_blackBBBBB(MGravityModel eModel,
			TypeGraph pg, TClass tClass, org.eclipse.gmt.modisco.java.TypeParameter eAnonymousClassDeclaration,
			CCMatch isApplicableMatch) {
		return new Object[] { eModel, pg, tClass, eAnonymousClassDeclaration, isApplicableMatch };
	}

	public static final Object[] pattern_TypeParameter_24_4_createcorrespondence_greenBBFB(TClass tClass,
			org.eclipse.gmt.modisco.java.TypeParameter eAnonymousClassDeclaration, CCMatch isApplicableMatch) {
		TypeToTAbstractType eAnonymousClassDeclarationToTClass = ModiscoFactory.eINSTANCE.createTypeToTAbstractType();
		eAnonymousClassDeclarationToTClass.setSource(eAnonymousClassDeclaration);
		eAnonymousClassDeclarationToTClass.setTarget(tClass);
	...
	public static final Object[] pattern_TypeParameter_24_5_addtoreturnedresult_blackBB(IsApplicableRuleResult result,
			CCMatch isApplicableMatch) {
		return new Object[] { result, isApplicableMatch };
	}

	public static final Object[] pattern_TypeParameter_24_5_addtoreturnedresult_greenBB(IsApplicableRuleResult result,
			CCMatch isApplicableMatch) {
	...
	public static final IsApplicableRuleResult pattern_TypeParameter_24_6_expressionFB(IsApplicableRuleResult result) {
	...
	public static final Object[] pattern_TypeParameter_27_1_matchtggpattern_black_nac_0BB(
			org.eclipse.gmt.modisco.java.TypeParameter eAnonymousClassDeclaration, MGravityModel eModel) {
		for (MGravityModel __DEC_eAnonymousClassDeclaration_typeParameters_131102 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(eAnonymousClassDeclaration, MGravityModel.class, "typeParameters")) {
			if (!eModel.equals(__DEC_eAnonymousClassDeclaration_typeParameters_131102)) {
				return new Object[] { eAnonymousClassDeclaration, eModel };
			}
		}
		return null;
	...
	public static final Object[] pattern_TypeParameter_27_1_matchtggpattern_black_nac_1BB(
			org.eclipse.gmt.modisco.java.TypeParameter eAnonymousClassDeclaration, MGravityModel eModel) {
		for (MGravityModel __DEC_eAnonymousClassDeclaration_typeParameters_157876 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(eAnonymousClassDeclaration, MGravityModel.class, "typeParameters")) {
			if (!eModel.equals(__DEC_eAnonymousClassDeclaration_typeParameters_157876)) {
				return new Object[] { eAnonymousClassDeclaration, eModel };
			}
		}
		return null;
	...
	public static final Object[] pattern_TypeParameter_27_1_matchtggpattern_blackBB(MGravityModel eModel,
			org.eclipse.gmt.modisco.java.TypeParameter eAnonymousClassDeclaration) {
		if (eModel.getTypeParameters().contains(eAnonymousClassDeclaration)) {
			if (pattern_TypeParameter_27_1_matchtggpattern_black_nac_0BB(eAnonymousClassDeclaration, eModel) == null) {
				if (pattern_TypeParameter_27_1_matchtggpattern_black_nac_1BB(eAnonymousClassDeclaration,
						eModel) == null) {
	...
	public static final Object[] pattern_TypeParameter_28_1_matchtggpattern_black_nac_0B(TClass tClass) {
		for (TPackage __DEC_tClass_classes_463295 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tClass, TPackage.class, "classes")) {
			return new Object[] { tClass };
		}
		return null;
	...
	public static final Object[] pattern_TypeParameter_28_1_matchtggpattern_black_nac_1BB(TClass tClass, TypeGraph pg) {
		for (TypeGraph __DEC_tClass_classes_363620 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tClass, TypeGraph.class, "classes")) {
			if (!pg.equals(__DEC_tClass_classes_363620)) {
				return new Object[] { tClass, pg };
			}
		}
		return null;
	...
	public static final Object[] pattern_TypeParameter_28_1_matchtggpattern_black_nac_2B(TClass tClass) {
		TPackage __DEC_tClass_ownedTypes_282775 = tClass.getPackage();
		if (__DEC_tClass_ownedTypes_282775 != null) {
			return new Object[] { tClass };
		}
	...
	public static final Object[] pattern_TypeParameter_29_6_perform_greenBBFFFBB(MGravityModel eModel, TypeGraph pg,
